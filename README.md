...
Last source update: Sep 16, 2026, 15:22 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Planning review | Sep 16, 2026, 15:16 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35113962608) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 16, 2026, 15:22 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35114689251) |
...
Last source update: Sep 16, 2026, 15:18 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1068 | 100% |
| Run attempts archived | 3227 | audit |
| Latest successful clusters | 902 | 84.5% |
...
- Latest records: 1068 clusters: 329 maintainer action, 273 automation snapshot, 420 intervention needed, 46 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#150117](https://github.com/openclaw/openclaw/pull/150117) is automation_failed: An ordinary successful-delivery reporting defect remains source-verifiable. Executable regression proof must precede implementation on th....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#149994](https://github.com/openclaw/openclaw/pull/149994) is action_planned: The evidence supports a bounded visual defect. Keep the issue open and prepare the authorized fix, checking for contributor work before c....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 329 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 273 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#150117](https://github.com/openclaw/openclaw/pull/150117) | automation_failed | An ordinary successful-delivery reporting defect remains source-verifiable. Executable regression proof must precede implementation on the executor. | Sep 16, 2026, 15:18 UTC | [issue-openclaw-openclaw-150117](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-150117.md) | [35111435303](https://github.com/openclaw/clawsweeper/actions/runs/35111435303) |
