...
Last source update: Aug 22, 2026, 22:25 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Hot intake publish complete | Aug 22, 2026, 22:25 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32601138577) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 22, 2026, 22:15 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32601881881) |
...
Last source update: Aug 22, 2026, 22:13 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 583 | 100% |
| Run attempts archived | 1952 | audit |
| Latest successful clusters | 480 | 82.3% |
| Latest failed clusters | 101 | 17.3% |
...
- Latest records: 583 clusters: 216 maintainer action, 115 automation snapshot, 225 intervention needed, 27 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [issue-openclaw-openclaw-128005](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-128005.md) is maintainer_input: Provide a writable worker with the sibling `../codex` checkout available, then author the capture-boundary regression and validate the re....
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#89528](https://github.com/openclaw/openclaw/pull/89528) is automation_blocked: The repair shape is clear, but this worker cannot satisfy the repository's Codex-source gate or create and validate a branch in the read-....
...
| Intervention Needed | 225 | automation failure or blocker recorded |
...
| automation_active | 0 |
| action_planned | 71 |
| automation_failed | 110 |
| automation_blocked | 115 |
...
| [openclaw/openclaw](https://github.com/openclaw/openclaw) |  | maintainer_input | Provide a writable repair checkout with sibling ../codex source and a writable pnpm/Corepack cache, then apply and validate the attached narrow fix... | Aug 22, 2026, 20:44 UTC | [issue-openclaw-openclaw-128025](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-128025.md) | [32597007431](https://github.com/openclaw/clawsweeper/actions/runs/32597007431) |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#89528](https://github.com/openclaw/openclaw/pull/89528) | automation_blocked | The repair shape is clear, but this worker cannot satisfy the repository's Codex-source gate or create and validate a branch in the read-only check... | Aug 22, 2026, 22:13 UTC | [issue-openclaw-openclaw-89528](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-89528.md) | [32601191950](https://github.com/openclaw/clawsweeper/actions/runs/32601191950) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#128017](https://github.com/openclaw/openclaw/pull/128017) | automation_blocked | Apply the supplied narrow fix in a writable checkout, then run the required regression and changed-file gates before opening the one allowed fix PR. | Aug 22, 2026, 21:43 UTC | [issue-openclaw-openclaw-128017](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-128017.md) | [32599907560](https://github.com/openclaw/clawsweeper/actions/runs/32599907560) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#124689](https://github.com/openclaw/openclaw/pull/124689) | automation_failed | An executor with writable checkout access must complete the required Codex inspection, add the regression, apply the owner-boundary filter, and val... | Aug 22, 2026, 21:31 UTC | [issue-openclaw-openclaw-124689](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-124689.md) | [32599401098](https://github.com/openclaw/clawsweeper/actions/runs/32599401098) |
...
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#125776](https://github.com/openclaw/openclaw/pull/125776) | automation_failed | The producer-boundary repair remains narrow and source-backed, but requires direct Codex contract inspection and dependency installation before edi... | Aug 22, 2026, 08:38 UTC | [issue-openclaw-openclaw-125776](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-125776.md) | [32562362460](https://github.com/openclaw/clawsweeper/actions/runs/32562362460) |
...
| issue-openclaw-openclaw-128025 | needs human | Provide a writable repair checkout with sibling ../codex source and a writable pnpm/Corepack cache, then apply and validate the attached narrow fix... | [issue-openclaw-openclaw-128025](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-128025.md) | [32597007431](https://github.com/openclaw/clawsweeper/actions/runs/32597007431) |
