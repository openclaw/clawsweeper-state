...
Last source update: Sep 17, 2026, 16:25 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 17, 2026, 16:22 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35242828631) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 17, 2026, 16:25 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35246345472) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Sep 17, 2026, 15:33 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35240947295) |
...
| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1081 | 100% |
| Run attempts archived | 3268 | audit |
| Latest successful clusters | 914 | 84.6% |
...
- Latest records: 1081 clusters: 329 maintainer action, 285 automation snapshot, 421 intervention needed, 46 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#150974](https://github.com/openclaw/openclaw/pull/150974) is automation_failed: The source-supported defect remains on the supplied current main. Keep the issue open while the executor establishes the required regress....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#150865](https://github.com/openclaw/openclaw/pull/150865) is action_planned: Repair the existing silent-error recovery owner so eligible zero-output blank-text failures reach bounded recovery and configured fallbac....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 329 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 285 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#150974](https://github.com/openclaw/openclaw/pull/150974) | automation_failed | The source-supported defect remains on the supplied current main. Keep the issue open while the executor establishes the required regression and im... | Sep 17, 2026, 16:25 UTC | [issue-openclaw-openclaw-150974](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-150974.md) | [35243270419](https://github.com/openclaw/clawsweeper/actions/runs/35243270419) |
