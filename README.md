...
Last source update: Sep 7, 2026, 13:43 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Sep 7, 2026, 13:40 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34124426206) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 7, 2026, 13:43 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34128895002) |
...
Last source update: Sep 7, 2026, 13:50 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 904 | 100% |
| Run attempts archived | 2791 | audit |
| Latest successful clusters | 745 | 82.4% |
...
- Latest records: 904 clusters: 305 maintainer action, 154 automation snapshot, 408 intervention needed, 37 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#141252](https://github.com/openclaw/openclaw/pull/141252) is automation_failed: A narrow queued lifecycle repair is supported by current source. Runtime reproduction must succeed before implementation proceeds..
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#141233](https://github.com/openclaw/openclaw/pull/141233) is action_planned: Retain this issue as the narrow repair owner. Proceed only after native-contract inspection and the required failing regression; do not i....
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#141252](https://github.com/openclaw/openclaw/pull/141252) | automation_failed | A narrow queued lifecycle repair is supported by current source. Runtime reproduction must succeed before implementation proceeds. | Sep 7, 2026, 13:50 UTC | [issue-openclaw-openclaw-141252](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-141252.md) | [34128916746](https://github.com/openclaw/clawsweeper/actions/runs/34128916746) |
