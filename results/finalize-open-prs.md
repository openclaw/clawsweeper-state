...
Generated: 2026-08-03T14:29:41.583Z
...
| [#118685](https://github.com/openclaw/openclaw/pull/118685) | fix(agents): record stop reason in completion trajectory | issue-openclaw-openclaw-118673 | MERGEABLE | BEHIND | CANCELLED:1 SUCCESS:55 SKIPPED:37 IN_PROGRESS:24 NEUTRAL:1; blockers:25 | needs_merge_state:BEHIND, needs_checks:ClawSweeper Dispatch / dispatch:CANCELLED; CI / build-artifacts:IN_PROGRESS; CI / QA Smoke CI (profile 2/4):IN_PROGRESS, needs_merge_preflight | repair failing checks or document unrelated main flake with touched-surface proof |
