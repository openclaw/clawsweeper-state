...
Last source update: Sep 6, 2026, 09:28 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Planning review | Sep 6, 2026, 09:28 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34024696599) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 6, 2026, 09:28 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34024696566) |
...
Last source update: Sep 6, 2026, 09:10 UTC
...
| Run attempts archived | 2735 | audit |
| Latest successful clusters | 718 | 81.9% |
| Latest failed clusters | 157 | 17.9% |
...
- Latest records: 877 clusters: 304 maintainer action, 133 automation snapshot, 403 intervention needed, 37 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#139963](https://github.com/openclaw/openclaw/pull/139963) is automation_failed: The producer/dispatcher mismatch supports a narrow existing-behavior repair. Keep the issue open; establish a failing lifecycle regressio....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#139847](https://github.com/openclaw/openclaw/issues/139847) is action_planned: Repair the queued lifecycle owner's missing use of the existing preparation contract. Preserve registry enforcement and per-turn restrict....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 304 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 133 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#139963](https://github.com/openclaw/openclaw/pull/139963) | automation_failed | The producer/dispatcher mismatch supports a narrow existing-behavior repair. Keep the issue open; establish a failing lifecycle regression and refr... | Sep 6, 2026, 09:10 UTC | [issue-openclaw-openclaw-139963](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-139963.md) | [34023570458](https://github.com/openclaw/clawsweeper/actions/runs/34023570458) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [cluster:issue-openclaw-openclaw-139950](cluster:issue-openclaw-openclaw-139950) | automation_failed | Implementation and publication require the writable executor to apply and validate the attached fix plan. | Sep 6, 2026, 09:01 UTC | [issue-openclaw-openclaw-139950](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-139950.md) | [34023091794](https://github.com/openclaw/clawsweeper/actions/runs/34023091794) |
