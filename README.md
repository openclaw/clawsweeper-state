...
Last source update: Sep 15, 2026, 02:27 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Sep 15, 2026, 02:27 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34919412562) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 15, 2026, 01:59 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34919409652) |
...
| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1041 | 100% |
| Run attempts archived | 3164 | audit |
| Latest successful clusters | 876 | 84.1% |
...
- Latest records: 1041 clusters: 326 maintainer action, 254 automation snapshot, 418 intervention needed, 43 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#148317](https://github.com/openclaw/openclaw/pull/148317) is automation_failed: Maintainer opted this PR into ClawSweeper automerge/autofix repair; run the direct Codex edit loop after live hydration instead of a sepa....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#148680](https://github.com/openclaw/openclaw/pull/148680) is action_planned: The supplied evidence supports a focused existing-behavior repair. Establish a failing real-transcript regression before implementation,....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 326 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 254 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#148317](https://github.com/openclaw/openclaw/pull/148317) | automation_failed | Maintainer opted this PR into ClawSweeper automerge/autofix repair; run the direct Codex edit loop after live hydration instead of a separate read-... | Sep 15, 2026, 02:27 UTC | [automerge-openclaw-openclaw-148317](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-openclaw-148317.md) | [34918794562](https://github.com/openclaw/clawsweeper/actions/runs/34918794562) |
