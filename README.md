...
Last source update: Aug 20, 2026, 21:52 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Hot intake publish complete | Aug 20, 2026, 21:52 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32418648993) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 20, 2026, 21:50 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32421256221) |
...
Last source update: Aug 20, 2026, 21:50 UTC
...
| Run attempts archived | 1708 | audit |
...
- Latest records: 552 clusters: 212 maintainer action, 116 automation snapshot, 197 intervention needed, 27 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [issue-openclaw-openclaw-121252](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-121252.md) is automation_blocked: fix artifact is too broad for autonomous execution; split into narrower jobs or explicitly set CLAWSWEEPER_ALLOW_BROAD_FIX_ARTIFACTS=1.
...
| Intervention Needed | 197 | automation failure or blocker recorded |
