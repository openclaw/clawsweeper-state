...
target_branch: clawsweeper/automerge-openclaw-openclaw-83136
source: pr_automerge
---

# ClawSweeper adopted PR repair candidate

Maintainer opted #83136 into ClawSweeper automerge.

Source PR: https://github.com/openclaw/openclaw/pull/83136
Title: fix(plugins): default 15s timeout for before_agent_start hook (#48534)

ClawSweeper should use this job only for the bounded ClawSweeper review/fix loop:

- Emit a fix artifact with `repair_strategy: "repair_contributor_branch"` and `source_prs: ["https://github.com/openclaw/openclaw/pull/83136"]` so the Codex edit pass can make this PR merge-ready.
