...
Last source update: Sep 15, 2026, 07:32 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review in progress | Sep 15, 2026, 07:32 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34941916995) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 15, 2026, 07:28 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34941719748) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Sep 15, 2026, 04:48 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34930204944) |
...
Last source update: Sep 15, 2026, 07:15 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1043 | 100% |
| Run attempts archived | 3170 | audit |
| Latest successful clusters | 878 | 84.2% |
...
- Latest records: 1043 clusters: 326 maintainer action, 255 automation snapshot, 418 intervention needed, 44 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [cluster:issue-openclaw-openclaw-148796](cluster:issue-openclaw-openclaw-148796) is automation_failed: Implementation and publication are blocked pending writable execution, successful reproduction, focused validation, and fresh review. Mer....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#148317](https://github.com/openclaw/openclaw/pull/148317) is action_planned: Complete the requested branch-refresh and validation loop, changing code only for concrete review findings or attributable check failures....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 326 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 255 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [cluster:issue-openclaw-openclaw-148796](cluster:issue-openclaw-openclaw-148796) | automation_failed | Implementation and publication are blocked pending writable execution, successful reproduction, focused validation, and fresh review. Merge and iss... | Sep 15, 2026, 07:15 UTC | [issue-openclaw-openclaw-148796](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-148796.md) | [34933000400](https://github.com/openclaw/clawsweeper/actions/runs/34933000400) |
