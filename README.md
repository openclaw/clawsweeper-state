...
Last source update: Sep 25, 2026, 03:06 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review in progress | Sep 25, 2026, 03:06 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/36088580134) |
...
Last source update: Sep 25, 2026, 03:01 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1198 | 100% |
| Run attempts archived | 3594 | audit |
...
- Latest records: 1198 clusters: 343 maintainer action, 357 automation snapshot, 449 intervention needed, 49 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [cluster:issue-openclaw-openclaw-157827](cluster:issue-openclaw-openclaw-157827) is automation_failed: Implementation and PR preparation require a writable checkout with dependencies and an observed failing CLI regression..
