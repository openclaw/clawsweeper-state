...
Last source update: Aug 22, 2026, 04:31 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Hot intake publish complete | Aug 22, 2026, 04:31 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32550313747) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 22, 2026, 04:18 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32551309611) |
...
| Run attempts archived | 1830 | audit |
| Latest successful clusters | 474 | 82.9% |
| Latest failed clusters | 96 | 16.8% |
| Latest cancelled clusters | 2 | 0.3% |
| Needs-human clusters | 45 | 7.9% |
...
- Latest records: 572 clusters: 215 maintainer action, 115 automation snapshot, 215 intervention needed, 27 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [issue-openclaw-openclaw-127287](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-127287.md) is maintainer_input: Provide a writable repair environment with ../codex available (or explicitly resolve the repository’s direct Codex-source gate) so the br....
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#101593](https://github.com/openclaw/openclaw/pull/101593) is automation_failed: Maintainer opted this PR into ClawSweeper automerge/autofix repair; run the direct Codex edit loop after live hydration instead of a sepa....
...
| Intervention Needed | 215 | automation failure or blocker recorded |
...
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [cluster:issue-openclaw-openclaw-124689](cluster:issue-openclaw-openclaw-124689) | automation_failed | Create/update clawsweeper/issue-openclaw-openclaw-124689 in a writable checkout, complete the direct Codex audit, then run the artifact validation... | Aug 22, 2026, 04:25 UTC | [issue-openclaw-openclaw-124689](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-124689.md) | [32551128407](https://github.com/openclaw/clawsweeper/actions/runs/32551128407) |
...
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#125776](https://github.com/openclaw/openclaw/pull/125776) | automation_failed | The source reproduction is clear, but this worker cannot create the branch, install dependencies, or satisfy the mandatory direct Codex-source gate. | Aug 22, 2026, 04:06 UTC | [issue-openclaw-openclaw-125776](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-125776.md) | [32550127190](https://github.com/openclaw/clawsweeper/actions/runs/32550127190) |
