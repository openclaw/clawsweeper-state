...
Last source update: Sep 21, 2026, 11:44 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 21, 2026, 11:44 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35593583359) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 21, 2026, 11:44 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35595524114) |
...
Last source update: Sep 21, 2026, 11:01 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1139 | 100% |
| Run attempts archived | 3399 | audit |
| Latest successful clusters | 969 | 85.1% |
| Latest failed clusters | 167 | 14.7% |
...
- Latest records: 1139 clusters: 339 maintainer action, 327 automation snapshot, 425 intervention needed, 48 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#154145](https://github.com/openclaw/openclaw/pull/154145) is automation_failed: The source finding remains valid and supports a focused new fix PR. Keep the issue open; this job prohibits closing and merging..
...
| Intervention Needed | 425 | automation failure or blocker recorded |
