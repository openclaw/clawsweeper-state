...
cluster_id: automerge-openclaw-openclaw-156340
mode: autonomous
...
target_branch: clawsweeper/automerge-openclaw-openclaw-156340
source: pr_automerge
...
Title: feat(ui): show latest commentary while agents work

ClawSweeper should use this job only for the bounded ClawSweeper review/fix loop:

- Emit a fix artifact with `repair_strategy: "repair_contributor_branch"` and `source_prs: ["https://github.com/openclaw/openclaw/pull/156340"]` so the Codex edit pass can make this PR merge-ready.
