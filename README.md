...
Last source update: Aug 20, 2026, 08:14 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Aug 20, 2026, 08:14 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32342762142) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 20, 2026, 07:54 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32346092658) |
...
Last source update: Aug 20, 2026, 08:11 UTC
...
| Run attempts archived | 1651 | audit |
| Latest successful clusters | 462 | 84.2% |
| Latest failed clusters | 85 | 15.5% |
| Latest cancelled clusters | 2 | 0.4% |
| Needs-human clusters | 39 | 7.1% |
...
- Latest records: 549 clusters: 210 maintainer action, 116 automation snapshot, 196 intervention needed, 27 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#124751](https://github.com/openclaw/openclaw/issues/124751) is maintainer_input: Provide the required sibling ../codex checkout (or a read-only equivalent) so the mandatory direct Codex protocol/runtime inspection can....
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#123318](https://github.com/openclaw/openclaw/pull/123318) is automation_failed: The source fix is narrow and bug-only; implementation and validation require a writable executor..
...
| --- | ---: | --- |
| Maintainer Action | 210 | explicit decision, access, or merge authority recorded |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#123318](https://github.com/openclaw/openclaw/pull/123318) | automation_failed | The source fix is narrow and bug-only; implementation and validation require a writable executor. | Aug 20, 2026, 08:11 UTC | [issue-openclaw-openclaw-123318](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-123318.md) | [32343564025](https://github.com/openclaw/clawsweeper/actions/runs/32343564025) |
