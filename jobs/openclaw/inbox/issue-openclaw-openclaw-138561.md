...
target_branch: clawsweeper/issue-openclaw-openclaw-138561
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/138561.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 138561
source_issue_revision_sha256: "edf8e165a12d3ec93bc4e2fc008735aaa2f08394551155b97983a5be5f510f60"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-138561`.

Source issue: https://github.com/openclaw/openclaw/issues/138561
Title: [Bug]: active-memory plugin stops recalling after 2026.8.2 upgrade, with no signal at info log level

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/138561.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/138561.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/138561.md
Category: bug
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-138561` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/138561 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/138561 when the implementation satisfies the issue.
