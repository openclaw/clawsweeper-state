...
Last source update: Sep 20, 2026, 07:24 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 20, 2026, 07:24 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35496664862) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 20, 2026, 07:23 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35496677792) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Sep 20, 2026, 05:44 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35492404877) |
...
Last source update: Sep 20, 2026, 07:21 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1121 | 100% |
| Run attempts archived | 3359 | audit |
| Latest successful clusters | 952 | 84.9% |
...
- Latest records: 1121 clusters: 337 maintainer action, 312 automation snapshot, 424 intervention needed, 48 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#153502](https://github.com/openclaw/openclaw/pull/153502) is automation_failed: Implementation is blocked on a writable executor. Reproduce against refreshed main before editing; stop for retriage if the specified fai....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#153391](https://github.com/openclaw/openclaw/pull/153391) is action_planned: Restore existing configuration behavior through shared payload handling, preserving isolated-completion constraints. Reproduction must pr....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 337 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 312 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#153502](https://github.com/openclaw/openclaw/pull/153502) | automation_failed | Implementation is blocked on a writable executor. Reproduce against refreshed main before editing; stop for retriage if the specified failure does... | Sep 20, 2026, 07:21 UTC | [issue-openclaw-openclaw-153502](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-153502.md) | [35494650988](https://github.com/openclaw/clawsweeper/actions/runs/35494650988) |
