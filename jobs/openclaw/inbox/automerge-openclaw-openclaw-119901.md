...
Title: fix(doctor): analyze SQLite databases after offline compaction

ClawSweeper should use this job only for the bounded ClawSweeper review/fix loop:

- Emit a fix artifact with `repair_strategy: "repair_contributor_branch"` and `source_prs: ["https://github.com/openclaw/openclaw/pull/119901"]` so the Codex edit pass can make this PR merge-ready.
