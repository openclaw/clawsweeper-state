...
Generated: 2026-08-08T04:23:51.645Z
...
| [#120298](https://github.com/openclaw/openclaw/pull/120298) | fix(config): preserve manual .bak.* backups | issue-openclaw-openclaw-120253 | MERGEABLE | BEHIND | SKIPPED:44 SUCCESS:76 FAILURE:5 NEUTRAL:1; blockers:5 | needs_merge_state:BEHIND, needs_checks:CI / check-prod-types:FAILURE; CI / check-lint:FAILURE; CI / check-test-types:FAILURE, needs_merge_preflight | repair failing checks or document unrelated main flake with touched-surface proof |
