...
Last source update: Aug 25, 2026, 00:38 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review in progress | Aug 25, 2026, 00:38 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32793940854) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Aug 25, 2026, 00:36 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32794295018) |
...
Last source update: Aug 25, 2026, 00:04 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 610 | 100% |
| Run attempts archived | 2111 | audit |
| Latest successful clusters | 508 | 83.3% |
| Latest failed clusters | 100 | 16.4% |
| Latest cancelled clusters | 2 | 0.3% |
| Needs-human clusters | 55 | 9.0% |
...
- Latest records: 610 clusters: 226 maintainer action, 114 automation snapshot, 242 intervention needed, 28 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [issue-openclaw-openclaw-125838](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-125838.md) is maintainer_input: Provide a writable checkout with runnable pnpm/Corepack dependencies and the required sibling `../codex` source checkout; then create or....
...
| --- | ---: | --- |
| Maintainer Action | 226 | explicit decision, access, or merge authority recorded |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) |  | maintainer_input | Provide a writable checkout with runnable pnpm/Corepack dependencies and the required sibling `../codex` source checkout; then create or update bra... | Aug 24, 2026, 23:13 UTC | [issue-openclaw-openclaw-125838](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-125838.md) | [32787616523](https://github.com/openclaw/clawsweeper/actions/runs/32787616523) |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) |  | automation_blocked | validation command failed (pnpm check:changed): $ node scripts/check-changed.mjs [check:changed] lanes=core, coreTests [check:changed] src/node-hos... | Aug 25, 2026, 00:04 UTC | [issue-openclaw-openclaw-128889](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-128889.md) | [32786780414](https://github.com/openclaw/clawsweeper/actions/runs/32786780414) |
...
| --- | --- | --- | --- | --- |
| issue-openclaw-openclaw-128889 | execute_fix blocked | validation command failed (pnpm check:changed): $ node scripts/check-changed.mjs [check:changed] lanes=core, coreTests [check:changed] src/node-hos... | [issue-openclaw-openclaw-128889](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-128889.md) | [32786780414](https://github.com/openclaw/clawsweeper/actions/runs/32786780414) |
| issue-openclaw-openclaw-125838 | needs human | Provide a writable checkout with runnable pnpm/Corepack dependencies and the required sibling `../codex` source checkout; then create or update bra... | [issue-openclaw-openclaw-125838](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-125838.md) | [32787616523](https://github.com/openclaw/clawsweeper/actions/runs/32787616523) |
