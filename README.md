...
Last source update: Aug 22, 2026, 22:37 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Hot intake publish complete | Aug 22, 2026, 22:37 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32602414715) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 22, 2026, 22:34 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32602734273) |
...
Last source update: Aug 22, 2026, 22:39 UTC
...
| Run attempts archived | 1955 | audit |
| Latest successful clusters | 478 | 82.0% |
| Latest failed clusters | 103 | 17.7% |
...
- Latest records: 583 clusters: 215 maintainer action, 115 automation snapshot, 226 intervention needed, 27 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#89528](https://github.com/openclaw/openclaw/pull/89528) is automation_failed: Implementation is blocked only by the missing mandatory Codex checkout and read-only execution environment; the canonical repair remains....
