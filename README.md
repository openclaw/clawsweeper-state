...
Last source update: Sep 9, 2026, 05:31 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 9, 2026, 05:31 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34314415807) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 9, 2026, 05:30 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34315094929) |
...
Last source update: Sep 9, 2026, 05:25 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 942 | 100% |
| Run attempts archived | 2871 | audit |
| Latest successful clusters | 780 | 82.8% |
| Latest failed clusters | 160 | 17.0% |
| Latest cancelled clusters | 2 | 0.2% |
| Needs-human clusters | 121 | 12.8% |
...
- Latest records: 942 clusters: 311 maintainer action, 182 automation snapshot, 412 intervention needed, 37 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#40078](https://github.com/openclaw/openclaw/issues/40078) is maintainer_input: Conservatively route this feature's capture and retention concerns to central security handling without asserting a vulnerability. No mut....
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#142847](https://github.com/openclaw/openclaw/pull/142847) is automation_failed: The issue remains source-supported and needs a focused repair. Native reproduction must precede production edits..
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#142847](https://github.com/openclaw/openclaw/pull/142847) | automation_failed | The issue remains source-supported and needs a focused repair. Native reproduction must precede production edits. | Sep 9, 2026, 05:25 UTC | [issue-openclaw-openclaw-142847](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-142847.md) | [34314358536](https://github.com/openclaw/clawsweeper/actions/runs/34314358536) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#142626](https://github.com/openclaw/openclaw/pull/142626) | automation_failed | Maintainer opted this PR into ClawSweeper automerge/autofix repair; run the direct Codex edit loop after live hydration instead of a separate read-... | Sep 9, 2026, 05:20 UTC | [automerge-openclaw-openclaw-142626](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-openclaw-142626.md) | [34312846731](https://github.com/openclaw/clawsweeper/actions/runs/34312846731) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) |  | automation_failed | Codex fix worker timed out after 1800000ms | Sep 9, 2026, 04:52 UTC | [issue-openclaw-openclaw-142820](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-142820.md) | [34310212267](https://github.com/openclaw/clawsweeper/actions/runs/34310212267) |
...
| --- | --- | --- | --- | --- |
| issue-openclaw-openclaw-142820 | execute_fix blocked | Codex fix worker timed out after 1800000ms | [issue-openclaw-openclaw-142820](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-142820.md) | [34310212267](https://github.com/openclaw/clawsweeper/actions/runs/34310212267) |
...
| --- | --- | --- | --- | --- | --- |
| [issue-openclaw-openclaw-142820](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-142820.md) | blocked |  |  | Codex fix worker timed out after 1800000ms | [34310212267](https://github.com/openclaw/clawsweeper/actions/runs/34310212267) |
