...
target_branch: clawsweeper/issue-openclaw-clawsweeper-189
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-clawsweeper-189`.

Source issue: https://github.com/openclaw/clawsweeper/issues/189
Title: Add AGENTS.md policy status to review details

## Maintainer Context

- Command comment: https://github.com/openclaw/clawsweeper/issues/189#issuecomment-4530617339
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-clawsweeper-189` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/clawsweeper/issues/189 in the PR body.
