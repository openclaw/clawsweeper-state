...
Last source update: Sep 8, 2026, 19:13 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Sep 8, 2026, 19:13 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34265516475) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 8, 2026, 18:47 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34264954693) |
...
Last source update: Sep 8, 2026, 19:03 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 928 | 100% |
| Run attempts archived | 2842 | audit |
| Latest successful clusters | 769 | 82.9% |
| Latest failed clusters | 157 | 16.9% |
...
- Latest records: 928 clusters: 310 maintainer action, 172 automation snapshot, 409 intervention needed, 37 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#142429](https://github.com/openclaw/openclaw/pull/142429) is automation_failed: Keep the issue open and repair the presentation while preserving existing global writes and agent-scoped provider behavior..
