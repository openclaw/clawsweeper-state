...
Last source update: Aug 11, 2026, 15:16 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Planning review | Aug 11, 2026, 15:16 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31505915260) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Aug 11, 2026, 14:43 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31503034840) |
...
Last source update: Aug 11, 2026, 15:27 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 478 | 100% |
| Run attempts archived | 1333 | audit |
| Latest successful clusters | 408 | 85.4% |
...
- Latest records: 478 clusters: 195 maintainer action, 101 automation snapshot, 157 intervention needed, 25 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [automerge-openclaw-openclaw-118751](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-openclaw-118751.md) is automation_failed: validation command failed (pnpm check:changed): $ node scripts/check-changed.mjs [check:changed] lanes=core, coreTests [check:changed] sr....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#120150](https://github.com/openclaw/openclaw/pull/120150) is action_planned: Rebase and repair the existing contributor branch rather than replace it; preserve the PR body’s credit to @patelmm79 and source history..
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 195 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 101 | repair, check, or planned action recorded; verify live status |
