...
Last source update: Aug 30, 2026, 13:12 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Planning review | Aug 30, 2026, 13:12 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33313184068) |
...
- Latest records: 708 clusters: 251 maintainer action, 115 automation snapshot, 310 intervention needed, 32 no pending action, 0 completed.
- Maintainer first: [openclaw/fs-safe](https://github.com/openclaw/fs-safe) [#174](https://github.com/openclaw/fs-safe/pull/174) is merge_not_authorized: job does not allow merge.
...
| --- | ---: | --- |
| job does not allow merge | 106 | [automerge-openclaw-fs-safe-174](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-fs-safe-174.md) |
