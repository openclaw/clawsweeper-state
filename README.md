...
Last source update: Sep 3, 2026, 08:41 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review comments checked | Sep 3, 2026, 08:41 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33732263202) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 3, 2026, 08:31 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33733656449) |
...
Last source update: Sep 3, 2026, 08:21 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 798 | 100% |
| Run attempts archived | 2571 | audit |
| Latest successful clusters | 660 | 82.7% |
...
- Latest records: 798 clusters: 287 maintainer action, 114 automation snapshot, 362 intervention needed, 35 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#137085](https://github.com/openclaw/openclaw/pull/137085) is automation_failed: The implementation itself is narrow and non-security-sensitive, but direct Codex-source inspection, a mutable branch, and runnable Apple-....
...
| Intervention Needed | 362 | automation failure or blocker recorded |
