...
Last source update: Aug 23, 2026, 00:34 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review publish complete | Aug 23, 2026, 00:34 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32607340536) |
...
Last source update: Aug 23, 2026, 00:31 UTC
...
| Run attempts archived | 1972 | audit |
| Latest successful clusters | 479 | 82.0% |
| Latest failed clusters | 103 | 17.6% |
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#45224](https://github.com/openclaw/openclaw/pull/45224) is automation_failed: A narrow repair is indicated, but implementation must wait for a writable checkout with dependencies and the mandatory Codex source avail....
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#45224](https://github.com/openclaw/openclaw/pull/45224) | automation_failed | A narrow repair is indicated, but implementation must wait for a writable checkout with dependencies and the mandatory Codex source available. | Aug 23, 2026, 00:31 UTC | [issue-openclaw-openclaw-45224](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-45224.md) | [32607660457](https://github.com/openclaw/clawsweeper/actions/runs/32607660457) |
