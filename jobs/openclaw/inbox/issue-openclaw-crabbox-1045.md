...
target_branch: clawsweeper/issue-openclaw-crabbox-1045
source: issue_implementation
trigger_source: review_viable_issue
clawsweeper_report_path: records/openclaw-crabbox/items/1045.md
source_issue_repo: "openclaw/crabbox"
source_issue_number: 1045
source_issue_revision_sha256: "b8379ea643839e68b4cac53f6c997826362474ab6a659aa8ec2101eea49932a5"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-crabbox-1045`.

Source issue: https://github.com/openclaw/crabbox/issues/1045
Title: Emoy

## Maintainer Context

- Trigger source: review_viable_issue
- ClawSweeper review report: records/openclaw-crabbox/items/1045.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-crabbox/items/1045.md
- Maintainer instruction: ClawSweeper finished reviewing this open issue and found no active implementation PR.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-crabbox/items/1045.md
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-crabbox-1045` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/crabbox/issues/1045 in the PR body.
- Use a closing reference for https://github.com/openclaw/crabbox/issues/1045 when the implementation satisfies the issue.
