...
Last source update: Sep 17, 2026, 01:04 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 17, 2026, 00:57 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35168498070) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 17, 2026, 01:04 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35169027733) |
...
Last source update: Sep 17, 2026, 00:33 UTC
...
| Run attempts archived | 3256 | audit |
| Latest successful clusters | 908 | 84.5% |
...
- Latest records: 1075 clusters: 329 maintainer action, 279 automation snapshot, 421 intervention needed, 46 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#150322](https://github.com/openclaw/openclaw/pull/150322) is automation_failed: A bounded existing-behavior repair is supported by current source. Runtime reproduction must precede implementation in a writable executor..
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#150298](https://github.com/openclaw/openclaw/pull/150298) is action_planned: A bounded regression in established keyboard input has a clear existing owner. Prepare the fix only after a failing registered-route regr....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 329 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 279 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#150322](https://github.com/openclaw/openclaw/pull/150322) | automation_failed | A bounded existing-behavior repair is supported by current source. Runtime reproduction must precede implementation in a writable executor. | Sep 17, 2026, 00:33 UTC | [issue-openclaw-openclaw-150322](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-150322.md) | [35164788920](https://github.com/openclaw/clawsweeper/actions/runs/35164788920) |
