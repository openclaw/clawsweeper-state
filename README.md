...
Last source update: Sep 19, 2026, 17:07 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review in progress | Sep 19, 2026, 17:07 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35456933135) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 19, 2026, 16:57 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35456472207) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Sep 19, 2026, 16:20 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35454632481) |
...
Last source update: Sep 19, 2026, 16:54 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1111 | 100% |
| Run attempts archived | 3341 | audit |
| Latest successful clusters | 944 | 85.0% |
...
- Latest records: 1111 clusters: 333 maintainer action, 308 automation snapshot, 422 intervention needed, 48 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#153003](https://github.com/openclaw/openclaw/pull/153003) is automation_failed: A narrow repair remains warranted; runtime reproduction must precede production edits in a writable executor..
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#152970](https://github.com/openclaw/openclaw/pull/152970) is action_planned: Initial readiness handling needs its own repair; merged post-restart handling does not cover this entry path. Proceed only after the exec....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 333 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 308 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#153003](https://github.com/openclaw/openclaw/pull/153003) | automation_failed | A narrow repair remains warranted; runtime reproduction must precede production edits in a writable executor. | Sep 19, 2026, 16:54 UTC | [issue-openclaw-openclaw-153003](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-153003.md) | [35453409829](https://github.com/openclaw/clawsweeper/actions/runs/35453409829) |
