...
Last source update: Aug 30, 2026, 17:31 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Planning review | Aug 30, 2026, 17:31 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33325086924) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 30, 2026, 17:27 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33325216541) |
...
Last source update: Aug 30, 2026, 16:51 UTC
...
| Run attempts archived | 2421 | audit |
| Latest successful clusters | 596 | 83.7% |
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#107487](https://github.com/openclaw/openclaw/pull/107487) is automation_failed: Run the artifact in a writable checkout with installed acpx@0.13.1 and sibling ../codex source, then reproduce, validate, and open/update....
