...
Last source update: Sep 17, 2026, 05:24 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 17, 2026, 05:24 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35183500360) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 17, 2026, 05:24 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35185483813) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Sep 17, 2026, 05:23 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35185494162) |
...
Last source update: Sep 17, 2026, 05:08 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1076 | 100% |
| Run attempts archived | 3258 | audit |
| Latest successful clusters | 909 | 84.5% |
| Latest failed clusters | 165 | 15.3% |
| Latest cancelled clusters | 2 | 0.2% |
| Needs-human clusters | 123 | 11.4% |
...
- Latest records: 1076 clusters: 329 maintainer action, 280 automation snapshot, 421 intervention needed, 46 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [cluster:issue-openclaw-openclaw-150601](cluster:issue-openclaw-openclaw-150601) is automation_failed: Implementation and publication require a writable executor with dependencies and browser capture support. Required screenshots must be in....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#150322](https://github.com/openclaw/openclaw/pull/150322) is action_planned: The issue has a narrow existing-behavior repair path. Establish a failing handler regression before implementation; leave closure and mer....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 329 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 280 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#150322](https://github.com/openclaw/openclaw/pull/150322) | action_planned | The issue has a narrow existing-behavior repair path. Establish a failing handler regression before implementation; leave closure and merging outsi... | Sep 17, 2026, 01:10 UTC | [issue-openclaw-openclaw-150322](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-150322.md) | [35169239773](https://github.com/openclaw/clawsweeper/actions/runs/35169239773) |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [cluster:issue-openclaw-openclaw-150601](cluster:issue-openclaw-openclaw-150601) | automation_failed | Implementation and publication require a writable executor with dependencies and browser capture support. Required screenshots must be inspected an... | Sep 17, 2026, 05:08 UTC | [issue-openclaw-openclaw-150601](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-150601.md) | [35184044490](https://github.com/openclaw/clawsweeper/actions/runs/35184044490) |
