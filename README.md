...
Last source update: Sep 17, 2026, 17:48 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Planning review | Sep 17, 2026, 17:48 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35254830614) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 17, 2026, 17:43 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35254277700) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Sep 17, 2026, 16:47 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35248644795) |
...
| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1082 | 100% |
| Run attempts archived | 3270 | audit |
| Latest successful clusters | 915 | 84.6% |
| Latest failed clusters | 165 | 15.2% |
...
- Latest records: 1082 clusters: 329 maintainer action, 286 automation snapshot, 421 intervention needed, 46 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [cluster:issue-openclaw-openclaw-151006](cluster:issue-openclaw-openclaw-151006) is automation_failed: Publication is blocked until the executor completes duplicate detection, reproduces the defect on current main, implements the fix, and p....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#150974](https://github.com/openclaw/openclaw/issues/150974) is action_planned: A bounded existing-behavior repair has a clear owner. Keep the issue open while the executor establishes the required failing native regr....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 329 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 286 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [cluster:issue-openclaw-openclaw-151006](cluster:issue-openclaw-openclaw-151006) | automation_failed | Publication is blocked until the executor completes duplicate detection, reproduces the defect on current main, implements the fix, and passes focu... | Sep 17, 2026, 17:48 UTC | [issue-openclaw-openclaw-151006](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-151006.md) | [35250803039](https://github.com/openclaw/clawsweeper/actions/runs/35250803039) |
