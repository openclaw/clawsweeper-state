...
Last source update: Sep 5, 2026, 02:19 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Sep 5, 2026, 02:19 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33938443300) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 5, 2026, 01:57 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33937646642) |
...
Last source update: Sep 5, 2026, 02:07 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 844 | 100% |
| Run attempts archived | 2660 | audit |
| Latest successful clusters | 697 | 82.6% |
...
- Latest records: 844 clusters: 300 maintainer action, 121 automation snapshot, 388 intervention needed, 35 no pending action, 0 completed.
