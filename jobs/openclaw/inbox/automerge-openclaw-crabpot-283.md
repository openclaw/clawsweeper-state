...
target_branch: clawsweeper/automerge-openclaw-crabpot-283
source: pr_automerge
...
Title: chore: pin plugin-inspector 0.3.21 source

ClawSweeper should use this job only for the bounded ClawSweeper review/fix loop:

- Emit a fix artifact with `repair_strategy: "repair_contributor_branch"` and `source_prs: ["https://github.com/openclaw/crabpot/pull/283"]` so the Codex edit pass can make this PR merge-ready.
