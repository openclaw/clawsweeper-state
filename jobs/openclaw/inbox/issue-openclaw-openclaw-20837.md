...
target_branch: clawsweeper/issue-openclaw-openclaw-20837
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/20837.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 20837
source_issue_revision_sha256: "40f49f6e630cc7669ef6f0a59032be1df44924e0a04f9a02f935c0f0f7d17cbc"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-20837`.

Source issue: https://github.com/openclaw/openclaw/issues/20837
Title: [Feature]: make agent aware of communication channel

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/20837.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/20837.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/20837.md
Category: bug
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-20837` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/20837 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/20837 when the implementation satisfies the issue.
