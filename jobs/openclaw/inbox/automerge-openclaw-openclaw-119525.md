...
target_branch: clawsweeper/automerge-openclaw-openclaw-119525
source: pr_automerge
...
Title: fix(memory): allow retry after search timeout

ClawSweeper should use this job only for the bounded ClawSweeper review/fix loop:

- Emit a fix artifact with `repair_strategy: "repair_contributor_branch"` and `source_prs: ["https://github.com/openclaw/openclaw/pull/119525"]` so the Codex edit pass can make this PR merge-ready.
