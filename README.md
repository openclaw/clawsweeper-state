...
Last source update: Aug 24, 2026, 21:31 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review comments checked | Aug 24, 2026, 21:31 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32777832099) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 24, 2026, 21:19 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32778754338) |
...
Last source update: Aug 24, 2026, 21:27 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 606 | 100% |
| Run attempts archived | 2105 | audit |
| Latest successful clusters | 503 | 83.0% |
| Latest failed clusters | 101 | 16.7% |
| Latest cancelled clusters | 2 | 0.3% |
| Needs-human clusters | 53 | 8.7% |
| Fix actions failed | 26 | 4.5% |
| Fix actions blocked | 110 | 19.2% |
...
- Latest records: 606 clusters: 224 maintainer action, 114 automation snapshot, 240 intervention needed, 28 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#128860](https://github.com/openclaw/openclaw/pull/128860) is automation_failed: Implementation is narrowly defined but blocked only by the worker environment: no write access, missing local test dependency, and unavai....
...
| --- | ---: | --- |
| Maintainer Action | 224 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 114 | repair, check, or planned action recorded; verify live status |
| Intervention Needed | 240 | automation failure or blocker recorded |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#128860](https://github.com/openclaw/openclaw/pull/128860) | automation_failed | Implementation is narrowly defined but blocked only by the worker environment: no write access, missing local test dependency, and unavailable mand... | Aug 24, 2026, 21:27 UTC | [issue-openclaw-openclaw-128860](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-128860.md) | [32776824511](https://github.com/openclaw/clawsweeper/actions/runs/32776824511) |
