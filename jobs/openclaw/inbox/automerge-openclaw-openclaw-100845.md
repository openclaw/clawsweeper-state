...
- Emit a fix artifact with `repair_strategy: "repair_contributor_branch"` and `source_prs: ["https://github.com/openclaw/openclaw/pull/100845"]` so the Codex edit pass can make this PR merge-ready.
