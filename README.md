...
Last source update: Sep 21, 2026, 04:10 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 21, 2026, 04:10 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35559047562) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 21, 2026, 03:58 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35559244089) |
...
Last source update: Sep 21, 2026, 04:08 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1134 | 100% |
| Run attempts archived | 3385 | audit |
| Latest successful clusters | 963 | 84.9% |
...
- Latest records: 1134 clusters: 339 maintainer action, 321 automation snapshot, 426 intervention needed, 48 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#154325](https://github.com/openclaw/openclaw/pull/154325) is automation_failed: The non-security bug has a narrow repair path. Only local implementation and validation are blocked by host restrictions; the executor mu....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#154227](https://github.com/openclaw/openclaw/pull/154227) is action_planned: A focused producer-side repair is supported by the report and source inspection. Execution must first demonstrate the failure on freshly....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 339 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 321 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#154325](https://github.com/openclaw/openclaw/pull/154325) | automation_failed | The non-security bug has a narrow repair path. Only local implementation and validation are blocked by host restrictions; the executor must demonst... | Sep 21, 2026, 04:08 UTC | [issue-openclaw-openclaw-154325](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-154325.md) | [35556074044](https://github.com/openclaw/clawsweeper/actions/runs/35556074044) |
