...
cluster_id: issue-openclaw-openclaw-77467
mode: autonomous
allowed_actions:
  - comment
  - label
...
target_branch: clawsweeper/issue-openclaw-openclaw-77467
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-77467`.

Source issue: https://github.com/openclaw/openclaw/issues/77467
Title: [Bug] MiniMax Portal OAuth token cannot auto-refresh — refreshOAuth method not implemented

## Maintainer Context

- Command comment: https://github.com/openclaw/openclaw/issues/77467#issuecomment-4373587880
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-77467` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/77467 in the PR body.
