...
Last source update: Aug 22, 2026, 05:43 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Aug 22, 2026, 05:43 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32553138867) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 22, 2026, 05:35 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32554694943) |
...
Last source update: Aug 22, 2026, 05:41 UTC
...
| Run attempts archived | 1839 | audit |
| Latest successful clusters | 474 | 82.7% |
| Latest failed clusters | 97 | 16.9% |
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [cluster:issue-openclaw-openclaw-127287](cluster:issue-openclaw-openclaw-127287) is automation_failed: Resume in a writable repair checkout that includes the required sibling Codex source, then run the artifact validation and open the one r....
