...
target_branch: clawsweeper/issue-openclaw-openclaw-windows-node-774
source: issue_implementation
trigger_source: review_viable_issue
clawsweeper_report_path: records/openclaw-openclaw-windows-node/items/774.md
source_issue_repo: "openclaw/openclaw-windows-node"
source_issue_number: 774
source_issue_revision_sha256: "9219b88ad98f88f1a8f5e849805f1f8e089ca6157364d3643b18fd3f7f9de5c0"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-windows-node-774`.

Source issue: https://github.com/openclaw/openclaw-windows-node/issues/774
Title: [aw] Repo Assist failed

## Maintainer Context

- Trigger source: review_viable_issue
- ClawSweeper review report: records/openclaw-openclaw-windows-node/items/774.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw-windows-node/items/774.md
- Maintainer instruction: ClawSweeper finished reviewing this open issue and found no active implementation PR.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw-windows-node/items/774.md
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-windows-node-774` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw-windows-node/issues/774 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw-windows-node/issues/774 when the implementation satisfies the issue.
