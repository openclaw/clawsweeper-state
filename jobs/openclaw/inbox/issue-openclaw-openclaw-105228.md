...
target_branch: clawsweeper/issue-openclaw-openclaw-105228
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/105228.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 105228
source_issue_revision_sha256: "1ee1f31b5e30451340d9424f3ba3ad3a9c10820712814d4ba9efbf5191ccd173"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-105228`.

Source issue: https://github.com/openclaw/openclaw/issues/105228
Title: fix(agents): missing AbortController propagation in ACPS subprocess spawner

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/105228.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/105228.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/105228.md
Category: bug
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-105228` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/105228 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/105228 when the implementation satisfies the issue.
