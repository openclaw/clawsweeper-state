...
Last source update: Sep 17, 2026, 12:56 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 17, 2026, 12:56 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35221627537) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 17, 2026, 12:52 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35223512109) |
...
Last source update: Sep 17, 2026, 12:49 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1080 | 100% |
| Run attempts archived | 3266 | audit |
| Latest successful clusters | 913 | 84.5% |
...
- Latest records: 1080 clusters: 329 maintainer action, 284 automation snapshot, 421 intervention needed, 46 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#150865](https://github.com/openclaw/openclaw/pull/150865) is automation_failed: A narrow existing-behavior repair is supported by source evidence. Establish the failing regression in a writable executor before changin....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#150809](https://github.com/openclaw/openclaw/pull/150809) is action_planned: A local transcript-validation failure is attributed to provider session expiry. Correct classification, prevent credential-health writes....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 329 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 284 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#150865](https://github.com/openclaw/openclaw/pull/150865) | automation_failed | A narrow existing-behavior repair is supported by source evidence. Establish the failing regression in a writable executor before changing producti... | Sep 17, 2026, 12:49 UTC | [issue-openclaw-openclaw-150865](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-150865.md) | [35219925289](https://github.com/openclaw/clawsweeper/actions/runs/35219925289) |
