...
cluster_id: "issue-openclaw-openclaw-121351"
mode: "autonomous"
run_id: "31351253782"
run_url: "https://github.com/openclaw/clawsweeper/actions/runs/31351253782"
head_sha: "13709144f5bd54cee22ec6a64ebc2b8fe0b021d5"
workflow_conclusion: "success"
result_status: "blocked"
published_at: "2026-08-10T03:47:09.233Z"
canonical: "https://github.com/openclaw/openclaw/issues/121351"
canonical_issue: "https://github.com/openclaw/openclaw/issues/121351"
canonical_pr: null
actions_total: 2
fix_executed: 0
fix_failed: 0
...
Run: [https://github.com/openclaw/clawsweeper/actions/runs/31351253782](https://github.com/openclaw/clawsweeper/actions/runs/31351253782)
...
#121351 is a confirmed canonical bug on current main (8430fc0e). The helper’s final `.trim()` removes the leading code-block indentation that its comment promises to preserve. The repair is narrow, but this read-only checkout cannot create the branch, edit files, or run the pnpm-backed test harness.
...
| Target | Action | Status | Classification | Reason |
| --- | --- | --- | --- | --- |
| #121351 | fix_needed | blocked | canonical | Implementation is blocked only by the read-only execution environment; the supplied fix artifact is ready for the deterministic executor. |
| cluster:issue-openclaw-openclaw-121351 | build_fix_artifact | planned | canonical | Create the one narrow credited autofix PR from the mandated ClawSweeper branch. |
