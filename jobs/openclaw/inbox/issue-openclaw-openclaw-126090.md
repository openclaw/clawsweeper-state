...
target_branch: clawsweeper/issue-openclaw-openclaw-126090
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/126090.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 126090
source_issue_revision_sha256: "41a6dcaab97f940b68c523170d5e9e547aaa1da207e43d47a0456328cc7a7685"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-126090`.

Source issue: https://github.com/openclaw/openclaw/issues/126090
Title: Bug: Telegram channel-final delivery-mirror bypasses text-based dedup, writes duplicate assistant messages to session transcript

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/126090.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/126090.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/126090.md
Category: bug
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-126090` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/126090 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/126090 when the implementation satisfies the issue.
