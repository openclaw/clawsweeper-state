...
Last source update: Sep 20, 2026, 12:47 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Sep 20, 2026, 12:47 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35510596524) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 20, 2026, 12:37 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35511109548) |
...
Last source update: Sep 20, 2026, 12:48 UTC
...
| Run attempts archived | 3366 | audit |
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#153682](https://github.com/openclaw/openclaw/pull/153682) is automation_failed: A narrow comparison repair is supported by current source. The required runtime regression and implementation need a writable executor..
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#153682](https://github.com/openclaw/openclaw/pull/153682) | automation_failed | A narrow comparison repair is supported by current source. The required runtime regression and implementation need a writable executor. | Sep 20, 2026, 12:48 UTC | [issue-openclaw-openclaw-153682](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-153682.md) | [35510881333](https://github.com/openclaw/clawsweeper/actions/runs/35510881333) |
