...
Last source update: Aug 9, 2026, 11:08 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review in progress | Aug 9, 2026, 10:53 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31309177316) |
...
Last source update: Aug 9, 2026, 10:53 UTC
...
| Run attempts archived | 1239 | audit |
| Latest successful clusters | 378 | 85.1% |
...
- Latest records: 444 clusters: 193 maintainer action, 93 automation snapshot, 134 intervention needed, 24 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [cluster:issue-openclaw-openclaw-55372](cluster:issue-openclaw-openclaw-55372) is automation_failed: An editable executor checkout is required to implement, validate, and open the planned PR with clawsweeper:autogenerated and clawsweeper:....
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [cluster:issue-openclaw-openclaw-55372](cluster:issue-openclaw-openclaw-55372) | automation_failed | An editable executor checkout is required to implement, validate, and open the planned PR with clawsweeper:autogenerated and clawsweeper:autofix la... | Aug 9, 2026, 10:53 UTC | [issue-openclaw-openclaw-55372](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-55372.md) | [31309033045](https://github.com/openclaw/clawsweeper/actions/runs/31309033045) |
