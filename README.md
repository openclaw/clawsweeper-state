...
Last source update: Sep 11, 2026, 22:28 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Planning review | Sep 11, 2026, 22:28 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34654026897) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 11, 2026, 22:21 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34653479291) |
...
Last source update: Sep 11, 2026, 22:23 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 994 | 100% |
| Run attempts archived | 3060 | audit |
| Latest successful clusters | 831 | 83.6% |
...
- Latest records: 994 clusters: 320 maintainer action, 220 automation snapshot, 415 intervention needed, 39 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#105763](https://github.com/openclaw/openclaw/issues/105763) is maintainer_input: Route this historical boundary decision to central OpenClaw security handling without mutation; it does not block the separate transcript....
...
| --- | ---: | --- |
| Maintainer Action | 320 | explicit decision, access, or merge authority recorded |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#105763](https://github.com/openclaw/openclaw/issues/105763) | maintainer_input | Route this historical boundary decision to central OpenClaw security handling without mutation; it does not block the separate transcript-resolver... | Sep 11, 2026, 22:23 UTC | [issue-openclaw-openclaw-145309](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-145309.md) | [34650747199](https://github.com/openclaw/clawsweeper/actions/runs/34650747199) |
...
| --- | --- | --- | --- | --- |
| issue-openclaw-openclaw-145309 | execute_fix blocked | Codex fix worker timed out after 1800000ms | [issue-openclaw-openclaw-145309](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-145309.md) | [34650747199](https://github.com/openclaw/clawsweeper/actions/runs/34650747199) |
...
| --- | --- | --- | --- | --- | --- |
| [issue-openclaw-openclaw-145309](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-145309.md) | blocked |  |  | Codex fix worker timed out after 1800000ms | [34650747199](https://github.com/openclaw/clawsweeper/actions/runs/34650747199) |
