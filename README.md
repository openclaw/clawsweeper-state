...
Last source update: Aug 23, 2026, 00:45 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review comments checked | Aug 23, 2026, 00:45 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32608046334) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 23, 2026, 00:26 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32607791647) |
...
Last source update: Aug 23, 2026, 00:44 UTC
...
| Run attempts archived | 1974 | audit |
| Latest successful clusters | 480 | 82.2% |
| Latest failed clusters | 102 | 17.5% |
...
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#45224](https://github.com/openclaw/openclaw/issues/45224) is maintainer_input: Provide the required sibling ../codex checkout and an executable checkout with dependencies, or explicitly waive the root Codex-source ga....
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [cluster:issue-openclaw-openclaw-124689](cluster:issue-openclaw-openclaw-124689) is automation_failed: A writable checkout with dependencies and sibling Codex source is required to add the pre-fix regression, implement, and validate the rep....
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#45224](https://github.com/openclaw/openclaw/issues/45224) | maintainer_input | Provide the required sibling ../codex checkout and an executable checkout with dependencies, or explicitly waive the root Codex-source gate for thi... | Aug 23, 2026, 00:44 UTC | [issue-openclaw-openclaw-45224](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-45224.md) | [32608305559](https://github.com/openclaw/clawsweeper/actions/runs/32608305559) |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [cluster:issue-openclaw-openclaw-124689](cluster:issue-openclaw-openclaw-124689) | automation_failed | A writable checkout with dependencies and sibling Codex source is required to add the pre-fix regression, implement, and validate the repair. | Aug 23, 2026, 00:19 UTC | [issue-openclaw-openclaw-124689](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-124689.md) | [32607139156](https://github.com/openclaw/clawsweeper/actions/runs/32607139156) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#128017](https://github.com/openclaw/openclaw/issues/128017) | automation_blocked | A single canonical body-normalization helper in query.ts should feed both raw-body scoring and snippet selection. | Aug 22, 2026, 23:44 UTC | [issue-openclaw-openclaw-128017](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-128017.md) | [32605533840](https://github.com/openclaw/clawsweeper/actions/runs/32605533840) |
...
| --- | --- | --- | --- | --- |
| issue-openclaw-openclaw-45224 | needs human | Provide the required sibling ../codex checkout and an executable checkout with dependencies, or explicitly waive the root Codex-source gate for thi... | [issue-openclaw-openclaw-45224](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-45224.md) | [32608305559](https://github.com/openclaw/clawsweeper/actions/runs/32608305559) |
