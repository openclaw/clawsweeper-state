...
Last source update: Sep 4, 2026, 01:51 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Sep 4, 2026, 01:50 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33823983419) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 4, 2026, 01:51 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33827250413) |
...
Last source update: Sep 4, 2026, 01:48 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 804 | 100% |
| Run attempts archived | 2583 | audit |
| Latest successful clusters | 662 | 82.3% |
| Latest failed clusters | 140 | 17.4% |
| Latest cancelled clusters | 2 | 0.2% |
| Needs-human clusters | 110 | 13.7% |
...
- Latest records: 804 clusters: 287 maintainer action, 115 automation snapshot, 367 intervention needed, 35 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#137742](https://github.com/openclaw/openclaw/pull/137742) is automation_failed: Produce the planned narrow repair in a writable checkout with ../codex available, then run the focused regression and changed gate..
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#137742](https://github.com/openclaw/openclaw/pull/137742) | automation_failed | Produce the planned narrow repair in a writable checkout with ../codex available, then run the focused regression and changed gate. | Sep 4, 2026, 01:48 UTC | [issue-openclaw-openclaw-137742](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-137742.md) | [33826174052](https://github.com/openclaw/clawsweeper/actions/runs/33826174052) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [cluster:issue-openclaw-openclaw-137690](cluster:issue-openclaw-openclaw-137690) | automation_failed | Create one narrow credited fix PR from clawsweeper/issue-openclaw-openclaw-137690. | Sep 4, 2026, 01:18 UTC | [issue-openclaw-openclaw-137690](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-137690.md) | [33822350006](https://github.com/openclaw/clawsweeper/actions/runs/33822350006) |
...
| [openclaw/openclaw](https://github.com/openclaw/openclaw) |  | automation_blocked | validation command failed (pnpm check:changed): $ node scripts/check-changed.mjs [check:changed] lanes=testRoot, apps, tooling [check:changed] apps... | Sep 3, 2026, 12:52 UTC | [issue-openclaw-openclaw-137085](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-137085.md) | [33748765755](https://github.com/openclaw/clawsweeper/actions/runs/33748765755) |
...
| --- | --- | --- | --- | --- |
| issue-openclaw-openclaw-137085 | execute_fix blocked | validation command failed (pnpm check:changed): $ node scripts/check-changed.mjs [check:changed] lanes=testRoot, apps, tooling [check:changed] apps... | [issue-openclaw-openclaw-137085](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-137085.md) | [33748765755](https://github.com/openclaw/clawsweeper/actions/runs/33748765755) |
...
| --- | --- | --- | --- | --- | --- |
| [issue-openclaw-openclaw-137085](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-137085.md) | blocked |  |  | validation command failed (pnpm check:changed): $ node scripts/check-changed.mjs [check:changed] lanes=testRoot, apps, tooling [check:changed] apps... | [33748765755](https://github.com/openclaw/clawsweeper/actions/runs/33748765755) |
