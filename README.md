...
Last source update: Aug 29, 2026, 16:29 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Aug 29, 2026, 16:17 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33261330643) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 29, 2026, 16:29 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33263053391) |
...
Last source update: Aug 29, 2026, 16:31 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 692 | 100% |
| Run attempts archived | 2347 | audit |
| Latest successful clusters | 576 | 83.2% |
| Latest failed clusters | 114 | 16.5% |
| Latest cancelled clusters | 2 | 0.3% |
| Needs-human clusters | 68 | 9.8% |
...
- Latest records: 692 clusters: 241 maintainer action, 113 automation snapshot, 308 intervention needed, 30 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [issue-openclaw-openclaw-132625](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-132625.md) is maintainer_input: Provide a writable task checkout with dependencies available so the regression can be added and run.; Provide the required sibling ../cod....
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#129173](https://github.com/openclaw/openclaw/pull/129173) is automation_failed: Repair is narrowly specified, but implementation cannot proceed in this read-only, dependency-incomplete checkout and cannot pass the rep....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#119735](https://github.com/openclaw/openclaw/pull/119735) is action_planned: Repair the writable same-repository contributor branch; no merge is authorized in this autofix job..
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 241 | explicit decision, access, or merge authority recorded |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#129173](https://github.com/openclaw/openclaw/pull/129173) | automation_failed | Repair is narrowly specified, but implementation cannot proceed in this read-only, dependency-incomplete checkout and cannot pass the repository's... | Aug 29, 2026, 16:31 UTC | [issue-openclaw-openclaw-129173](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-129173.md) | [33258872192](https://github.com/openclaw/clawsweeper/actions/runs/33258872192) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#119737](https://github.com/openclaw/openclaw/pull/119737) | automation_failed | Maintainer opted this PR into ClawSweeper automerge/autofix repair; run the direct Codex edit loop after live hydration instead of a separate read-... | Aug 29, 2026, 16:16 UTC | [automerge-openclaw-openclaw-119737](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-openclaw-119737.md) | [33259911466](https://github.com/openclaw/clawsweeper/actions/runs/33259911466) |
