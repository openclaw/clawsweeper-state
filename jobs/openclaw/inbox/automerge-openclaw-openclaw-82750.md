...
target_branch: clawsweeper/automerge-openclaw-openclaw-82750
source: pr_automerge
---

# ClawSweeper adopted PR repair candidate

Maintainer opted #82750 into ClawSweeper automerge.

Source PR: https://github.com/openclaw/openclaw/pull/82750
Title: fix(agents): normalize Copilot replay tool IDs

ClawSweeper should use this job only for the bounded ClawSweeper review/fix loop:

- Emit a fix artifact with `repair_strategy: "repair_contributor_branch"` and `source_prs: ["https://github.com/openclaw/openclaw/pull/82750"]` so the Codex edit pass can make this PR merge-ready.
