...
Last source update: Aug 20, 2026, 07:42 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Hot intake publish complete | Aug 20, 2026, 07:42 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32344381061) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Aug 20, 2026, 07:35 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32344706951) |
...
Last source update: Aug 20, 2026, 07:44 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 549 | 100% |
| Run attempts archived | 1647 | audit |
| Latest successful clusters | 463 | 84.3% |
| Latest failed clusters | 84 | 15.3% |
| Latest cancelled clusters | 2 | 0.4% |
| Needs-human clusters | 40 | 7.3% |
...
- Latest records: 549 clusters: 211 maintainer action, 116 automation snapshot, 195 intervention needed, 27 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [issue-openclaw-openclaw-113326](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-113326.md) is maintainer_input: Provide a writable repair environment containing sibling ../codex (https://github.com/openai/codex.git), then inspect the exact device-co....
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [cluster:issue-openclaw-openclaw-126571](cluster:issue-openclaw-openclaw-126571) is automation_failed: Executor must refresh main, obtain dependencies, satisfy the direct Codex-source gate, and validate before opening the PR..
...
| --- | ---: | --- |
| Maintainer Action | 211 | explicit decision, access, or merge authority recorded |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) |  | maintainer_input | Provide a writable repair environment containing sibling ../codex (https://github.com/openai/codex.git), then inspect the exact device-code/login p... | Aug 20, 2026, 07:44 UTC | [issue-openclaw-openclaw-113326](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-113326.md) | [32344748188](https://github.com/openclaw/clawsweeper/actions/runs/32344748188) |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [cluster:issue-openclaw-openclaw-126571](cluster:issue-openclaw-openclaw-126571) | automation_failed | Executor must refresh main, obtain dependencies, satisfy the direct Codex-source gate, and validate before opening the PR. | Aug 20, 2026, 07:39 UTC | [issue-openclaw-openclaw-126571](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-126571.md) | [32343784687](https://github.com/openclaw/clawsweeper/actions/runs/32343784687) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#95840](https://github.com/openclaw/openclaw/pull/95840) | automation_failed | A narrow provider-owned repair is ready to implement, but this worker cannot write the branch or install the missing dependency. | Aug 20, 2026, 07:34 UTC | [issue-openclaw-openclaw-95840](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-95840.md) | [32343560183](https://github.com/openclaw/clawsweeper/actions/runs/32343560183) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#123318](https://github.com/openclaw/openclaw/pull/123318) | automation_blocked | A writable executor must implement and validate the artifact; no GitHub mutation is permitted from this worker. | Aug 20, 2026, 07:24 UTC | [issue-openclaw-openclaw-123318](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-123318.md) | [32342829127](https://github.com/openclaw/clawsweeper/actions/runs/32342829127) |
...
| --- | --- | --- | --- | --- |
| issue-openclaw-openclaw-113326 | needs human | Provide a writable repair environment containing sibling ../codex (https://github.com/openai/codex.git), then inspect the exact device-code/login p... | [issue-openclaw-openclaw-113326](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-113326.md) | [32344748188](https://github.com/openclaw/clawsweeper/actions/runs/32344748188) |
