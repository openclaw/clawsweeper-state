...
Generated: 2026-08-03T15:24:08.530Z
...
| [#118685](https://github.com/openclaw/openclaw/pull/118685) | fix(agents): record stop reason in completion trajectory | issue-openclaw-openclaw-118673 | MERGEABLE | BEHIND | CANCELLED:3 SKIPPED:40 SUCCESS:79 FAILURE:2 NEUTRAL:1; blockers:4 | needs_merge_state:BEHIND, needs_checks:ClawSweeper Dispatch / dispatch:CANCELLED; Real behavior proof:CANCELLED; CI / checks-node-compact-large-8:FAILURE, needs_merge_preflight | repair failing checks or document unrelated main flake with touched-surface proof |
