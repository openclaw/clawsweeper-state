...
mode: "autonomous"
run_id: "31479658834"
run_url: "https://github.com/openclaw/clawsweeper/actions/runs/31479658834"
head_sha: "16e2959d529b25fdb5351c07ee9942ede27d6209"
workflow_conclusion: "success"
result_status: "blocked"
published_at: "2026-08-11T11:11:40.450Z"
canonical: "https://github.com/openclaw/openclaw/issues/121984"
canonical_issue: "https://github.com/openclaw/openclaw/issues/121984"
canonical_pr: null
actions_total: 3
fix_executed: 0
fix_failed: 0
...
# issue-openclaw-openclaw-121984

Repo: openclaw/openclaw

Run: [https://github.com/openclaw/clawsweeper/actions/runs/31479658834](https://github.com/openclaw/clawsweeper/actions/runs/31479658834)
...
#121984 is a source-proven, narrow data-loss fix: cleanup lowercases both stored keys and the requested key, so case-distinct Matrix and Signal sessions match together. A writable, dependency-capable executor is required to add the failing store-backed regression, apply the canonical-key matcher repair, and validate/open the PR.
...
| Target | Action | Status | Classification | Reason |
| --- | --- | --- | --- | --- |
| #121984 | fix_needed | planned | canonical | The bug is reproducible from the current source, but this worker has a read-only checkout and cannot install dependencies or write the required regression/fix branch. |
| cluster:issue-openclaw-openclaw-121984 | build_fix_artifact | planned |  | Prepare one narrow new-fix PR after validation is available. |
| cluster:issue-openclaw-openclaw-121984 | open_fix_pr | blocked |  | Implementation and PR creation must run in a writable checkout with dependencies installed; do not open a PR until the regression fails before the repair and passes afterward. |
