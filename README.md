...
Last source update: Aug 21, 2026, 06:09 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Hot intake publish complete | Aug 21, 2026, 06:09 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32451534164) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Aug 21, 2026, 05:58 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32452515042) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Aug 21, 2026, 05:05 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32449271321) |
...
Last source update: Aug 21, 2026, 06:13 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 558 | 100% |
| Run attempts archived | 1737 | audit |
| Latest successful clusters | 467 | 83.7% |
...
- Latest records: 558 clusters: 213 maintainer action, 118 automation snapshot, 200 intervention needed, 27 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#127034](https://github.com/openclaw/openclaw/issues/127034) is maintainer_input: Provide a writable executor with sibling ../codex available (or network access to clone it) and normal dependencies installed; that execu....
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#126906](https://github.com/openclaw/openclaw/pull/126906) is automation_failed: Require the final authorized memory-flush tool surface to retain append-only write; otherwise throw into the existing failed-state and vi....
...
| Intervention Needed | 200 | automation failure or blocker recorded |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#127034](https://github.com/openclaw/openclaw/issues/127034) | maintainer_input | Provide a writable executor with sibling ../codex available (or network access to clone it) and normal dependencies installed; that executor must d... | Aug 21, 2026, 05:53 UTC | [issue-openclaw-openclaw-127034](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-127034.md) | [32451561419](https://github.com/openclaw/clawsweeper/actions/runs/32451561419) |
...
| --- | --- | --- | --- | --- |
| issue-openclaw-openclaw-127034 | needs human | Provide a writable executor with sibling ../codex available (or network access to clone it) and normal dependencies installed; that executor must d... | [issue-openclaw-openclaw-127034](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-127034.md) | [32451561419](https://github.com/openclaw/clawsweeper/actions/runs/32451561419) |
