...
Last source update: Sep 5, 2026, 10:11 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review in progress | Sep 5, 2026, 10:11 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33959752139) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 5, 2026, 09:56 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33959273060) |
...
Last source update: Sep 5, 2026, 10:05 UTC
...
| Run attempts archived | 2675 | audit |
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [issue-openclaw-openclaw-103198](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-103198.md) is automation_failed: Codex fix worker timed out after 1800000ms.
...
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#42986](https://github.com/openclaw/openclaw/pull/42986) | automation_failed | Implementation requires a writable, dependency-ready checkout and an actual failing baseline regression. Recheck the existing implementation branch... | Sep 5, 2026, 09:59 UTC | [issue-openclaw-openclaw-42986](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-42986.md) | [33957863564](https://github.com/openclaw/clawsweeper/actions/runs/33957863564) |
