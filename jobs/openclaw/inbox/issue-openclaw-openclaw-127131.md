...
target_branch: clawsweeper/issue-openclaw-openclaw-127131
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/127131.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 127131
source_issue_revision_sha256: "214f30d7ea965f0e9530006305dff8fbaad1a876ab7c6b87ebe04a65b0522e96"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-127131`.

Source issue: https://github.com/openclaw/openclaw/issues/127131
Title: Preserve plugin runtime identity across registry selection and cached descriptor lifecycle

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/127131.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/127131.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/127131.md
Category: bug
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-127131` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/127131 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/127131 when the implementation satisfies the issue.
