...
Last source update: Sep 16, 2026, 08:42 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 16, 2026, 08:42 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35070640566) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 16, 2026, 08:39 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35074853118) |
...
Last source update: Sep 16, 2026, 07:07 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1059 | 100% |
| Run attempts archived | 3209 | audit |
| Latest successful clusters | 895 | 84.5% |
| Latest failed clusters | 162 | 15.3% |
...
- Latest records: 1059 clusters: 328 maintainer action, 267 automation snapshot, 418 intervention needed, 46 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [automerge-openclaw-openclaw-146737](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-openclaw-146737.md) is automation_failed: validation command failed (pnpm check:changed): $ node scripts/check-changed.mjs --timed [check:changed] lanes=all [check:changed] extens....
