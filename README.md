...
Last source update: Sep 8, 2026, 03:36 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 8, 2026, 03:36 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34183325639) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 8, 2026, 03:34 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34183922270) |
...
Last source update: Sep 8, 2026, 03:05 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 916 | 100% |
| Run attempts archived | 2818 | audit |
| Latest successful clusters | 757 | 82.6% |
...
- Latest records: 916 clusters: 309 maintainer action, 161 automation snapshot, 409 intervention needed, 37 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#141787](https://github.com/openclaw/openclaw/pull/141787) is automation_failed: Implementation is blocked in this read-only worker. The executor must first reproduce the original sequence on refreshed main and recheck....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#141701](https://github.com/openclaw/openclaw/pull/141701) is action_planned: Keep this canonical issue open and prepare the bounded repair. Implementation must first establish a failing regression on refreshed main....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 309 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 161 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#141787](https://github.com/openclaw/openclaw/pull/141787) | automation_failed | Implementation is blocked in this read-only worker. The executor must first reproduce the original sequence on refreshed main and recheck existing... | Sep 8, 2026, 03:05 UTC | [issue-openclaw-openclaw-141787](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-141787.md) | [34181886001](https://github.com/openclaw/clawsweeper/actions/runs/34181886001) |
