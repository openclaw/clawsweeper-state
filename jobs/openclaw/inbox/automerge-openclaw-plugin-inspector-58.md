...
target_branch: clawsweeper/automerge-openclaw-plugin-inspector-58
source: pr_automerge
...
Title: chore(release): prepare plugin-inspector 0.3.21

ClawSweeper should use this job only for the bounded ClawSweeper review/fix loop:

- Emit a fix artifact with `repair_strategy: "repair_contributor_branch"` and `source_prs: ["https://github.com/openclaw/plugin-inspector/pull/58"]` so the Codex edit pass can make this PR merge-ready.
