...
Last source update: Sep 6, 2026, 22:13 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Planning review | Sep 6, 2026, 22:13 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34063322248) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 6, 2026, 21:56 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34062502877) |
...
Last source update: Sep 6, 2026, 22:12 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 887 | 100% |
| Run attempts archived | 2757 | audit |
| Latest successful clusters | 730 | 82.3% |
| Latest failed clusters | 155 | 17.5% |
...
- Latest records: 887 clusters: 304 maintainer action, 143 automation snapshot, 403 intervention needed, 37 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [issue-openclaw-openclaw-140455](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-140455.md) is automation_blocked: validation command failed (pnpm check:changed): $ node scripts/check-changed.mjs [check:changed] lanes=extensions, extensionTests [check:....
...
| Intervention Needed | 403 | automation failure or blocker recorded |
