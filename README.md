...
Last source update: Aug 21, 2026, 22:25 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review in progress | Aug 21, 2026, 22:25 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32532423889) |
...
| Run attempts archived | 1789 | audit |
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#126813](https://github.com/openclaw/openclaw/pull/126813) is automation_failed: Implementation is blocked only by the missing mandated sibling Codex checkout and read-only filesystem; no maintainer product decision is....
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#126813](https://github.com/openclaw/openclaw/pull/126813) | automation_failed | Implementation is blocked only by the missing mandated sibling Codex checkout and read-only filesystem; no maintainer product decision is pending. | Aug 21, 2026, 22:25 UTC | [issue-openclaw-openclaw-126813](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-126813.md) | [32531970129](https://github.com/openclaw/clawsweeper/actions/runs/32531970129) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#101593](https://github.com/openclaw/openclaw/pull/101593) | automation_failed | Maintainer opted this PR into ClawSweeper automerge/autofix repair; run the direct Codex edit loop after live hydration instead of a separate read-... | Aug 21, 2026, 22:18 UTC | [automerge-openclaw-openclaw-101593](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-openclaw-101593.md) | [32531521575](https://github.com/openclaw/clawsweeper/actions/runs/32531521575) |
