...
Last source update: Sep 15, 2026, 09:47 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 15, 2026, 09:45 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34952164661) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 15, 2026, 09:47 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34954300347) |
...
Last source update: Sep 15, 2026, 09:49 UTC
...
| Run attempts archived | 3177 | audit |
| Latest successful clusters | 881 | 84.1% |
| Latest failed clusters | 164 | 15.7% |
...
- Latest records: 1047 clusters: 327 maintainer action, 258 automation snapshot, 418 intervention needed, 44 no pending action, 0 completed.
...
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#148898](https://github.com/openclaw/openclaw/pull/148898) is action_planned: A narrow timing-accounting repair fits the authorized bug-only scope. Preserve this issue and create one implementation PR only after rep....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 327 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 258 | repair, check, or planned action recorded; verify live status |
