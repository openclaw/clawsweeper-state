...
Last source update: Aug 11, 2026, 21:01 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Aug 11, 2026, 21:00 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31535146827) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 11, 2026, 21:01 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31535774005) |
...
Last source update: Aug 11, 2026, 21:20 UTC
...
| Run attempts archived | 1351 | audit |
| Latest successful clusters | 416 | 85.8% |
...
- Latest records: 485 clusters: 195 maintainer action, 108 automation snapshot, 157 intervention needed, 25 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#122251](https://github.com/openclaw/openclaw/pull/122251) is automation_failed: Implementation is bounded and ready for a new fix PR, but this worker cannot edit the read-only checkout or install the missing test depe....
