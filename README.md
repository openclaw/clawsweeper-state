...
Last source update: Sep 21, 2026, 04:50 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 21, 2026, 04:50 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35562318173) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 21, 2026, 04:50 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35562338400) |
...
Last source update: Sep 21, 2026, 04:49 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1135 | 100% |
| Run attempts archived | 3387 | audit |
| Latest successful clusters | 964 | 84.9% |
...
- Latest records: 1135 clusters: 339 maintainer action, 322 automation snapshot, 426 intervention needed, 48 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#138929](https://github.com/openclaw/openclaw/pull/138929) is automation_failed: Keep the issue canonical and open. Source supports a bounded recovery repair; implementation must first establish the required failing re....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#154325](https://github.com/openclaw/openclaw/pull/154325) is action_planned: A bounded installation defect has a concrete repair path. Proceed with reproduction and implementation through the executor; no maintaine....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 339 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 322 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#138929](https://github.com/openclaw/openclaw/pull/138929) | automation_failed | Keep the issue canonical and open. Source supports a bounded recovery repair; implementation must first establish the required failing regression o... | Sep 21, 2026, 04:49 UTC | [issue-openclaw-openclaw-138929](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-138929.md) | [35559565560](https://github.com/openclaw/clawsweeper/actions/runs/35559565560) |
