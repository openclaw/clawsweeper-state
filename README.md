...
Last source update: Sep 21, 2026, 10:44 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 21, 2026, 10:41 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35588295053) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 21, 2026, 10:44 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35590224100) |
...
Last source update: Sep 21, 2026, 10:43 UTC
...
| Run attempts archived | 3398 | audit |
| Latest successful clusters | 968 | 85.0% |
...
- Latest records: 1139 clusters: 339 maintainer action, 326 automation snapshot, 426 intervention needed, 48 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#154685](https://github.com/openclaw/openclaw/pull/154685) is automation_failed: Source and runtime evidence support a narrow bug fix. Production-boundary reproduction must pass its failing-regression gate before imple....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#154700](https://github.com/openclaw/openclaw/pull/154700) is action_planned: Contain probe exceptions within the existing run-registry owner. Reject steering without delivery and skip only the indeterminate handle....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 339 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 326 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#154685](https://github.com/openclaw/openclaw/pull/154685) | automation_failed | Source and runtime evidence support a narrow bug fix. Production-boundary reproduction must pass its failing-regression gate before implementation. | Sep 21, 2026, 10:43 UTC | [issue-openclaw-openclaw-154685](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-154685.md) | [35585193351](https://github.com/openclaw/clawsweeper/actions/runs/35585193351) |
