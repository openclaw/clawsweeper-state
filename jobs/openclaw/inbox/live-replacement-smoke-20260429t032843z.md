...
target_branch: clawsweeper/live-replacement-smoke-20260429t032843z
source: clawsweeper
---

# ClawSweeper-promoted fix PR candidate

ClawSweeper Repair should create or update one implementation PR from `clawsweeper/live-replacement-smoke-20260429t032843z`.

## Operator Prompt

Live replacement smoke for source PR #74037.

Treat #74037 as useful source work, but do not repair or push to the source branch. Always create a narrow ClawSweeper replacement PR instead. The source PR intentionally added docs/clawsweeper-replacement-smoke.md with the typo `replacment`; the replacement PR should add the same smoke note but correct the typo to `replacement` and keep the smoke id 20260429T032843Z.
...
- Keep one PR for this cluster; reuse `clawsweeper/live-replacement-smoke-20260429t032843z` if it already exists.
