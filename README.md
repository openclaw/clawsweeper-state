...
Last source update: Sep 12, 2026, 20:55 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Sep 12, 2026, 20:55 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34717102057) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 12, 2026, 20:44 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34717897354) |
...
Last source update: Sep 12, 2026, 20:51 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1010 | 100% |
| Run attempts archived | 3097 | audit |
| Latest successful clusters | 848 | 84.0% |
...
- Latest records: 1010 clusters: 321 maintainer action, 233 automation snapshot, 416 intervention needed, 40 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#143727](https://github.com/openclaw/openclaw/pull/143727) is automation_failed: Maintainer opted this PR into ClawSweeper automerge/autofix repair; run the direct Codex edit loop after live hydration instead of a sepa....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#146331](https://github.com/openclaw/openclaw/issues/146331) is action_planned: Prepare a regression-first implementation on the designated branch. Opening a PR remains contingent on reproducing the defect and passing....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 321 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 233 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#143727](https://github.com/openclaw/openclaw/pull/143727) | automation_failed | Maintainer opted this PR into ClawSweeper automerge/autofix repair; run the direct Codex edit loop after live hydration instead of a separate read-... | Sep 12, 2026, 20:51 UTC | [automerge-openclaw-openclaw-143727](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-openclaw-143727.md) | [34716685466](https://github.com/openclaw/clawsweeper/actions/runs/34716685466) |
