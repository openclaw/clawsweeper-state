...
Last source update: Aug 9, 2026, 05:32 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review in progress | Aug 9, 2026, 05:32 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31296858314) |
...
Last source update: Aug 9, 2026, 05:23 UTC
...
| Run attempts archived | 1222 | audit |
| Latest successful clusters | 376 | 85.5% |
...
- Latest records: 440 clusters: 193 maintainer action, 91 automation snapshot, 132 intervention needed, 24 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#89252](https://github.com/openclaw/openclaw/pull/89252) is automation_blocked: Current source already satisfies the issue, but the hydrated preflight state is stale relative to the available main checkout. Do not ope....
