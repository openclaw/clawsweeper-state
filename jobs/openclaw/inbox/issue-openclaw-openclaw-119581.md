...
target_branch: clawsweeper/issue-openclaw-openclaw-119581
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/119581.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 119581
source_issue_revision_sha256: "76166d8392eb05319781c22b3465b68041a60cbe656ed083bd7283911fe26ebd"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-119581`.

Source issue: https://github.com/openclaw/openclaw/issues/119581
Title: [Bug]: source build selects a non-renderer root-help bundle, then times out

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/119581.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/119581.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/119581.md
Category: bug
...
Repair the source-build CLI startup metadata resolver so it selects only a generated module exporting outputRootHelp, rather than the first root-help filename match. Add regression coverage with a root-help-live-config fixture created before a real renderer fixture, and prove the renderer is selected without invoking the source fallback. Preserve fallback behavior for genuinely missing or broken renderers; do not add config or API surface. Do not edit release-owned CHANGELOG.md; record source-install reliability context in the PR body.
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-119581` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/119581 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/119581 when the implementation satisfies the issue.
