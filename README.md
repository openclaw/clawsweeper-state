...
Last source update: Sep 4, 2026, 15:14 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Sep 4, 2026, 15:14 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33886466012) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 4, 2026, 14:57 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33886517915) |
...
Last source update: Sep 4, 2026, 15:13 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 820 | 100% |
| Run attempts archived | 2621 | audit |
| Latest successful clusters | 680 | 82.9% |
| Latest failed clusters | 138 | 16.8% |
| Latest cancelled clusters | 2 | 0.2% |
| Needs-human clusters | 119 | 14.5% |
...
- Latest records: 820 clusters: 297 maintainer action, 115 automation snapshot, 373 intervention needed, 35 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#138308](https://github.com/openclaw/openclaw/issues/138308) is maintainer_input: Codex hard gate: make ../codex available for direct inspection, or authorize a rerun in an environment that can clone it. Until then, no....
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#138298](https://github.com/openclaw/openclaw/pull/138298) is automation_blocked: Implementation and proof require a writable, dependency-complete checkout at the hydrated main SHA and the mandated sibling Codex source..
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#138308](https://github.com/openclaw/openclaw/issues/138308) | maintainer_input | Codex hard gate: make ../codex available for direct inspection, or authorize a rerun in an environment that can clone it. Until then, no implementa... | Sep 4, 2026, 15:13 UTC | [issue-openclaw-openclaw-138308](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-138308.md) | [33887049654](https://github.com/openclaw/clawsweeper/actions/runs/33887049654) |
...
| --- | --- | --- | --- | --- |
| issue-openclaw-openclaw-138308 | needs human | Codex hard gate: make ../codex available for direct inspection, or authorize a rerun in an environment that can clone it. Until then, no implementa... | [issue-openclaw-openclaw-138308](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-138308.md) | [33887049654](https://github.com/openclaw/clawsweeper/actions/runs/33887049654) |
