...
Last source update: Sep 20, 2026, 01:46 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 20, 2026, 01:46 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35481729042) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 20, 2026, 01:41 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35482010478) |
...
Last source update: Sep 20, 2026, 01:42 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1117 | 100% |
| Run attempts archived | 3352 | audit |
| Latest successful clusters | 949 | 85.0% |
| Latest failed clusters | 165 | 14.8% |
| Latest cancelled clusters | 3 | 0.3% |
| Needs-human clusters | 124 | 11.1% |
...
- Latest records: 1117 clusters: 335 maintainer action, 311 automation snapshot, 423 intervention needed, 48 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#153250](https://github.com/openclaw/openclaw/issues/153250) is maintainer_input: Resolve whether automatic implementation should proceed despite the current clawsweeper:manual-only label and @holny's implementation off....
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#153313](https://github.com/openclaw/openclaw/pull/153313) is automation_failed: The fix is narrow and needs no unresolved product decision. A writable executor must install repository dependencies and demonstrate fail....
...
| --- | ---: | --- |
| Maintainer Action | 335 | explicit decision, access, or merge authority recorded |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#153313](https://github.com/openclaw/openclaw/pull/153313) | automation_failed | The fix is narrow and needs no unresolved product decision. A writable executor must install repository dependencies and demonstrate failing normal... | Sep 20, 2026, 01:42 UTC | [issue-openclaw-openclaw-153313](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-153313.md) | [35480712473](https://github.com/openclaw/clawsweeper/actions/runs/35480712473) |
