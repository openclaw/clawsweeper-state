...
Last source update: Sep 11, 2026, 09:09 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 11, 2026, 09:09 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34581270295) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 11, 2026, 08:56 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34581572446) |
...
Last source update: Sep 11, 2026, 09:14 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 974 | 100% |
| Run attempts archived | 3014 | audit |
| Latest successful clusters | 810 | 83.2% |
...
- Latest records: 974 clusters: 318 maintainer action, 201 automation snapshot, 416 intervention needed, 39 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [cluster:issue-openclaw-openclaw-144792](cluster:issue-openclaw-openclaw-144792) is automation_failed: Publication is blocked until the executor implements and validates the artifact on a writable checkout, completes the required isolated W....
...
| [openclaw/openclaw](https://github.com/openclaw/openclaw) |  | automation_failed | validation command failed (pnpm check:changed): $ node scripts/check-changed.mjs [check:changed] lanes=scripts, testRoot, tooling [check:changed] .... | Sep 11, 2026, 08:47 UTC | [automerge-openclaw-openclaw-117144](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-openclaw-117144.md) | [34577398891](https://github.com/openclaw/clawsweeper/actions/runs/34577398891) |
