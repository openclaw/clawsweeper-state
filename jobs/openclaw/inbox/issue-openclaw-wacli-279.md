...
target_branch: clawsweeper/issue-openclaw-wacli-279
source: issue_implementation
trigger_source: review_viable_issue
clawsweeper_report_path: records/openclaw-wacli/items/279.md
source_issue_repo: "openclaw/wacli"
source_issue_number: 279
source_issue_revision_sha256: "ad6b22a92ab71d2c3f3158bf11f266e4f1283962dac1b24271e656440410523c"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-wacli-279`.

Source issue: https://github.com/openclaw/wacli/issues/279
Title: Client outdated (405)

## Maintainer Context

- Trigger source: review_viable_issue
- ClawSweeper review report: records/openclaw-wacli/items/279.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-wacli/items/279.md
- Maintainer instruction: ClawSweeper finished reviewing this open issue and found no active implementation PR.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-wacli/items/279.md
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-wacli-279` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/wacli/issues/279 in the PR body.
- Use a closing reference for https://github.com/openclaw/wacli/issues/279 when the implementation satisfies the issue.
