...
Last source update: Aug 23, 2026, 00:18 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Aug 23, 2026, 00:18 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32605423360) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 22, 2026, 23:59 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32606639941) |
...
Last source update: Aug 23, 2026, 00:07 UTC
...
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#124689](https://github.com/openclaw/openclaw/issues/124689) is maintainer_input: Provide a writable checkout with dependencies and sibling ../codex available; then implement and validate the contained status-ranking re....
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#45224](https://github.com/openclaw/openclaw/pull/45224) is automation_blocked: The narrow fix path is clear, but implementation requires direct Playwright 1.62.1 and ../codex inspection plus a writable dependency-ins....
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#124689](https://github.com/openclaw/openclaw/issues/124689) | maintainer_input | Provide a writable checkout with dependencies and sibling ../codex available; then implement and validate the contained status-ranking repair. | Aug 22, 2026, 23:55 UTC | [issue-openclaw-openclaw-124689](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-124689.md) | [32606114642](https://github.com/openclaw/clawsweeper/actions/runs/32606114642) |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#45224](https://github.com/openclaw/openclaw/pull/45224) | automation_blocked | The narrow fix path is clear, but implementation requires direct Playwright 1.62.1 and ../codex inspection plus a writable dependency-installed che... | Aug 23, 2026, 00:07 UTC | [issue-openclaw-openclaw-45224](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-45224.md) | [32606633550](https://github.com/openclaw/clawsweeper/actions/runs/32606633550) |
...
| --- | --- | --- | --- | --- |
| issue-openclaw-openclaw-124689 | needs human | Provide a writable checkout with dependencies and sibling ../codex available; then implement and validate the contained status-ranking repair. | [issue-openclaw-openclaw-124689](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-124689.md) | [32606114642](https://github.com/openclaw/clawsweeper/actions/runs/32606114642) |
