...
Last source update: Sep 20, 2026, 22:45 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 20, 2026, 22:45 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35542477469) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 20, 2026, 22:42 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35542403429) |
...
Last source update: Sep 20, 2026, 22:39 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1130 | 100% |
| Run attempts archived | 3378 | audit |
| Latest successful clusters | 960 | 85.0% |
...
- Latest records: 1130 clusters: 339 maintainer action, 318 automation snapshot, 425 intervention needed, 48 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#154112](https://github.com/openclaw/openclaw/pull/154112) is automation_failed: Duration alone is not a voice-note discriminator when definitive visual MIME is available. Existing waveform precedence must remain intact..
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#154036](https://github.com/openclaw/openclaw/pull/154036) is action_planned: The established behavior supports a bounded regression repair without a new product decision. Establish a failing detail-view regression....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 339 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 318 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#154112](https://github.com/openclaw/openclaw/pull/154112) | automation_failed | Duration alone is not a voice-note discriminator when definitive visual MIME is available. Existing waveform precedence must remain intact. | Sep 20, 2026, 22:39 UTC | [issue-openclaw-openclaw-154112](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-154112.md) | [35540939950](https://github.com/openclaw/clawsweeper/actions/runs/35540939950) |
