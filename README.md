...
Last source update: Aug 7, 2026, 23:47 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Hot intake publish complete | Aug 7, 2026, 23:47 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31227440532) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply finished | Aug 7, 2026, 23:38 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31227673987) |
...
Last source update: Aug 7, 2026, 23:09 UTC
...
| Run attempts archived | 1161 | audit |
| Latest successful clusters | 360 | 84.9% |
...
- Latest records: 424 clusters: 190 maintainer action, 82 automation snapshot, 128 intervention needed, 24 no pending action, 0 completed.
...
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#119731](https://github.com/openclaw/openclaw/pull/119731) is action_planned: Repair the canonical PR branch; do not merge in autofix mode..
