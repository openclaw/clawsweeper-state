...
Generated: 2026-08-08T05:20:34.642Z
...
| [#120298](https://github.com/openclaw/openclaw/pull/120298) | fix(config): preserve manual .bak.* backups | issue-openclaw-openclaw-120253 | MERGEABLE | BEHIND | IN_PROGRESS:6 SUCCESS:20 SKIPPED:24 NEUTRAL:1; blockers:6 | needs_merge_state:BEHIND, needs_checks:CI / preflight:IN_PROGRESS; iOS Periphery Dead Code / Detect iOS scan scope:IN_PROGRESS; CodeQL / Security High (process-exec-boundary):IN_PROGRESS, needs_merge_preflight | repair failing checks or document unrelated main flake with touched-surface proof |
...
| [#120076](https://github.com/openclaw/openclaw/pull/120076) | fix(mcp): receive loopback OAuth login callbacks | issue-openclaw-openclaw-120019 | CONFLICTING | DIRTY | CANCELLED:1 SKIPPED:50 SUCCESS:80 NEUTRAL:1; blockers:1 | security_hold, needs_rebase:CONFLICTING, needs_merge_state:DIRTY, needs_checks:ClawSweeper Dispatch / dispatch:CANCELLED, needs_merge_preflight | route to central security triage |
