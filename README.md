...
Last source update: Sep 16, 2026, 06:46 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 16, 2026, 06:45 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35064283468) |
...
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Sep 16, 2026, 02:50 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35049484599) |
...
Last source update: Sep 16, 2026, 06:48 UTC
...
| Run attempts archived | 3208 | audit |
| Latest successful clusters | 894 | 84.4% |
...
- Latest records: 1059 clusters: 328 maintainer action, 266 automation snapshot, 419 intervention needed, 46 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#149672](https://github.com/openclaw/openclaw/pull/149672) is automation_failed: A narrow shared-flow repair is supported by source evidence. Runtime reproduction remains unexecuted; publication must wait for a failing....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#149569](https://github.com/openclaw/openclaw/pull/149569) is action_planned: Honor --plain in the existing diagnostic color decision and prove the behavior through registered-command coverage before publication..
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 328 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 266 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#149672](https://github.com/openclaw/openclaw/pull/149672) | automation_failed | A narrow shared-flow repair is supported by source evidence. Runtime reproduction remains unexecuted; publication must wait for a failing regressio... | Sep 16, 2026, 06:48 UTC | [issue-openclaw-openclaw-149672](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-149672.md) | [35061985381](https://github.com/openclaw/clawsweeper/actions/runs/35061985381) |
