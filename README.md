...
Last source update: Sep 15, 2026, 19:34 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Sep 15, 2026, 19:34 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35010417524) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 15, 2026, 19:31 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35013726484) |
...
Last source update: Sep 15, 2026, 19:37 UTC
...
| Run attempts archived | 3196 | audit |
| Latest successful clusters | 889 | 84.3% |
| Latest failed clusters | 164 | 15.5% |
...
- Latest records: 1055 clusters: 328 maintainer action, 262 automation snapshot, 419 intervention needed, 46 no pending action, 0 completed.
...
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#149255](https://github.com/openclaw/openclaw/pull/149255) is action_planned: A scoped bug repair is justified for investigation; runtime reproduction and dependency-contract verification remain prerequisites to imp....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 328 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 262 | repair, check, or planned action recorded; verify live status |
