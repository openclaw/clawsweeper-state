...
mode: "autonomous"
run_id: "30698165242"
run_url: "https://github.com/openclaw/clawsweeper/actions/runs/30698165242"
head_sha: "922ebc673e129c2f85d3990f5c99dd1ec7c9effc"
workflow_conclusion: "success"
result_status: "blocked"
published_at: "2026-08-01T12:22:46.950Z"
...
Run: [https://github.com/openclaw/clawsweeper/actions/runs/30698165242](https://github.com/openclaw/clawsweeper/actions/runs/30698165242)
...
#117358 remains a reproducible current-main canonical bug at 11239da88fbe399ea01c9c143f886d200986f628. The CLI lifecycle estimates raw `getBranch()` message rows while `SessionManager.buildSessionContext()` already owns compaction/reset boundary projection. The supplied checkout is read-only on `main`, so implementation and validation cannot be performed here; a narrow new-fix-PR artifact is ready for a writable executor.
...
| Target | Action | Status | Classification | Reason |
| --- | --- | --- | --- | --- |
| #117358 | fix_needed | planned | canonical | Replace the raw-branch estimate input with `sessionManager.buildSessionContext().messages` and cover compacted and reset branches with oversized discarded history. |
| cluster:issue-openclaw-openclaw-117358 | build_fix_artifact | planned | canonical | The repair is narrow and implementation-ready, but this worker cannot modify the supplied checkout. |
| cluster:issue-openclaw-openclaw-117358 | open_fix_pr | blocked | canonical | A writable executor should apply the prepared artifact on `clawsweeper/issue-openclaw-openclaw-117358`, validate it, and open the credited PR with the required ClawSweeper labels. |
