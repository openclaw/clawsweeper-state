...
target_branch: clawsweeper/issue-openclaw-openclaw-130226
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/130226.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 130226
source_issue_revision_sha256: "43665e32c9e268b8ac3cbc07c8a158253bcb4db31224b4764c5785af3092d32a"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-130226`.

Source issue: https://github.com/openclaw/openclaw/issues/130226
Title: [Bug]: Forced context-engine compaction can no-op above the reserve-adjusted prompt budget

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/130226.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/130226.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/130226.md
Category: bug
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-130226` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/130226 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/130226 when the implementation satisfies the issue.
