...
Last source update: Sep 25, 2026, 14:29 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Sep 25, 2026, 14:29 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/36143530683) |
...
Last source update: Sep 25, 2026, 14:25 UTC
...
| Run attempts archived | 3608 | audit |
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#158103](https://github.com/openclaw/openclaw/pull/158103) is automation_failed: Implement only after the required loopback regression fails on main for the reported reason..
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#158103](https://github.com/openclaw/openclaw/pull/158103) | automation_failed | Implement only after the required loopback regression fails on main for the reported reason. | Sep 25, 2026, 14:25 UTC | [issue-openclaw-openclaw-158103](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-158103.md) | [36141117375](https://github.com/openclaw/clawsweeper/actions/runs/36141117375) |
