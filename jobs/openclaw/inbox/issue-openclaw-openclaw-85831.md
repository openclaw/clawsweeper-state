...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-85831`.

Source issue: https://github.com/openclaw/openclaw/issues/85831
Title: [Bug]: control-ui config saving error ignores schema defaults

## Maintainer Context

- Command comment: https://github.com/openclaw/openclaw/issues/85831#issuecomment-4526782010
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-85831` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/85831 in the PR body.
