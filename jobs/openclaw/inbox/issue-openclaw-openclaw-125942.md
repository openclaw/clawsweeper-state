...
target_branch: clawsweeper/issue-openclaw-openclaw-125942
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/125942.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 125942
source_issue_revision_sha256: "c210fa6758e38f84c830d5bb398542d440a77db607b6c6563acbdf77552fb5ff"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-125942`.

Source issue: https://github.com/openclaw/openclaw/issues/125942
Title: erroredAssistantResultPolicy hardcoded to "drop" causes silent replay of failed user turns

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/125942.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/125942.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/125942.md
Category: bug
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-125942` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/125942 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/125942 when the implementation satisfies the issue.
