...
Last source update: Sep 21, 2026, 07:38 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Planning review | Sep 21, 2026, 07:38 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35573623079) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 21, 2026, 07:13 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35571750480) |
...
Last source update: Sep 21, 2026, 07:17 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1137 | 100% |
| Run attempts archived | 3394 | audit |
| Latest successful clusters | 966 | 85.0% |
...
- Latest records: 1137 clusters: 339 maintainer action, 324 automation snapshot, 426 intervention needed, 48 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#154510](https://github.com/openclaw/openclaw/pull/154510) is automation_failed: Implementation requires a writable executor checkout with dependencies and current-main verification. This is an execution blocker, not u....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#138929](https://github.com/openclaw/openclaw/pull/138929) is action_planned: The report supports a focused repair within the existing recovery owner. Executable reproduction must first confirm that current stream n....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 339 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 324 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#154510](https://github.com/openclaw/openclaw/pull/154510) | automation_failed | Implementation requires a writable executor checkout with dependencies and current-main verification. This is an execution blocker, not unresolved... | Sep 21, 2026, 07:17 UTC | [issue-openclaw-openclaw-154510](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-154510.md) | [35569449134](https://github.com/openclaw/clawsweeper/actions/runs/35569449134) |
