...
target_branch: clawsweeper/issue-openclaw-openclaw-126229
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/126229.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 126229
source_issue_revision_sha256: "935d4b1d923f18fd6c1050427da0f71d9fab20da441e3dd31f4e60a9e5a19324"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-126229`.

Source issue: https://github.com/openclaw/openclaw/issues/126229
Title: [Bug]: cap-truncated chat projections carry no structured truncation flag, so session.message consumers cannot detect a bounded preview

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/126229.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/126229.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/126229.md
Category: bug
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-126229` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/126229 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/126229 when the implementation satisfies the issue.
