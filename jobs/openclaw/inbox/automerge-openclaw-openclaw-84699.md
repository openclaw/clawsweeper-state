...
target_branch: clawsweeper/automerge-openclaw-openclaw-84699
source: pr_automerge
requested_by: "Takhoffman"
requested_by_id: "781889"
request_comment_url: "https://github.com/openclaw/openclaw/pull/84699#issuecomment-4503636968"
---

# ClawSweeper adopted PR repair candidate

Maintainer opted #84699 into ClawSweeper automerge.

Requested by: Takhoffman
Request comment: https://github.com/openclaw/openclaw/pull/84699#issuecomment-4503636968


Source PR: https://github.com/openclaw/openclaw/pull/84699
Title: fix(doctor): warn when sandbox hides MCP tools

ClawSweeper should use this job only for the bounded ClawSweeper review/fix loop:

- Emit a fix artifact with `repair_strategy: "repair_contributor_branch"` and `source_prs: ["https://github.com/openclaw/openclaw/pull/84699"]` so the Codex edit pass can make this PR merge-ready.
