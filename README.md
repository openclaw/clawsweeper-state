...
Last source update: Aug 20, 2026, 21:42 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Hot intake publish complete | Aug 20, 2026, 21:42 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32417561737) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 20, 2026, 21:35 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32420087576) |
...
Last source update: Aug 20, 2026, 21:39 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 552 | 100% |
| Run attempts archived | 1707 | audit |
| Latest successful clusters | 462 | 83.7% |
| Latest failed clusters | 88 | 15.9% |
...
- Latest records: 552 clusters: 213 maintainer action, 116 automation snapshot, 196 intervention needed, 27 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#121252](https://github.com/openclaw/openclaw/issues/121252) is maintainer_input: Provide an environment with the required sibling ../codex source and installable dependencies, then rerun `node scripts/run-vitest.mjs ex....
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#121252](https://github.com/openclaw/openclaw/issues/121252) | maintainer_input | Provide an environment with the required sibling ../codex source and installable dependencies, then rerun `node scripts/run-vitest.mjs extensions/b... | Aug 20, 2026, 21:34 UTC | [issue-openclaw-openclaw-121252](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-121252.md) | [32419287916](https://github.com/openclaw/clawsweeper/actions/runs/32419287916) |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#118806](https://github.com/openclaw/openclaw/pull/118806) | automation_failed | Maintainer opted this PR into ClawSweeper automerge/autofix repair; run the direct Codex edit loop after live hydration instead of a separate read-... | Aug 20, 2026, 21:39 UTC | [automerge-openclaw-openclaw-118806](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-openclaw-118806.md) | [32418796871](https://github.com/openclaw/clawsweeper/actions/runs/32418796871) |
...
| --- | --- | --- | --- | --- |
| issue-openclaw-openclaw-121252 | needs human | Provide an environment with the required sibling ../codex source and installable dependencies, then rerun `node scripts/run-vitest.mjs extensions/b... | [issue-openclaw-openclaw-121252](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-121252.md) | [32419287916](https://github.com/openclaw/clawsweeper/actions/runs/32419287916) |
