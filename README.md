...
Last source update: Sep 20, 2026, 20:31 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 20, 2026, 20:31 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35533597337) |
...
Last source update: Sep 20, 2026, 19:59 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1128 | 100% |
| Run attempts archived | 3374 | audit |
| Latest successful clusters | 958 | 84.9% |
...
- Latest records: 1128 clusters: 339 maintainer action, 316 automation snapshot, 425 intervention needed, 48 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#153971](https://github.com/openclaw/openclaw/pull/153971) is automation_failed: Source supports a narrow repair, but reproduction must succeed before production edits. Credential rotation failure does not claim a secu....
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#153971](https://github.com/openclaw/openclaw/pull/153971) | automation_failed | Source supports a narrow repair, but reproduction must succeed before production edits. Credential rotation failure does not claim a security-bound... | Sep 20, 2026, 19:59 UTC | [issue-openclaw-openclaw-153971](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-153971.md) | [35532355043](https://github.com/openclaw/clawsweeper/actions/runs/35532355043) |
