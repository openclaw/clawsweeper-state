...
Last source update: Aug 24, 2026, 18:38 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review comments checked | Aug 24, 2026, 18:26 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32759981368) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 24, 2026, 18:38 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32763393503) |
...
Last source update: Aug 24, 2026, 18:32 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 603 | 100% |
| Run attempts archived | 2095 | audit |
| Latest successful clusters | 499 | 82.8% |
| Latest failed clusters | 102 | 16.9% |
| Latest cancelled clusters | 2 | 0.3% |
| Needs-human clusters | 51 | 8.5% |
| Fix actions failed | 26 | 4.6% |
| Fix actions blocked | 109 | 19.1% |
| Completed close actions | 0 | 0.0% |
| Completed merge actions | 0 | 0.0% |
| Blocked mutation attempts | 310 | 99.7% |
...
- Latest records: 603 clusters: 222 maintainer action, 114 automation snapshot, 239 intervention needed, 28 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [issue-openclaw-openclaw-128743](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-128743.md) is maintainer_input: Provide a writable checkout with dependencies and a readable sibling ../codex checkout; then execute the supplied new-fix-PR artifact and....
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [cluster:issue-openclaw-openclaw-128821](cluster:issue-openclaw-openclaw-128821) is automation_failed: Implementation is blocked only in this worker sandbox; the supplied artifact defines a narrow new PR path..
...
| --- | ---: | --- |
| Maintainer Action | 222 | explicit decision, access, or merge authority recorded |
...
| [openclaw/openclaw](https://github.com/openclaw/openclaw) |  | automation_failed | Codex /review did not pass after final base synchronization: Not merge-ready: the artifact smoke still does not prove ACPX/Codex starts from the ar... | Aug 24, 2026, 18:22 UTC | [automerge-openclaw-openclaw-117144](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-openclaw-117144.md) | [32758855279](https://github.com/openclaw/clawsweeper/actions/runs/32758855279) |
...
| [openclaw/crabpot](https://github.com/openclaw/crabpot) | [#283](https://github.com/openclaw/crabpot/pull/283) | automation_failed | Maintainer opted this PR into ClawSweeper automerge/autofix repair; run the direct Codex edit loop after live hydration instead of a separate read-... | Aug 24, 2026, 15:35 UTC | [automerge-openclaw-crabpot-283](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-crabpot-283.md) | [32738098036](https://github.com/openclaw/clawsweeper/actions/runs/32738098036) |
...
| --- | --- | --- | --- | --- |
| automerge-openclaw-openclaw-117144 | fix failed | Codex /review did not pass after final base synchronization: Not merge-ready: the artifact smoke still does not prove ACPX/Codex starts from the ar... | [automerge-openclaw-openclaw-117144](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-openclaw-117144.md) | [32758855279](https://github.com/openclaw/clawsweeper/actions/runs/32758855279) |
...
| [automerge-openclaw-openclaw-117144](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-openclaw-117144.md) | blocked |  |  | Codex /review did not pass after final base synchronization: Not merge-ready: the artifact smoke still does not prove ACPX/Codex starts from the ar... | [32758855279](https://github.com/openclaw/clawsweeper/actions/runs/32758855279) |
