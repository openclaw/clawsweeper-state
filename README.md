...
Last source update: Sep 21, 2026, 01:02 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 21, 2026, 01:02 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35549444917) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 21, 2026, 01:02 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35549453952) |
...
Last source update: Sep 21, 2026, 00:48 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1132 | 100% |
| Run attempts archived | 3381 | audit |
| Latest successful clusters | 961 | 84.9% |
...
- Latest records: 1132 clusters: 339 maintainer action, 319 automation snapshot, 426 intervention needed, 48 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#154180](https://github.com/openclaw/openclaw/pull/154180) is automation_failed: Existing source startup is demonstrably broken. Proceed with one narrow implementation PR after reproducing the full capture layout on th....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#154112](https://github.com/openclaw/openclaw/pull/154112) is action_planned: A focused plugin-owned bug fix is supported. Establish failing boundary regressions before production edits, then validate and prepare th....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 339 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 319 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#154180](https://github.com/openclaw/openclaw/pull/154180) | automation_failed | Existing source startup is demonstrably broken. Proceed with one narrow implementation PR after reproducing the full capture layout on the executor. | Sep 21, 2026, 00:48 UTC | [issue-openclaw-openclaw-154180](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-154180.md) | [35546583603](https://github.com/openclaw/clawsweeper/actions/runs/35546583603) |
