...
Last source update: Aug 22, 2026, 00:32 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Aug 22, 2026, 00:32 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32538542895) |
...
Last source update: Aug 22, 2026, 00:33 UTC
...
| Run attempts archived | 1803 | audit |
| Latest successful clusters | 474 | 83.5% |
| Latest failed clusters | 92 | 16.2% |
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#125776](https://github.com/openclaw/openclaw/pull/125776) is automation_failed: Blocked only on the unavailable writable validation environment and mandatory direct ../codex protocol inspection; the fix path is otherw....
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#125776](https://github.com/openclaw/openclaw/pull/125776) | automation_failed | Blocked only on the unavailable writable validation environment and mandatory direct ../codex protocol inspection; the fix path is otherwise narrow. | Aug 22, 2026, 00:33 UTC | [issue-openclaw-openclaw-125776](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-125776.md) | [32540214136](https://github.com/openclaw/clawsweeper/actions/runs/32540214136) |
