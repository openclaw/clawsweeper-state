...
target_branch: clawsweeper/issue-openclaw-openclaw-131231
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/131231.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 131231
source_issue_revision_sha256: "d53b868a7484b91007edfeeb391977036b350da41e59fd4cd541474b5188cb8b"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-131231`.

Source issue: https://github.com/openclaw/openclaw/issues/131231
Title: [Bug]: browser act fill silently no-ops on unsupported field keys (ok:true, value unchanged)

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/131231.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/131231.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/131231.md
Category: bug
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-131231` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/131231 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/131231 when the implementation satisfies the issue.
