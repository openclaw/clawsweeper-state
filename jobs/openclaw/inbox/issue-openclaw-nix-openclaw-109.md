...
cluster_id: issue-openclaw-nix-openclaw-109
mode: autonomous
...
target_branch: clawsweeper/issue-openclaw-nix-openclaw-109
source: issue_implementation
trigger_source: review_viable_issue
clawsweeper_report_path: records/openclaw-nix-openclaw/items/109.md
source_issue_repo: "openclaw/nix-openclaw"
source_issue_number: 109
source_issue_revision_sha256: "f96627b45fdfa7f91343dfe41e6d5f5a1fee9fa18ef214c9eba8e6ae903ed712"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-nix-openclaw-109`.

Source issue: https://github.com/openclaw/nix-openclaw/issues/109
Title: Node.js punycode deprecation warning from transitive dependency (DEP0040)

## Maintainer Context

- Trigger source: review_viable_issue
- ClawSweeper review report: records/openclaw-nix-openclaw/items/109.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-nix-openclaw/items/109.md
- Maintainer instruction: ClawSweeper finished reviewing this open issue and found no active implementation PR.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-nix-openclaw/items/109.md
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-nix-openclaw-109` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/nix-openclaw/issues/109 in the PR body.
- Use a closing reference for https://github.com/openclaw/nix-openclaw/issues/109 when the implementation satisfies the issue.
