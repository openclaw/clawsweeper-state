...
cluster_id: issue-openclaw-openclaw-125139
mode: autonomous
...
target_branch: clawsweeper/issue-openclaw-openclaw-125139
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/125139.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 125139
source_issue_revision_sha256: "ed4f367769e1d70a38d1bc5ab37b01c7b7e83086f5d04a8d7cca632cf7db68b7"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-125139`.

Source issue: https://github.com/openclaw/openclaw/issues/125139
Title: [Bug]: memory-wiki unsafe-local import re-imports its own vault pages — the loop fixed for bridge mode in #95666 is not covered

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/125139.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/125139.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/125139.md
Category: bug
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-125139` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/125139 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/125139 when the implementation satisfies the issue.
