...
Last source update: Sep 11, 2026, 03:17 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review in progress | Sep 11, 2026, 03:17 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34557759958) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 11, 2026, 02:57 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34556493194) |
...
Last source update: Sep 11, 2026, 03:02 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 970 | 100% |
| Run attempts archived | 2998 | audit |
| Latest successful clusters | 807 | 83.2% |
...
- Latest records: 970 clusters: 318 maintainer action, 199 automation snapshot, 415 intervention needed, 38 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#144581](https://github.com/openclaw/openclaw/pull/144581) is automation_failed: Implementation is blocked until a writable executor establishes the required failing snapshot-worker regression on Windows. The canonical....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#144582](https://github.com/openclaw/openclaw/pull/144582) is action_planned: A bounded integration bug remains. Reuse the existing bridge before browser popup reservation; retain the issue until the implementation....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 318 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 199 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#144581](https://github.com/openclaw/openclaw/pull/144581) | automation_failed | Implementation is blocked until a writable executor establishes the required failing snapshot-worker regression on Windows. The canonical bug class... | Sep 11, 2026, 03:02 UTC | [issue-openclaw-openclaw-144581](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-144581.md) | [34553766012](https://github.com/openclaw/clawsweeper/actions/runs/34553766012) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) |  | automation_failed | validation command failed (pnpm check:changed): $ node scripts/check-changed.mjs [check:changed] lanes=extensions, extensionTests [check:changed] e... | Sep 11, 2026, 02:49 UTC | [automerge-openclaw-openclaw-142626](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-openclaw-142626.md) | [34553007219](https://github.com/openclaw/clawsweeper/actions/runs/34553007219) |
