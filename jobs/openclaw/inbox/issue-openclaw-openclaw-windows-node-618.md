...
target_branch: clawsweeper/issue-openclaw-openclaw-windows-node-618
source: issue_implementation
trigger_source: review_viable_issue
clawsweeper_report_path: records/openclaw-openclaw-windows-node/items/618.md
source_issue_repo: "openclaw/openclaw-windows-node"
source_issue_number: 618
source_issue_revision_sha256: "520cd74888c37d45eb8989e51e521fbb9a60c701304871e901119c00b54df959"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-windows-node-618`.

Source issue: https://github.com/openclaw/openclaw-windows-node/issues/618
Title: [Repo Assist] Monthly Activity 2026-06

## Maintainer Context

- Trigger source: review_viable_issue
- ClawSweeper review report: records/openclaw-openclaw-windows-node/items/618.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw-windows-node/items/618.md
- Maintainer instruction: ClawSweeper finished reviewing this open issue and found no active implementation PR.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw-windows-node/items/618.md
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-windows-node-618` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw-windows-node/issues/618 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw-windows-node/issues/618 when the implementation satisfies the issue.
