...
cluster_id: issue-steipete-codexbar-2209
mode: autonomous
...
target_branch: clawsweeper/issue-steipete-codexbar-2209
source: issue_implementation
trigger_source: review_viable_issue
clawsweeper_report_path: records/steipete-codexbar/items/2209.md
source_issue_repo: "steipete/codexbar"
source_issue_number: 2209
source_issue_revision_sha256: "f7a649edca99662925db4f288a2c39524392800f20866e9e13ec7589ff1065a6"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-steipete-codexbar-2209`.

Source issue: https://github.com/steipete/codexbar/issues/2209
Title: Unable to detect balance for Xiaomi MiMo model

## Maintainer Context

- Trigger source: review_viable_issue
- ClawSweeper review report: records/steipete-codexbar/items/2209.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/steipete-codexbar/items/2209.md
- Maintainer instruction: ClawSweeper finished reviewing this open issue and found no active implementation PR.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/steipete-codexbar/items/2209.md
...
- Keep one PR for this issue; reuse `clawsweeper/issue-steipete-codexbar-2209` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/steipete/codexbar/issues/2209 in the PR body.
- Use a closing reference for https://github.com/steipete/codexbar/issues/2209 when the implementation satisfies the issue.
