...
target_branch: clawsweeper/issue-openclaw-openclaw-133860
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/133860.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 133860
source_issue_revision_sha256: "f27a63f85b3a45dfd2e36d21f03d1c9d5bcdd22df6c4b6e955033e7aa52cb6b2"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-133860`.

Source issue: https://github.com/openclaw/openclaw/issues/133860
Title: [Bug]: llama.cpp "Context size has been exceeded." not recognized as context overflow → compact-and-retry skipped

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/133860.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/133860.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/133860.md
Category: bug
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-133860` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/133860 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/133860 when the implementation satisfies the issue.
