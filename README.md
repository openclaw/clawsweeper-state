...
Last source update: Aug 10, 2026, 19:03 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Aug 10, 2026, 19:03 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31421418183) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Aug 10, 2026, 18:44 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31420569578) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Aug 10, 2026, 15:08 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31401859995) |
...
Last source update: Aug 10, 2026, 17:31 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 465 | 100% |
| Run attempts archived | 1302 | audit |
| Latest successful clusters | 398 | 85.6% |
| Latest failed clusters | 65 | 14.0% |
| Latest cancelled clusters | 2 | 0.4% |
| Needs-human clusters | 28 | 6.0% |
| Fix actions failed | 23 | 4.4% |
| Fix actions blocked | 94 | 18.0% |
...
- Latest records: 465 clusters: 196 maintainer action, 98 automation snapshot, 147 intervention needed, 24 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [issue-openclaw-openclaw-121617](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-121617.md) is automation_blocked: validation command failed (pnpm check:changed): $ node scripts/check-changed.mjs [check:changed] lanes=core, coreTests, docs [check:chang....
...
| Intervention Needed | 147 | automation failure or blocker recorded |
