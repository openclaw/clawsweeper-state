...
Last source update: Sep 24, 2026, 15:07 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 24, 2026, 15:07 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/36014980769) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 24, 2026, 14:51 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/36015498255) |
...
Last source update: Sep 24, 2026, 15:03 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1187 | 100% |
| Run attempts archived | 3567 | audit |
| Latest successful clusters | 1004 | 84.6% |
| Latest failed clusters | 180 | 15.2% |
...
- Latest records: 1187 clusters: 343 maintainer action, 351 automation snapshot, 444 intervention needed, 49 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [issue-openclaw-openclaw-157309](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-157309.md) is automation_blocked: validation command failed (pnpm check:changed): changed-gate validation has an unsafe existing artifacts directory.
...
| Intervention Needed | 444 | automation failure or blocker recorded |
...
| [openclaw/openclaw](https://github.com/openclaw/openclaw) |  | automation_blocked | validation command failed (pnpm check:changed): changed-gate validation has an unsafe existing artifacts directory | Sep 24, 2026, 14:58 UTC | [issue-openclaw-openclaw-77717](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-77717.md) | [36011117893](https://github.com/openclaw/clawsweeper/actions/runs/36011117893) |
...
| [issue-openclaw-openclaw-77717](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-77717.md) | blocked |  |  | validation command failed (pnpm check:changed): changed-gate validation has an unsafe existing artifacts directory | [36011117893](https://github.com/openclaw/clawsweeper/actions/runs/36011117893) |
