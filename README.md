...
Last source update: Aug 23, 2026, 05:06 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review publish complete | Aug 23, 2026, 04:58 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32617830906) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 23, 2026, 05:06 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32619479227) |
...
Last source update: Aug 23, 2026, 05:11 UTC
...
| Run attempts archived | 2006 | audit |
| Latest successful clusters | 482 | 82.3% |
| Latest failed clusters | 102 | 17.4% |
| Latest cancelled clusters | 2 | 0.3% |
| Needs-human clusters | 46 | 7.8% |
...
- Latest records: 586 clusters: 216 maintainer action, 115 automation snapshot, 228 intervention needed, 27 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#125776](https://github.com/openclaw/openclaw/issues/125776) is maintainer_input: Provide a writable worker with ../codex restored (or otherwise make the exact Codex source available) so the dynamic-tool call-id contrac....
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#124689](https://github.com/openclaw/openclaw/pull/124689) is automation_failed: A writable checkout with dependencies is required to add the pre-fix-failing regression, apply the generic status filter, run focused tes....
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#125776](https://github.com/openclaw/openclaw/issues/125776) | maintainer_input | Provide a writable worker with ../codex restored (or otherwise make the exact Codex source available) so the dynamic-tool call-id contract can be i... | Aug 23, 2026, 05:11 UTC | [issue-openclaw-openclaw-125776](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-125776.md) | [32619389864](https://github.com/openclaw/clawsweeper/actions/runs/32619389864) |
...
| --- | --- | --- | --- | --- |
| issue-openclaw-openclaw-125776 | needs human | Provide a writable worker with ../codex restored (or otherwise make the exact Codex source available) so the dynamic-tool call-id contract can be i... | [issue-openclaw-openclaw-125776](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-125776.md) | [32619389864](https://github.com/openclaw/clawsweeper/actions/runs/32619389864) |
