...
target_branch: clawsweeper/issue-openclaw-openclaw-119758
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/119758.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 119758
source_issue_revision_sha256: "9b271ce5988b7443e689e7dfabb844d711813a3c848e78924ded0a73f20e8b80"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-119758`.

Source issue: https://github.com/openclaw/openclaw/issues/119758
Title: @openclaw/codex latest tag installs a build incompatible with beta core

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/119758.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/119758.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/119758.md
Category: bug
...
Repair the beta-core targeted official-plugin update bug from https://github.com/openclaw/openclaw/issues/119758. Make `openclaw plugins update <official-id>` derive the same update channel from the running version as the existing `--all` path when `config.update.channel` is unset, but do not change exact-version pinning, beta-to-latest fallback policy, config schema, or Doctor severity; those remain in https://github.com/openclaw/openclaw/issues/97680. Add focused beta-unset-channel and stable-control regressions, verify version-drift guidance does not prescribe a non-repairing command, and capture user-visible release-note context in the PR body without editing CHANGELOG.md.
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-119758` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/119758 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/119758 when the implementation satisfies the issue.
