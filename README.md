...
Last source update: Aug 29, 2026, 22:27 UTC
...
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 29, 2026, 22:27 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33278597773) |
...
Last source update: Aug 29, 2026, 22:26 UTC
...
| Run attempts archived | 2362 | audit |
| Latest successful clusters | 579 | 83.1% |
| Latest failed clusters | 116 | 16.6% |
...
- Latest records: 697 clusters: 242 maintainer action, 114 automation snapshot, 311 intervention needed, 30 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [issue-openclaw-openclaw-129173](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-129173.md) is maintainer_input: Provide a writable repair environment with dependencies installed and sibling ../codex source available; root policy blocks a code-change....
...
| --- | ---: | --- |
| Maintainer Action | 242 | explicit decision, access, or merge authority recorded |
