...
Last source update: Aug 23, 2026, 10:52 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Aug 23, 2026, 10:52 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32632944627) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 23, 2026, 10:47 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32634658162) |
...
Last source update: Aug 23, 2026, 10:42 UTC
...
| Run attempts archived | 2019 | audit |
...
- Latest records: 589 clusters: 217 maintainer action, 115 automation snapshot, 230 intervention needed, 27 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [automerge-openclaw-openclaw-125422](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-openclaw-125422.md) is maintainer_input: Provide or mount ../codex (or authorize its checkout) so the required Codex source inspection can complete before a repair verdict..
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#128156](https://github.com/openclaw/openclaw/pull/128156) is automation_failed: Add a cloned-regex no-match gate only for patterns derived from the built-in default table, preserving custom-regex and full-context sema....
...
| Intervention Needed | 230 | automation failure or blocker recorded |
