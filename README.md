...
Last source update: Aug 31, 2026, 18:16 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Aug 31, 2026, 18:16 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33420723199) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 31, 2026, 17:57 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33422211754) |
...
Last source update: Aug 31, 2026, 18:04 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 736 | 100% |
| Run attempts archived | 2466 | audit |
| Latest successful clusters | 614 | 83.4% |
| Latest failed clusters | 120 | 16.3% |
| Latest cancelled clusters | 2 | 0.3% |
| Needs-human clusters | 85 | 11.5% |
...
- Latest records: 736 clusters: 262 maintainer action, 114 automation snapshot, 325 intervention needed, 35 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [issue-openclaw-openclaw-134182](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-134182.md) is maintainer_input: Provide a writable macOS repair environment with the required sibling ../codex checkout available; this runner cannot clone it because gi....
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#134305](https://github.com/openclaw/openclaw/pull/134305) is automation_blocked: A writable checkout at the hydrated main SHA, dependencies, and the required sibling Codex source are prerequisites to reproduce, edit, a....
...
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#134297](https://github.com/openclaw/openclaw/pull/134297) | automation_failed | Implementation is blocked only in this read-only, dependency-free checkout; the deterministic executor can apply the narrow artifact on clawsweeper... | Aug 31, 2026, 17:46 UTC | [issue-openclaw-openclaw-134297](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-134297.md) | [33418824565](https://github.com/openclaw/clawsweeper/actions/runs/33418824565) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#134256](https://github.com/openclaw/openclaw/pull/134256) | automation_failed | Implementation and local regression proof require a writable executor checkout with the required sibling Codex source available. | Aug 31, 2026, 17:31 UTC | [issue-openclaw-openclaw-134256](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-134256.md) | [33417577446](https://github.com/openclaw/clawsweeper/actions/runs/33417577446) |
