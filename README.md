...
Last source update: Sep 5, 2026, 16:30 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Sep 5, 2026, 16:29 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33977504201) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 5, 2026, 16:30 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33977911883) |
...
Last source update: Sep 5, 2026, 16:23 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 862 | 100% |
| Run attempts archived | 2696 | audit |
| Latest successful clusters | 707 | 82.0% |
...
- Latest records: 862 clusters: 303 maintainer action, 127 automation snapshot, 397 intervention needed, 35 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [cluster:issue-openclaw-openclaw-139185](cluster:issue-openclaw-openclaw-139185) is automation_failed: Blocked on implementing and validating the canonical fix in a writable environment, obtaining Windows/MSYS2 proof, and refreshing competi....
...
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#98468](https://github.com/openclaw/openclaw/pull/98468) | automation_failed | The source finding remains applicable. Continue with the existing staging owner and shared runner after restoring an executable checkout and comple... | Sep 5, 2026, 16:21 UTC | [issue-openclaw-openclaw-98468](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-98468.md) | [33975543713](https://github.com/openclaw/clawsweeper/actions/runs/33975543713) |
