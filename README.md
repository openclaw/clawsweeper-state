...
Last source update: Aug 29, 2026, 18:30 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Planning review | Aug 29, 2026, 18:29 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33267950475) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Aug 29, 2026, 18:30 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33268398324) |
...
Last source update: Aug 29, 2026, 17:19 UTC
...
| Run attempts archived | 2349 | audit |
| Latest successful clusters | 578 | 83.5% |
| Latest failed clusters | 112 | 16.2% |
...
- Latest records: 692 clusters: 242 maintainer action, 114 automation snapshot, 306 intervention needed, 30 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#132597](https://github.com/openclaw/openclaw/pull/132597) is automation_failed: Implementation and validation require a writable checkout with dependencies, authenticated GitHub preflight, and the mandated ../codex so....
...
| Intervention Needed | 306 | automation failure or blocker recorded |
