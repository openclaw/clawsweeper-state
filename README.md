...
Last source update: Aug 23, 2026, 10:38 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Hot intake publish complete | Aug 23, 2026, 10:36 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32633098184) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Aug 23, 2026, 10:38 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32634297131) |
...
Last source update: Aug 23, 2026, 10:36 UTC
...
| Run attempts archived | 2018 | audit |
| Latest successful clusters | 482 | 81.8% |
| Latest failed clusters | 105 | 17.8% |
| Latest cancelled clusters | 2 | 0.3% |
| Needs-human clusters | 45 | 7.6% |
...
- Latest records: 589 clusters: 216 maintainer action, 115 automation snapshot, 231 intervention needed, 27 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#107442](https://github.com/openclaw/openclaw/issues/107442) is maintainer_input: Central security handling only..
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#125422](https://github.com/openclaw/openclaw/pull/125422) is automation_failed: Maintainer opted this PR into ClawSweeper automerge/autofix repair; run the direct Codex edit loop after live hydration instead of a sepa....
...
| Intervention Needed | 231 | automation failure or blocker recorded |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#125422](https://github.com/openclaw/openclaw/pull/125422) | automation_failed | Maintainer opted this PR into ClawSweeper automerge/autofix repair; run the direct Codex edit loop after live hydration instead of a separate read-... | Aug 23, 2026, 10:36 UTC | [automerge-openclaw-openclaw-125422](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-openclaw-125422.md) | [32633804366](https://github.com/openclaw/clawsweeper/actions/runs/32633804366) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#128156](https://github.com/openclaw/openclaw/pull/128156) | automation_failed | Add a cloned-regex no-match gate only for patterns derived from the built-in default table, preserving custom-regex and full-context semantics. | Aug 23, 2026, 10:30 UTC | [issue-openclaw-openclaw-128156](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-128156.md) | [32633477882](https://github.com/openclaw/clawsweeper/actions/runs/32633477882) |
