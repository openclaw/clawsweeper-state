...
Last source update: Sep 10, 2026, 16:29 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 10, 2026, 16:24 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34498732669) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 10, 2026, 16:29 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34502352871) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Sep 10, 2026, 10:45 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34467674921) |
...
| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 964 | 100% |
| Run attempts archived | 2969 | audit |
| Latest successful clusters | 799 | 82.9% |
| Latest failed clusters | 163 | 16.9% |
| Latest cancelled clusters | 2 | 0.2% |
| Needs-human clusters | 122 | 12.7% |
| Fix actions failed | 34 | 4.7% |
| Fix actions blocked | 152 | 20.9% |
...
- Latest records: 964 clusters: 318 maintainer action, 192 automation snapshot, 416 intervention needed, 38 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#138691](https://github.com/openclaw/openclaw/issues/138691) is maintainer_input: Quarantine this separate pairing-policy change for central OpenClaw security handling without public mutation. It does not block the diag....
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [issue-openclaw-openclaw-144150](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-144150.md) is automation_failed: Codex fix worker timed out after 1800000ms.
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#144006](https://github.com/openclaw/openclaw/pull/144006) is action_planned: Extend existing final-payload deduplication to consume successful same-assistant-message caption delivery evidence. None of the hydrated....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 318 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 192 | repair, check, or planned action recorded; verify live status |
| Intervention Needed | 416 | automation failure or blocker recorded |
| No Pending Action | 38 | latest record proposes no repair or apply action |
...
| automation_blocked | 239 |
| reviewed_no_action | 38 |
| completed | 0 |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#138691](https://github.com/openclaw/openclaw/issues/138691) | maintainer_input | Quarantine this separate pairing-policy change for central OpenClaw security handling without public mutation. It does not block the diagnostic-onl... | Sep 10, 2026, 16:04 UTC | [issue-openclaw-openclaw-144124](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-144124.md) | [34494556139](https://github.com/openclaw/clawsweeper/actions/runs/34494556139) |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#144006](https://github.com/openclaw/openclaw/pull/144006) | action_planned | Extend existing final-payload deduplication to consume successful same-assistant-message caption delivery evidence. None of the hydrated PRs covers... | Sep 10, 2026, 13:06 UTC | [issue-openclaw-openclaw-144006](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-144006.md) | [34479722282](https://github.com/openclaw/clawsweeper/actions/runs/34479722282) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#143790](https://github.com/openclaw/openclaw/pull/143790) | action_planned | The string-literal and root-level repairs cover different cases. Prepare the scoped fix artifact, with runtime reproduction required before impleme... | Sep 10, 2026, 07:59 UTC | [issue-openclaw-openclaw-143790](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-143790.md) | [34452292491](https://github.com/openclaw/clawsweeper/actions/runs/34452292491) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#143646](https://github.com/openclaw/openclaw/pull/143646) | action_planned | The focused bug has a concrete repair path without a new configuration option or runtime policy change. Reproduce against refreshed main before imp... | Sep 10, 2026, 03:57 UTC | [issue-openclaw-openclaw-143646](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-143646.md) | [34435066741](https://github.com/openclaw/clawsweeper/actions/runs/34435066741) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#143385](https://github.com/openclaw/openclaw/pull/143385) | action_planned | Preserve this canonical issue and prepare one implementation PR after reproduction and dependency-contract verification. Closure and merge are proh... | Sep 9, 2026, 23:32 UTC | [issue-openclaw-openclaw-143385](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-143385.md) | [34416959177](https://github.com/openclaw/clawsweeper/actions/runs/34416959177) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#143282](https://github.com/openclaw/openclaw/pull/143282) | action_planned | Useful, editable contributor work already owns this repair. Address the reported defects and investigate CI before considering readiness; preserve... | Sep 9, 2026, 17:42 UTC | [issue-openclaw-openclaw-143267](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-143267.md) | [34383512541](https://github.com/openclaw/clawsweeper/actions/runs/34383512541) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#143018](https://github.com/openclaw/openclaw/pull/143018) | action_planned | Internal helpers should intentionally skip recall. A focused eligibility repair can enforce that documented behavior without changing authorization... | Sep 9, 2026, 10:37 UTC | [issue-openclaw-openclaw-143018](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-143018.md) | [34340717378](https://github.com/openclaw/clawsweeper/actions/runs/34340717378) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#142878](https://github.com/openclaw/openclaw/pull/142878) | action_planned | A narrow bug-fix plan is supported by the supplied report. Establish the failing regression and inspect the supported native source contract before... | Sep 9, 2026, 07:41 UTC | [issue-openclaw-openclaw-142878](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-142878.md) | [34324541624](https://github.com/openclaw/clawsweeper/actions/runs/34324541624) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#142848](https://github.com/openclaw/openclaw/issues/142848) | action_planned | A focused admission-and-ranking repair is appropriate. Establish failing builder regressions before implementation; do not close or merge from this... | Sep 9, 2026, 06:52 UTC | [issue-openclaw-openclaw-142848](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-142848.md) | [34320554064](https://github.com/openclaw/clawsweeper/actions/runs/34320554064) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#142820](https://github.com/openclaw/openclaw/pull/142820) | action_planned | The channel candidate forwards the selected profile directly; RPC applies the existing CLI forwarding selector. Prepare one implementation PR, cont... | Sep 9, 2026, 05:39 UTC | [issue-openclaw-openclaw-142820](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-142820.md) | [34315189563](https://github.com/openclaw/clawsweeper/actions/runs/34315189563) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#142847](https://github.com/openclaw/openclaw/issues/142847) | action_planned | A focused repair path is supported. Implement only after reproducing the defect on current main and refreshing existing-PR ownership. | Sep 9, 2026, 05:36 UTC | [issue-openclaw-openclaw-142847](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-142847.md) | [34315185229](https://github.com/openclaw/clawsweeper/actions/runs/34315185229) |
...
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#144176](https://github.com/openclaw/openclaw/pull/144176) | automation_failed | The observed producer defect supports a narrow bug fix. Reproduce again on verified current main before editing; leave the issue open. | Sep 10, 2026, 16:26 UTC | [issue-openclaw-openclaw-144176](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-144176.md) | [34501072598](https://github.com/openclaw/clawsweeper/actions/runs/34501072598) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) |  | automation_failed | validation command failed (pnpm check:changed): $ node scripts/check-changed.mjs [check:changed] lanes=extensions, extensionTests [check:changed] e... | Sep 10, 2026, 16:17 UTC | [automerge-openclaw-openclaw-142626](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-openclaw-142626.md) | [34493751604](https://github.com/openclaw/clawsweeper/actions/runs/34493751604) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#144152](https://github.com/openclaw/openclaw/pull/144152) | automation_failed | A bounded catalog-to-presentation repair is supported by source and controller evidence; the required full regression remains a prerequisite to imp... | Sep 10, 2026, 15:59 UTC | [issue-openclaw-openclaw-144152](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-144152.md) | [34498337479](https://github.com/openclaw/clawsweeper/actions/runs/34498337479) |
