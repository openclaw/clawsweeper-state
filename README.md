...
Last source update: Sep 6, 2026, 06:41 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Sep 6, 2026, 06:41 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34016714033) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 6, 2026, 06:40 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34017067996) |
...
Last source update: Sep 6, 2026, 06:43 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 874 | 100% |
| Run attempts archived | 2728 | audit |
| Latest successful clusters | 715 | 81.8% |
| Latest failed clusters | 157 | 18.0% |
...
- Latest records: 874 clusters: 304 maintainer action, 131 automation snapshot, 402 intervention needed, 37 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#139847](https://github.com/openclaw/openclaw/pull/139847) is automation_failed: Keep the issue open. The missing initialization has a narrow owning-boundary repair, conditional on reproduction against refreshed main..
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#139527](https://github.com/openclaw/openclaw/pull/139527) is action_planned: Keep this current report as the canonical repair target. Plan a guard against ineffective stale-runtime replacement while preserving exis....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 304 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 131 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#139847](https://github.com/openclaw/openclaw/pull/139847) | automation_failed | Keep the issue open. The missing initialization has a narrow owning-boundary repair, conditional on reproduction against refreshed main. | Sep 6, 2026, 06:43 UTC | [issue-openclaw-openclaw-139847](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-139847.md) | [34016924972](https://github.com/openclaw/clawsweeper/actions/runs/34016924972) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#130432](https://github.com/openclaw/openclaw/pull/130432) | automation_failed | Keep the issue open. The hydrated report and inspected source support repair planning, but implementation must first establish a failing regression... | Sep 6, 2026, 06:10 UTC | [issue-openclaw-openclaw-130432](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-130432.md) | [34015412277](https://github.com/openclaw/clawsweeper/actions/runs/34015412277) |
