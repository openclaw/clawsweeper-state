...
Last source update: Aug 4, 2026, 07:12 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review publish complete | Aug 4, 2026, 07:12 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/30884032216) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 4, 2026, 06:15 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/30883312861) |
...
Last source update: Aug 4, 2026, 06:15 UTC
...
| Latest successful clusters | 296 | 86.5% |
| Latest failed clusters | 45 | 13.2% |
...
- Latest records: 342 clusters: 166 maintainer action, 54 automation snapshot, 101 intervention needed, 21 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#119129](https://github.com/openclaw/openclaw/pull/119129) is automation_failed: A narrow bug fix is warranted, but this read-only checkout cannot create the required branch delta or run write-producing test fixtures..
...
| Intervention Needed | 101 | automation failure or blocker recorded |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#119129](https://github.com/openclaw/openclaw/pull/119129) | automation_failed | A narrow bug fix is warranted, but this read-only checkout cannot create the required branch delta or run write-producing test fixtures. | Aug 4, 2026, 06:15 UTC | [issue-openclaw-openclaw-119129](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-119129.md) | [30882912729](https://github.com/openclaw/clawsweeper/actions/runs/30882912729) |
