...
target_branch: clawsweeper/issue-openclaw-openclaw-92474
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/92474.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 92474
source_issue_revision_sha256: "4a8fdd2c926fba9b02fbfd639a12a3390de1e2537665fb2bc7c8664c87b290d0"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-92474`.

Source issue: https://github.com/openclaw/openclaw/issues/92474
...
- ClawSweeper review report: records/openclaw-openclaw/items/92474.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/92474.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/92474.md
Category: bug
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-92474` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/92474 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/92474 when the implementation satisfies the issue.
