...
Last source update: Sep 11, 2026, 13:36 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 11, 2026, 13:36 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34603590380) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 11, 2026, 13:30 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34604582306) |
...
Last source update: Sep 11, 2026, 13:08 UTC
...
| Run attempts archived | 3033 | audit |
| Latest successful clusters | 818 | 83.4% |
...
- Latest records: 981 clusters: 318 maintainer action, 208 automation snapshot, 416 intervention needed, 39 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#144911](https://github.com/openclaw/openclaw/pull/144911) is automation_failed: Required reproduction and implementation need writable authorized isolation with installed dependencies. This is an environment blocker,....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#144877](https://github.com/openclaw/openclaw/issues/144877) is action_planned: A narrow repair is supported by the existing placement contract. Runtime reproduction must precede implementation; no matching fix PR is....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 318 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 208 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#144911](https://github.com/openclaw/openclaw/pull/144911) | automation_failed | Required reproduction and implementation need writable authorized isolation with installed dependencies. This is an environment blocker, not eviden... | Sep 11, 2026, 13:08 UTC | [issue-openclaw-openclaw-144911](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-144911.md) | [34598605765](https://github.com/openclaw/clawsweeper/actions/runs/34598605765) |
