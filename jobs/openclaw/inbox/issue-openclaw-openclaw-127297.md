...
target_branch: clawsweeper/issue-openclaw-openclaw-127297
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/127297.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 127297
source_issue_revision_sha256: "40760cc7b9a3ced47d9ca707bbe8ac4de4105763b240e12e08d714bae1be416b"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-127297`.

Source issue: https://github.com/openclaw/openclaw/issues/127297
Title: [Bug]: plugin drift remediation uses packaging build suffix as nonexistent npm version

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/127297.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/127297.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/127297.md
Category: bug
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-127297` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/127297 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/127297 when the implementation satisfies the issue.
