...
target_branch: clawsweeper/issue-openclaw-openclaw-119233
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/119233.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 119233
source_issue_revision_sha256: "1b41cc10c14637935f5c0fcabc43bcfc41e00459b85ba50f97274bc2c6351471"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-119233`.

Source issue: https://github.com/openclaw/openclaw/issues/119233
Title: [Bug]: models auth order set --agent reports success but drops inherited profile IDs

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/119233.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/119233.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/119233.md
Category: bug
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-119233` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/119233 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/119233 when the implementation satisfies the issue.
