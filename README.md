...
Last source update: Sep 2, 2026, 11:12 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 2, 2026, 11:12 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33619193912) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 2, 2026, 10:57 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33621960267) |
...
Last source update: Sep 2, 2026, 10:56 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 788 | 100% |
| Run attempts archived | 2558 | audit |
| Latest successful clusters | 656 | 83.2% |
| Latest failed clusters | 130 | 16.5% |
| Latest cancelled clusters | 2 | 0.3% |
| Needs-human clusters | 109 | 13.8% |
...
- Latest records: 788 clusters: 286 maintainer action, 114 automation snapshot, 353 intervention needed, 35 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#136212](https://github.com/openclaw/openclaw/pull/136212) is automation_failed: Narrow non-security repair candidate; no active implementation PR is hydrated..
...
| Intervention Needed | 353 | automation failure or blocker recorded |
