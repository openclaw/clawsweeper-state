...
Last source update: Aug 22, 2026, 17:38 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Hot intake publish complete | Aug 22, 2026, 17:38 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32587732165) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 22, 2026, 17:33 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32588008851) |
...
Last source update: Aug 22, 2026, 17:36 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 578 | 100% |
| Run attempts archived | 1927 | audit |
| Latest successful clusters | 475 | 82.2% |
| Latest failed clusters | 101 | 17.5% |
...
- Latest records: 578 clusters: 215 maintainer action, 115 automation snapshot, 221 intervention needed, 27 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [issue-openclaw-openclaw-124689](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-124689.md) is maintainer_input: Provide a writable checkout with dependencies installed and the required sibling `../codex` source so the planned regression can be demon....
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#126018](https://github.com/openclaw/openclaw/pull/126018) is automation_failed: Current main still drops the legacy interactive-text tail; a focused owner-boundary repair is appropriate..
...
| Intervention Needed | 221 | automation failure or blocker recorded |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) |  | maintainer_input | Provide a writable checkout with dependencies installed and the required sibling `../codex` source so the planned regression can be demonstrated pr... | Aug 22, 2026, 17:36 UTC | [issue-openclaw-openclaw-124689](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-124689.md) | [32587760244](https://github.com/openclaw/clawsweeper/actions/runs/32587760244) |
...
| --- | --- | --- | --- | --- |
| issue-openclaw-openclaw-124689 | needs human | Provide a writable checkout with dependencies installed and the required sibling `../codex` source so the planned regression can be demonstrated pr... | [issue-openclaw-openclaw-124689](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-124689.md) | [32587760244](https://github.com/openclaw/clawsweeper/actions/runs/32587760244) |
