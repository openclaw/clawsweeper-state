...
target_branch: clawsweeper/clawsweeper-openclaw-openclaw-73964-73872
source: clawsweeper
---

# ClawSweeper-promoted fix PR candidate

ClawSweeper Repair should create or update one implementation PR from `clawsweeper/clawsweeper-openclaw-openclaw-73964-73872`.
...
PR hygiene:
- Create a replacement ClawSweeper PR against current `main`; do not edit the source contributor branch directly.
...
- Keep one PR for this cluster; reuse `clawsweeper/clawsweeper-openclaw-openclaw-73964-73872` if it already exists.
