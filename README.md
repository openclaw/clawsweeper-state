...
Last source update: Sep 16, 2026, 16:33 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 16, 2026, 16:33 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35121287530) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 16, 2026, 16:31 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35122362023) |
...
Last source update: Sep 16, 2026, 16:08 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1069 | 100% |
| Run attempts archived | 3229 | audit |
| Latest successful clusters | 903 | 84.5% |
| Latest failed clusters | 164 | 15.3% |
...
- Latest records: 1069 clusters: 329 maintainer action, 274 automation snapshot, 420 intervention needed, 46 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [cluster:issue-openclaw-openclaw-150126](cluster:issue-openclaw-openclaw-150126) is automation_failed: Implementation and publication require a writable executor checkout, completed validation, and isolated recovery proof. This worker must....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#150117](https://github.com/openclaw/openclaw/pull/150117) is action_planned: Confirmed delivery facts must reach the successful tool result without inventing thread-wide counters or adding a fallible post-send read....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 329 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 274 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [cluster:issue-openclaw-openclaw-150126](cluster:issue-openclaw-openclaw-150126) | automation_failed | Implementation and publication require a writable executor checkout, completed validation, and isolated recovery proof. This worker must not publis... | Sep 16, 2026, 16:08 UTC | [issue-openclaw-openclaw-150126](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-150126.md) | [35114531160](https://github.com/openclaw/clawsweeper/actions/runs/35114531160) |
