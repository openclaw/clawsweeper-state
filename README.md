...
Last source update: Aug 18, 2026, 23:25 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Aug 18, 2026, 23:25 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32195909067) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 18, 2026, 23:16 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32196334394) |
...
Last source update: Aug 18, 2026, 23:16 UTC
...
| Run attempts archived | 1506 | audit |
| Latest successful clusters | 445 | 85.2% |
| Latest failed clusters | 75 | 14.4% |
...
- Latest records: 522 clusters: 202 maintainer action, 117 automation snapshot, 176 intervention needed, 27 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#126018](https://github.com/openclaw/openclaw/pull/126018) is automation_blocked: A writable executor with dependencies and ../codex is required to implement and validate the allowed new fix PR..
