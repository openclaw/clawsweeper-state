...
target_branch: clawsweeper/automerge-openclaw-openclaw-51672
source: pr_automerge
---

# ClawSweeper adopted PR repair candidate

Maintainer opted #51672 into ClawSweeper automerge.

Source PR: https://github.com/openclaw/openclaw/pull/51672
Title: ci: add missing extension and channel labels to labeler.yml

ClawSweeper should use this job only for the bounded ClawSweeper review/fix loop:

- Emit a fix artifact with `repair_strategy: "repair_contributor_branch"` and `source_prs: ["https://github.com/openclaw/openclaw/pull/51672"]` so the Codex edit pass can make this PR merge-ready.
