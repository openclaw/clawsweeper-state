...
Last source update: Aug 29, 2026, 08:14 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review comments checked | Aug 29, 2026, 08:14 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33241863187) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 29, 2026, 07:57 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33241960300) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Aug 29, 2026, 06:01 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33237453215) |
...
Last source update: Aug 29, 2026, 08:04 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 688 | 100% |
| Run attempts archived | 2330 | audit |
| Latest successful clusters | 574 | 83.4% |
| Latest failed clusters | 112 | 16.3% |
| Latest cancelled clusters | 2 | 0.3% |
| Needs-human clusters | 68 | 9.9% |
...
- Latest records: 688 clusters: 241 maintainer action, 113 automation snapshot, 304 intervention needed, 30 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#130144](https://github.com/openclaw/openclaw/issues/130144) is maintainer_input: Restore or provide read access to the required ../codex sibling source, then rerun the direct Codex protocol/runtime inspection before cr....
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#98468](https://github.com/openclaw/openclaw/pull/98468) is automation_blocked: A writable execution environment and the mandatory ../codex source checkout are required before making a Codex-gated code change and runn....
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#130144](https://github.com/openclaw/openclaw/issues/130144) | maintainer_input | Restore or provide read access to the required ../codex sibling source, then rerun the direct Codex protocol/runtime inspection before creating a f... | Aug 29, 2026, 08:04 UTC | [issue-openclaw-openclaw-130144](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-130144.md) | [33241517162](https://github.com/openclaw/clawsweeper/actions/runs/33241517162) |
...
| --- | --- | --- | --- | --- |
| issue-openclaw-openclaw-130144 | needs human | Restore or provide read access to the required ../codex sibling source, then rerun the direct Codex protocol/runtime inspection before creating a f... | [issue-openclaw-openclaw-130144](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-130144.md) | [33241517162](https://github.com/openclaw/clawsweeper/actions/runs/33241517162) |
