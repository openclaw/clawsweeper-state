...
Last source update: Sep 11, 2026, 09:44 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Planning review | Sep 11, 2026, 09:44 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34585644046) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 11, 2026, 09:44 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34585607581) |
...
Last source update: Sep 11, 2026, 09:42 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 976 | 100% |
| Run attempts archived | 3020 | audit |
| Latest successful clusters | 812 | 83.2% |
| Latest failed clusters | 162 | 16.6% |
| Latest cancelled clusters | 2 | 0.2% |
| Needs-human clusters | 122 | 12.5% |
| Fix actions failed | 34 | 4.7% |
| Fix actions blocked | 153 | 21.0% |
...
- Latest records: 976 clusters: 318 maintainer action, 203 automation snapshot, 416 intervention needed, 39 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#144796](https://github.com/openclaw/openclaw/pull/144796) is automation_failed: A focused advertiser logging repair is supported by current source and the hydrated report. Implementation must first establish the faili....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#144801](https://github.com/openclaw/openclaw/pull/144801) is action_planned: Preserve LiuwqGit's useful implementation and attribution. Retrieve the complete review and failed-check diagnostics, then complete isola....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 318 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 203 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#144796](https://github.com/openclaw/openclaw/pull/144796) | automation_failed | A focused advertiser logging repair is supported by current source and the hydrated report. Implementation must first establish the failing entry-p... | Sep 11, 2026, 09:35 UTC | [issue-openclaw-openclaw-144796](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-144796.md) | [34580713099](https://github.com/openclaw/clawsweeper/actions/runs/34580713099) |
