...
Last source update: Aug 18, 2026, 19:46 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Hot intake publish complete | Aug 18, 2026, 19:46 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32176892262) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Aug 18, 2026, 19:33 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32177218539) |
...
Last source update: Aug 18, 2026, 19:40 UTC
...
- Latest records: 518 clusters: 202 maintainer action, 115 automation snapshot, 174 intervention needed, 27 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#125942](https://github.com/openclaw/openclaw/issues/125942) is maintainer_input: Provide a readable sibling ../codex checkout (or a writable environment to clone it) and dependencies so the required Codex contract chec....
...
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#124015](https://github.com/openclaw/openclaw/pull/124015) is action_planned: Rebase onto current main, retrieve the two failed-job logs for the exact refreshed head, make only the necessary owner-boundary repair, t....
...
| Intervention Needed | 174 | automation failure or blocker recorded |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#125942](https://github.com/openclaw/openclaw/issues/125942) | maintainer_input | Provide a readable sibling ../codex checkout (or a writable environment to clone it) and dependencies so the required Codex contract check and focu... | Aug 18, 2026, 19:40 UTC | [issue-openclaw-openclaw-125942](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-125942.md) | [32176925242](https://github.com/openclaw/clawsweeper/actions/runs/32176925242) |
...
| --- | --- | --- | --- | --- |
| issue-openclaw-openclaw-125942 | needs human | Provide a readable sibling ../codex checkout (or a writable environment to clone it) and dependencies so the required Codex contract check and focu... | [issue-openclaw-openclaw-125942](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-125942.md) | [32176925242](https://github.com/openclaw/clawsweeper/actions/runs/32176925242) |
