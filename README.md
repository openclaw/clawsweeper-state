...
Last source update: Aug 30, 2026, 06:54 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Aug 30, 2026, 06:54 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33295560418) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 30, 2026, 06:49 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33297732717) |
...
Last source update: Aug 30, 2026, 06:55 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 703 | 100% |
| Run attempts archived | 2388 | audit |
| Latest successful clusters | 587 | 83.5% |
...
- Latest records: 703 clusters: 248 maintainer action, 115 automation snapshot, 310 intervention needed, 30 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#133117](https://github.com/openclaw/openclaw/pull/133117) is automation_failed: A writable worker with the required sibling Codex source checkout must perform the narrow repair and regression proof before opening the PR..
