...
Last source update: Aug 23, 2026, 04:42 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review publish complete | Aug 23, 2026, 04:42 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32616973265) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Aug 23, 2026, 04:35 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32618209680) |
...
Last source update: Aug 23, 2026, 04:45 UTC
...
| Run attempts archived | 2003 | audit |
| Latest successful clusters | 481 | 82.1% |
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [cluster:issue-openclaw-openclaw-124689](cluster:issue-openclaw-openclaw-124689) is automation_failed: Executor must use a writable checkout with dependencies and clone/provide ../codex before editing and validation..
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [cluster:issue-openclaw-openclaw-124689](cluster:issue-openclaw-openclaw-124689) | automation_failed | Executor must use a writable checkout with dependencies and clone/provide ../codex before editing and validation. | Aug 23, 2026, 04:45 UTC | [issue-openclaw-openclaw-124689](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-124689.md) | [32618218144](https://github.com/openclaw/clawsweeper/actions/runs/32618218144) |
