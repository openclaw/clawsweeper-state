...
target_branch: clawsweeper/automerge-openclaw-openclaw-75552
source: pr_automerge
---

# ClawSweeper adopted PR repair candidate

Maintainer opted #75552 into ClawSweeper automerge.

Source PR: https://github.com/openclaw/openclaw/pull/75552
Title: fix(gateway): bound session transcript hot paths

ClawSweeper should use this job only for the bounded ClawSweeper review/fix loop:

- If ClawSweeper emits an explicit repair marker, requests changes, or finds failing checks/rebase work, and the PR branch is safe to update, emit a fix artifact with `repair_strategy: "repair_contributor_branch"` and `source_prs: ["https://github.com/openclaw/openclaw/pull/75552"]`.
