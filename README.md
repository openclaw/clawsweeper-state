...
Last source update: Aug 28, 2026, 00:42 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review comments checked | Aug 28, 2026, 00:42 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33129146728) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 28, 2026, 00:28 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33129752615) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Aug 27, 2026, 03:27 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33036411219) |
...
Last source update: Aug 28, 2026, 00:21 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 666 | 100% |
| Run attempts archived | 2273 | audit |
| Latest successful clusters | 554 | 83.2% |
| Latest failed clusters | 110 | 16.5% |
| Latest cancelled clusters | 2 | 0.3% |
| Needs-human clusters | 65 | 9.8% |
| Fix actions failed | 30 | 4.7% |
| Fix actions blocked | 130 | 20.4% |
...
- Latest records: 666 clusters: 237 maintainer action, 114 automation snapshot, 285 intervention needed, 30 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [issue-openclaw-openclaw-130977](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-130977.md) is maintainer_input: Provide or approve the raw plugins-list RSS samples from the failing Blacksmith run and comparable passing runs, plus the intended sustai....
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#119718](https://github.com/openclaw/openclaw/pull/119718) is automation_failed: Maintainer opted this PR into ClawSweeper automerge/autofix repair; run the direct Codex edit loop after live hydration instead of a sepa....
...
| --- | ---: | --- |
| Maintainer Action | 237 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 114 | repair, check, or planned action recorded; verify live status |
| Intervention Needed | 285 | automation failure or blocker recorded |
...
| automation_active | 0 |
| action_planned | 70 |
| automation_failed | 126 |
| automation_blocked | 159 |
...
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#131231](https://github.com/openclaw/openclaw/pull/131231) | automation_failed | Implementation is blocked only by this worker environment. The deterministic executor needs a writable checkout with dependencies and the required... | Aug 27, 2026, 23:38 UTC | [issue-openclaw-openclaw-131231](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-131231.md) | [33123976868](https://github.com/openclaw/clawsweeper/actions/runs/33123976868) |
...
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#130742](https://github.com/openclaw/openclaw/pull/130742) | automation_blocked | Configured non-default session stores cannot reach either transcript integrity path. | Aug 27, 2026, 14:43 UTC | [issue-openclaw-openclaw-130742](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-130742.md) | [33080938248](https://github.com/openclaw/clawsweeper/actions/runs/33080938248) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#92015](https://github.com/openclaw/openclaw/pull/92015) | automation_blocked | The ACP binding/effective-cwd contract must be checked in the required Codex source before implementing the lifecycle gate. | Aug 27, 2026, 12:49 UTC | [issue-openclaw-openclaw-92015](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-92015.md) | [33072289852](https://github.com/openclaw/clawsweeper/actions/runs/33072289852) |
