...
Generated: 2026-08-02T02:49:14.880Z
...
| [#117717](https://github.com/openclaw/openclaw/pull/117717) | fix(whatsapp): log terminal inbound media failures | issue-openclaw-openclaw-117709 | MERGEABLE | BEHIND | SUCCESS:50 SKIPPED:38 IN_PROGRESS:19 NEUTRAL:1; blockers:19 | needs_merge_state:BEHIND, needs_checks:CI / build-artifacts:IN_PROGRESS; CI / checks-node-compact-large-1:IN_PROGRESS; CI / checks-node-compact-large-2:IN_PROGRESS, needs_merge_preflight | repair failing checks or document unrelated main flake with touched-surface proof |
...
| [#117620](https://github.com/openclaw/openclaw/pull/117620) | fix(model-catalog): preserve manifest lifecycle metadata on refresh | issue-openclaw-openclaw-117545 | MERGEABLE | BEHIND | CANCELLED:6 SKIPPED:42 SUCCESS:81 FAILURE:3 NEUTRAL:1; blockers:6 | needs_merge_state:BEHIND, needs_checks:Real behavior proof:CANCELLED; Real behavior proof:CANCELLED; Real behavior proof:CANCELLED, needs_merge_preflight | repair failing checks or document unrelated main flake with touched-surface proof |
