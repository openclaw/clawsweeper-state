...
target_branch: clawsweeper/issue-openclaw-openclaw-86939
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-86939`.

Source issue: https://github.com/openclaw/openclaw/issues/86939
Title: fix(ui): webchat run-status-label stuck on "In progress" after model call ends

## Maintainer Context

- Command comment: https://github.com/openclaw/openclaw/issues/86939#issuecomment-4545600354
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-86939` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/86939 in the PR body.
