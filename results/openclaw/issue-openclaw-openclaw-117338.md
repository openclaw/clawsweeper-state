...
mode: "autonomous"
run_id: "30698090859"
run_url: "https://github.com/openclaw/clawsweeper/actions/runs/30698090859"
head_sha: "922ebc673e129c2f85d3990f5c99dd1ec7c9effc"
workflow_conclusion: "success"
result_status: "blocked"
published_at: "2026-08-01T12:25:59.398Z"
...
Run: [https://github.com/openclaw/clawsweeper/actions/runs/30698090859](https://github.com/openclaw/clawsweeper/actions/runs/30698090859)
...
Verified the open canonical issue on current main (597699401a5fda97296118286c081357fa2055a5): the canonical matcher returns false for the Chinese recall request "我们上次讨论了什么？", and the active-memory hook then exits before deep recall. The repair is a narrow plugin-local matcher and regression-test change, but this worker checkout is read-only and has no installed dependencies, so it cannot create the required branch diff or run the focused Vitest validation.
...
| Target | Action | Status | Classification | Reason |
| --- | --- | --- | --- | --- |
| #117338 | keep_canonical | planned | canonical | This is a reproducible, non-security, default-path active-memory defect with one clear plugin-local owner. |
| #117338 | fix_needed | planned | canonical | Create one narrow new fix PR from clawsweeper/issue-openclaw-openclaw-117338; no existing candidate PR was hydrated. |
| cluster:issue-openclaw-openclaw-117338 | build_fix_artifact | blocked | canonical | The implementation plan is deterministic, but materializing and validating it requires a writable trusted checkout with dependencies available. |
