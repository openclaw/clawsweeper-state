...
Last source update: Sep 7, 2026, 12:46 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Sep 7, 2026, 12:46 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34119083810) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 7, 2026, 12:41 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34123133845) |
...
Last source update: Sep 7, 2026, 12:32 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 902 | 100% |
| Run attempts archived | 2787 | audit |
| Latest successful clusters | 743 | 82.4% |
...
- Latest records: 902 clusters: 305 maintainer action, 152 automation snapshot, 408 intervention needed, 37 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#141202](https://github.com/openclaw/openclaw/pull/141202) is automation_failed: Keep the issue open. Execute the reproduction-first repair only after refreshing main and PR ownership in a writable checkout..
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#141122](https://github.com/openclaw/openclaw/pull/141122) is action_planned: Repair storage release at the lifecycle owner while preserving admitted-write ordering and bounded teardown. Publication requires success....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 305 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 152 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#141202](https://github.com/openclaw/openclaw/pull/141202) | automation_failed | Keep the issue open. Execute the reproduction-first repair only after refreshing main and PR ownership in a writable checkout. | Sep 7, 2026, 12:32 UTC | [issue-openclaw-openclaw-141202](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-141202.md) | [34121426211](https://github.com/openclaw/clawsweeper/actions/runs/34121426211) |
