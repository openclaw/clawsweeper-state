...
Last source update: Aug 25, 2026, 01:32 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Aug 25, 2026, 01:32 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32795741668) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 25, 2026, 01:01 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32795800218) |
...
Last source update: Aug 25, 2026, 01:05 UTC
...
- Latest records: 610 clusters: 225 maintainer action, 114 automation snapshot, 243 intervention needed, 28 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#128877](https://github.com/openclaw/openclaw/issues/128877) is maintainer_input: Capture the exact b10453 managed llama-server --version output or an equivalent redacted trace from a writable, network-enabled environme....
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#125838](https://github.com/openclaw/openclaw/pull/125838) is automation_blocked: A narrow repair remains appropriate, but this worker cannot satisfy the repository’s direct-Codex-source prerequisite or install the miss....
...
| --- | ---: | --- |
| Maintainer Action | 225 | explicit decision, access, or merge authority recorded |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#125838](https://github.com/openclaw/openclaw/pull/125838) | automation_blocked | A narrow repair remains appropriate, but this worker cannot satisfy the repository’s direct-Codex-source prerequisite or install the missing local... | Aug 25, 2026, 01:05 UTC | [issue-openclaw-openclaw-125838](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-125838.md) | [32795470464](https://github.com/openclaw/clawsweeper/actions/runs/32795470464) |
