...
target_branch: clawsweeper/issue-openclaw-crabbox-382
source: issue_implementation
trigger_source: review_viable_issue
clawsweeper_report_path: records/openclaw-crabbox/items/382.md
source_issue_repo: "openclaw/crabbox"
source_issue_number: 382
source_issue_revision_sha256: "ceb917dc8e6626b6af8e34fa2dc949b7433c3203c6ae33af28cc72f20d9a5c26"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-crabbox-382`.

Source issue: https://github.com/openclaw/crabbox/issues/382
Title: Add a Flue delegated provider for running Crabbox jobs through Flue sandboxes

## Maintainer Context

- Trigger source: review_viable_issue
- ClawSweeper review report: records/openclaw-crabbox/items/382.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-crabbox/items/382.md
- Maintainer instruction: ClawSweeper finished reviewing this open issue and found no active implementation PR.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-crabbox/items/382.md
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-crabbox-382` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/crabbox/issues/382 in the PR body.
- Use a closing reference for https://github.com/openclaw/crabbox/issues/382 when the implementation satisfies the issue.
