...
Last source update: Aug 29, 2026, 10:12 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Planning review | Aug 29, 2026, 10:12 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33246859030) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 29, 2026, 09:41 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33246045762) |
...
Last source update: Aug 29, 2026, 10:03 UTC
...
| Run attempts archived | 2337 | audit |
| Latest successful clusters | 574 | 83.3% |
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#70634](https://github.com/openclaw/openclaw/pull/70634) is automation_failed: Provision a writable checkout with dependencies and the required sibling Codex source, then apply the narrow repair artifact..
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#70634](https://github.com/openclaw/openclaw/pull/70634) | automation_failed | Provision a writable checkout with dependencies and the required sibling Codex source, then apply the narrow repair artifact. | Aug 29, 2026, 10:03 UTC | [issue-openclaw-openclaw-70634](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-70634.md) | [33246150691](https://github.com/openclaw/clawsweeper/actions/runs/33246150691) |
