...
Generated: 2026-08-03T00:20:39.052Z
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| [#118325](https://github.com/openclaw/openclaw/pull/118325) | fix(memory-core): ingest transcript turns into short-term recall | issue-openclaw-openclaw-117669 | MERGEABLE | BEHIND | CANCELLED:8 QUEUED:2 IN_PROGRESS:12 SUCCESS:1 SKIPPED:20; blockers:16 | needs_merge_state:BEHIND, needs_checks:Real behavior proof:CANCELLED; Real behavior proof:CANCELLED; Real behavior proof:CANCELLED, needs_merge_preflight, needs_result_backfill | repair failing checks or document unrelated main flake with touched-surface proof |
...
| [#117485](https://github.com/openclaw/openclaw/pull/117485) | fix(ios): route forced realtime consults through Gateway relay | issue-openclaw-openclaw-110171 | MERGEABLE | BEHIND | SUCCESS:18 IN_PROGRESS:3 SKIPPED:24 QUEUED:3; blockers:6 | needs_merge_state:BEHIND, needs_checks:Shared OpenClawKit Periphery / Scan shared kit from iOS:IN_PROGRESS; iOS Periphery Dead Code / Scan iOS dead code:IN_PROGRESS; Shared OpenClawKit Periphery / Scan shared kit from macOS:IN_PROGRESS, needs_merge_preflight | repair failing checks or document unrelated main flake with touched-surface proof |
