...
target_branch: clawsweeper/clawsweeper-openclaw-openclaw-73880
source: clawsweeper
---

# ClawSweeper-promoted fix PR candidate

ClawSweeper Repair should create or update one implementation PR from `clawsweeper/clawsweeper-openclaw-openclaw-73880`.
...
- Keep one PR for this cluster; reuse `clawsweeper/clawsweeper-openclaw-openclaw-73880` if it already exists.
