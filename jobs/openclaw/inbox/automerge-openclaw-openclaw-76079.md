...
cluster_id: automerge-openclaw-openclaw-76079
mode: autonomous
allowed_actions:
  - comment
  - label
...
target_branch: clawsweeper/automerge-openclaw-openclaw-76079
source: pr_automerge
---

# ClawSweeper adopted PR repair candidate

Maintainer opted #76079 into ClawSweeper autofix.

Source PR: https://github.com/openclaw/openclaw/pull/76079
Title: refactor: cache plugin tool descriptors

ClawSweeper should use this job only for the bounded ClawSweeper review/fix loop:

- If ClawSweeper emits an explicit repair marker, requests changes, or finds failing checks/rebase work, and the PR branch is safe to update, emit a fix artifact with `repair_strategy: "repair_contributor_branch"` and `source_prs: ["https://github.com/openclaw/openclaw/pull/76079"]`.
