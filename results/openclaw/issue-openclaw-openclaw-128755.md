...
cluster_id: "issue-openclaw-openclaw-128755"
mode: "autonomous"
run_id: "32742857815"
run_url: "https://github.com/openclaw/clawsweeper/actions/runs/32742857815"
head_sha: "ce250708c1ea10228f29fc5740cba95460dcdf74"
workflow_conclusion: "success"
result_status: "blocked"
published_at: "2026-08-24T16:17:19.099Z"
canonical: "https://github.com/openclaw/openclaw/issues/128755"
canonical_issue: "https://github.com/openclaw/openclaw/issues/128755"
canonical_pr: null
actions_total: 2
fix_executed: 0
fix_failed: 0
...
# issue-openclaw-openclaw-128755

Repo: openclaw/openclaw

Run: [https://github.com/openclaw/clawsweeper/actions/runs/32742857815](https://github.com/openclaw/clawsweeper/actions/runs/32742857815)
...
Verified a real gateway owner-attribution defect on current main. Implementation is blocked in this read-only worker: the required sibling ../codex checkout is absent, its mandated clone failed with EROFS, and the required test cannot initialize Corepack on the read-only filesystem. A narrow new-PR artifact is ready for a writable executor.
...
| Target | Action | Status | Classification | Reason |
| --- | --- | --- | --- | --- |
| #128755 | fix_needed | blocked | canonical | Current main is affected, but this worker cannot satisfy the repository’s mandatory Codex-source and writable-validation gates. |
| cluster:issue-openclaw-openclaw-128755 | build_fix_artifact | planned | canonical | A writable executor can apply this narrow, behavior-level repair after directly inspecting ../codex. |
