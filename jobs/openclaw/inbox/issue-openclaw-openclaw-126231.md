...
target_branch: clawsweeper/issue-openclaw-openclaw-126231
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/126231.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 126231
source_issue_revision_sha256: "edf28570bb5e723a4fd357b722678567c0120dbea6ad3ee438285b44e55f1e66"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-126231`.

Source issue: https://github.com/openclaw/openclaw/issues/126231
Title: handler-timeout ingress events die with attempts=0 — silently lost messages

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/126231.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/126231.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/126231.md
Category: bug
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-126231` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/126231 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/126231 when the implementation satisfies the issue.
