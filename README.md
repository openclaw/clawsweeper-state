...
Last source update: Sep 19, 2026, 12:54 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 19, 2026, 12:54 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35442828470) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 19, 2026, 12:48 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35443866363) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Sep 19, 2026, 12:48 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35443866372) |
...
Last source update: Sep 19, 2026, 12:48 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1106 | 100% |
| Run attempts archived | 3331 | audit |
| Latest successful clusters | 939 | 84.9% |
| Latest failed clusters | 165 | 14.9% |
...
- Latest records: 1106 clusters: 333 maintainer action, 304 automation snapshot, 422 intervention needed, 47 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [cluster:issue-openclaw-openclaw-152847](cluster:issue-openclaw-openclaw-152847) is automation_failed: Implementation requires a writable executor with installed dependencies. Reproduce first and refresh the related-PR inventory before prep....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#152760](https://github.com/openclaw/openclaw/pull/152760) is action_planned: A focused repair fits the existing sanitizer owner. Establish runtime reproduction on current main before implementation; stop if reprodu....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 333 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 304 | repair, check, or planned action recorded; verify live status |
| Intervention Needed | 422 | automation failure or blocker recorded |
| No Pending Action | 47 | latest record proposes no repair or apply action |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [cluster:issue-openclaw-openclaw-152847](cluster:issue-openclaw-openclaw-152847) | automation_failed | Implementation requires a writable executor with installed dependencies. Reproduce first and refresh the related-PR inventory before preparing the... | Sep 19, 2026, 12:48 UTC | [issue-openclaw-openclaw-152847](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-152847.md) | [35442461566](https://github.com/openclaw/clawsweeper/actions/runs/35442461566) |
