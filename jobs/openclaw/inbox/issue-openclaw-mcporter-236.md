...
cluster_id: issue-openclaw-mcporter-236
mode: autonomous
...
target_branch: clawsweeper/issue-openclaw-mcporter-236
source: issue_implementation
trigger_source: review_viable_issue
clawsweeper_report_path: records/openclaw-mcporter/items/236.md
source_issue_repo: "openclaw/mcporter"
source_issue_number: 236
source_issue_revision_sha256: "7a4b3ba51b4a4b21987e6706d5849cfb33aed65c4f032a8840259d18a710d611"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-mcporter-236`.

Source issue: https://github.com/openclaw/mcporter/issues/236
Title: v0.12.4 hasn't been released

## Maintainer Context

- Trigger source: review_viable_issue
- ClawSweeper review report: records/openclaw-mcporter/items/236.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-mcporter/items/236.md
- Maintainer instruction: ClawSweeper finished reviewing this open issue and found no active implementation PR.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-mcporter/items/236.md
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-mcporter-236` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/mcporter/issues/236 in the PR body.
- Use a closing reference for https://github.com/openclaw/mcporter/issues/236 when the implementation satisfies the issue.
