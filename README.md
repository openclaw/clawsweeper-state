...
Last source update: Aug 31, 2026, 14:44 UTC
...
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 31, 2026, 14:44 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33404255699) |
...
Last source update: Aug 31, 2026, 14:23 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 730 | 100% |
| Run attempts archived | 2457 | audit |
| Latest successful clusters | 610 | 83.6% |
...
- Latest records: 730 clusters: 260 maintainer action, 114 automation snapshot, 321 intervention needed, 35 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#134081](https://github.com/openclaw/openclaw/pull/134081) is automation_blocked: Implementation and validation are blocked by the read-only worker environment; hand the artifact to a writable executor with dependencies....
