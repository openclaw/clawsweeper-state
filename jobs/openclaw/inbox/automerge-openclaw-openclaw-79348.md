...
target_branch: clawsweeper/automerge-openclaw-openclaw-79348
source: pr_automerge
---

# ClawSweeper adopted PR repair candidate

Maintainer opted #79348 into ClawSweeper automerge.

Source PR: https://github.com/openclaw/openclaw/pull/79348
Title: Make exec command highlighting optional

ClawSweeper should use this job only for the bounded ClawSweeper review/fix loop:

- Emit a fix artifact with `repair_strategy: "repair_contributor_branch"` and `source_prs: ["https://github.com/openclaw/openclaw/pull/79348"]` so the Codex edit pass can make this PR merge-ready.
