...
Last source update: Aug 19, 2026, 10:40 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Hot intake publish complete | Aug 19, 2026, 10:40 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32242546153) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 19, 2026, 10:36 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32243377518) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Aug 19, 2026, 04:02 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32214254110) |
...
Last source update: Aug 19, 2026, 10:42 UTC
...
| Run attempts archived | 1551 | audit |
| Latest successful clusters | 448 | 84.4% |
| Latest failed clusters | 81 | 15.3% |
...
- Latest records: 531 clusters: 205 maintainer action, 116 automation snapshot, 183 intervention needed, 27 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#79869](https://github.com/openclaw/openclaw/issues/79869) is maintainer_input: Provide a writable repair checkout/branch and a readable sibling ../codex source checkout (or permit cloning it there) so the required di....
...
| Intervention Needed | 183 | automation failure or blocker recorded |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#79869](https://github.com/openclaw/openclaw/issues/79869) | maintainer_input | Provide a writable repair checkout/branch and a readable sibling ../codex source checkout (or permit cloning it there) so the required direct Codex... | Aug 19, 2026, 10:42 UTC | [issue-openclaw-openclaw-62505](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-62505.md) | [32243274995](https://github.com/openclaw/clawsweeper/actions/runs/32243274995) |
...
| --- | --- | --- | --- | --- |
| issue-openclaw-openclaw-62505 | needs human | Provide a writable repair checkout/branch and a readable sibling ../codex source checkout (or permit cloning it there) so the required direct Codex... | [issue-openclaw-openclaw-62505](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-62505.md) | [32243274995](https://github.com/openclaw/clawsweeper/actions/runs/32243274995) |
