...
Last source update: Aug 23, 2026, 11:06 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Hot intake publish complete | Aug 23, 2026, 11:06 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32634547200) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Aug 23, 2026, 10:55 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32635075566) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Aug 23, 2026, 07:01 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32624434502) |
...
| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 589 | 100% |
| Run attempts archived | 2020 | audit |
| Latest successful clusters | 484 | 82.2% |
| Latest failed clusters | 103 | 17.5% |
| Latest cancelled clusters | 2 | 0.3% |
| Needs-human clusters | 47 | 8.0% |
...
- Latest records: 589 clusters: 218 maintainer action, 115 automation snapshot, 229 intervention needed, 27 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [issue-openclaw-openclaw-128156](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-128156.md) is maintainer_input: Provide a readable sibling `../codex` checkout, or run the artifact in an environment permitted to create it, so the acting executor can....
...
| --- | ---: | --- |
| Maintainer Action | 218 | explicit decision, access, or merge authority recorded |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) |  | maintainer_input | Provide a readable sibling `../codex` checkout, or run the artifact in an environment permitted to create it, so the acting executor can perform th... | Aug 23, 2026, 11:06 UTC | [issue-openclaw-openclaw-128156](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-128156.md) | [32632465014](https://github.com/openclaw/clawsweeper/actions/runs/32632465014) |
...
| --- | --- | --- | --- | --- |
| issue-openclaw-openclaw-128156 | needs human | Provide a readable sibling `../codex` checkout, or run the artifact in an environment permitted to create it, so the acting executor can perform th... | [issue-openclaw-openclaw-128156](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-128156.md) | [32632465014](https://github.com/openclaw/clawsweeper/actions/runs/32632465014) |
