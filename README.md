...
Last source update: Aug 19, 2026, 07:39 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review publish complete | Aug 19, 2026, 07:39 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32227974263) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Aug 19, 2026, 07:35 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32228475969) |
...
| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 530 | 100% |
| Run attempts archived | 1545 | audit |
| Latest successful clusters | 445 | 84.0% |
| Latest failed clusters | 83 | 15.7% |
...
- Latest records: 530 clusters: 204 maintainer action, 116 automation snapshot, 183 intervention needed, 27 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#126231](https://github.com/openclaw/openclaw/pull/126231) is automation_failed: Implementation is blocked: the required ../codex source checkout is absent in this read-only environment, and the baseline test cannot st....
...
| --- | ---: | --- |
| Maintainer Action | 204 | explicit decision, access, or merge authority recorded |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#126231](https://github.com/openclaw/openclaw/pull/126231) | automation_failed | Implementation is blocked: the required ../codex source checkout is absent in this read-only environment, and the baseline test cannot start becaus... | Aug 19, 2026, 07:39 UTC | [issue-openclaw-openclaw-126231](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-126231.md) | [32227107047](https://github.com/openclaw/clawsweeper/actions/runs/32227107047) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [cluster:issue-openclaw-openclaw-126227](cluster:issue-openclaw-openclaw-126227) | automation_failed | Open only after the executor installs dependencies, performs the required direct Codex-source audit, applies the artifact, and passes the listed va... | Aug 19, 2026, 07:34 UTC | [issue-openclaw-openclaw-126227](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-126227.md) | [32227057135](https://github.com/openclaw/clawsweeper/actions/runs/32227057135) |
