...
target_branch: clawsweeper/issue-openclaw-openclaw-121351
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/121351.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 121351
source_issue_revision_sha256: "77775203710f821edcab28269fa242e44584f907c915e07dc931fd0e2c95ab52"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-121351`.

Source issue: https://github.com/openclaw/openclaw/issues/121351
Title: [Bug]: `stripFormattedReasoningMessage` trims substantive answer body whitespace

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/121351.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/121351.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/121351.md
Category: bug
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-121351` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/121351 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/121351 when the implementation satisfies the issue.
