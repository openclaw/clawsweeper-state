...
Last source update: Sep 15, 2026, 10:12 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 15, 2026, 10:12 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34954851855) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 15, 2026, 09:58 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34955265053) |
...
Last source update: Sep 15, 2026, 09:52 UTC
...
| Run attempts archived | 3178 | audit |
| Latest successful clusters | 882 | 84.2% |
| Latest failed clusters | 163 | 15.6% |
...
- Latest records: 1047 clusters: 327 maintainer action, 259 automation snapshot, 417 intervention needed, 44 no pending action, 0 completed.
...
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#148886](https://github.com/openclaw/openclaw/pull/148886) is action_planned: A bounded behavior repair remains warranted. The linked candidate is not validated sufficiently to consider the issue fixed..
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 327 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 259 | repair, check, or planned action recorded; verify live status |
