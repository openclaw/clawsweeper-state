...
Last source update: Aug 6, 2026, 01:35 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Hot intake publish complete | Aug 6, 2026, 01:35 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31059091034) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply finished | Aug 6, 2026, 01:29 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31062776629) |
...
Last source update: Aug 6, 2026, 01:00 UTC
...
| Run attempts archived | 1065 | audit |
| Latest successful clusters | 330 | 84.0% |
| Latest failed clusters | 61 | 15.5% |
| Latest cancelled clusters | 2 | 0.5% |
| Needs-human clusters | 25 | 6.4% |
| Fix actions failed | 19 | 4.3% |
| Fix actions blocked | 78 | 17.8% |
| Completed close actions | 0 | 0.0% |
| Completed merge actions | 0 | 0.0% |
| Blocked mutation attempts | 276 | 99.6% |
...
- Latest records: 393 clusters: 179 maintainer action, 70 automation snapshot, 120 intervention needed, 24 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [issue-openclaw-openclaw-119591](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-119591.md) is automation_failed: Codex /review timed out after 127384ms.
...
| Automation Snapshot | 70 | repair, check, or planned action recorded; verify live status |
...
| [openclaw/crabpot](https://github.com/openclaw/crabpot) | [#283](https://github.com/openclaw/crabpot/pull/283) | automation_failed | Maintainer opted this PR into ClawSweeper automerge/autofix repair; run the direct Codex edit loop after live hydration instead of a separate read-... | Aug 6, 2026, 00:52 UTC | [automerge-openclaw-crabpot-283](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-crabpot-283.md) | [31060666276](https://github.com/openclaw/clawsweeper/actions/runs/31060666276) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) |  | automation_failed | Codex fix worker timed out after 1800000ms | Aug 6, 2026, 00:47 UTC | [issue-openclaw-openclaw-44289](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-44289.md) | [31058696184](https://github.com/openclaw/clawsweeper/actions/runs/31058696184) |
...
| [issue-openclaw-openclaw-44289](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-44289.md) | blocked |  |  | Codex fix worker timed out after 1800000ms | [31058696184](https://github.com/openclaw/clawsweeper/actions/runs/31058696184) |
...
| autofix-only job cannot merge | 18 | [automerge-openclaw-openclaw-119718](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-openclaw-119718.md) |
