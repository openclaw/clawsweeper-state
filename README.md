...
Last source update: Sep 16, 2026, 18:33 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 16, 2026, 18:33 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35131141467) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 16, 2026, 18:27 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35134308981) |
...
Last source update: Sep 16, 2026, 18:05 UTC
...
| Run attempts archived | 3237 | audit |
| Latest successful clusters | 906 | 84.6% |
...
- Latest records: 1071 clusters: 329 maintainer action, 277 automation snapshot, 419 intervention needed, 46 no pending action, 0 completed.
...
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#150142](https://github.com/openclaw/openclaw/pull/150142) is action_planned: The issue owns an ordinary ingestion bug with a bounded repair surface. Executable reproduction must pass the job's prerequisite before i....
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#150142](https://github.com/openclaw/openclaw/pull/150142) | action_planned | The issue owns an ordinary ingestion bug with a bounded repair surface. Executable reproduction must pass the job's prerequisite before implementat... | Sep 16, 2026, 18:05 UTC | [issue-openclaw-openclaw-150142](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-150142.md) | [35128686237](https://github.com/openclaw/clawsweeper/actions/runs/35128686237) |
