...
Last source update: Sep 19, 2026, 20:28 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review in progress | Sep 19, 2026, 20:27 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35467316757) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 19, 2026, 20:28 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35467453648) |
...
Last source update: Sep 19, 2026, 20:13 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1113 | 100% |
| Run attempts archived | 3345 | audit |
| Latest successful clusters | 946 | 85.0% |
...
- Latest records: 1113 clusters: 334 maintainer action, 309 automation snapshot, 422 intervention needed, 48 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#153145](https://github.com/openclaw/openclaw/pull/153145) is automation_failed: Implementation requires a writable executor and disposable macOS runner. Establish the required failing regression before patching or ope....
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#153145](https://github.com/openclaw/openclaw/pull/153145) | automation_failed | Implementation requires a writable executor and disposable macOS runner. Establish the required failing regression before patching or opening the P... | Sep 19, 2026, 20:13 UTC | [issue-openclaw-openclaw-153145](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-153145.md) | [35466358549](https://github.com/openclaw/clawsweeper/actions/runs/35466358549) |
