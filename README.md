...
Last source update: Sep 2, 2026, 10:44 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review comments checked | Sep 2, 2026, 10:43 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33619414985) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 2, 2026, 10:44 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33620884400) |
...
Last source update: Sep 2, 2026, 10:13 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 787 | 100% |
| Run attempts archived | 2557 | audit |
| Latest successful clusters | 656 | 83.4% |
...
- Latest records: 787 clusters: 286 maintainer action, 114 automation snapshot, 352 intervention needed, 35 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#136123](https://github.com/openclaw/openclaw/pull/136123) is automation_blocked: Repair the status owner; do not weaken Doctor’s conservative maintenance gate..
