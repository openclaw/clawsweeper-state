...
Last source update: Sep 26, 2026, 07:39 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Sep 26, 2026, 07:39 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/36227145736) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 26, 2026, 07:34 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/36227109961) |
...
Last source update: Sep 26, 2026, 07:35 UTC
...
| Run attempts archived | 3654 | audit |
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#158710](https://github.com/openclaw/openclaw/pull/158710) is automation_failed: The Codex harness can advertise the authenticated server's tools while omitting the second server's connect tool..
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#158710](https://github.com/openclaw/openclaw/pull/158710) | automation_failed | The Codex harness can advertise the authenticated server's tools while omitting the second server's connect tool. | Sep 26, 2026, 07:30 UTC | [issue-openclaw-openclaw-158710](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-158710.md) | [36225539983](https://github.com/openclaw/clawsweeper/actions/runs/36225539983) |
