...
Last source update: Aug 23, 2026, 19:51 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Hot intake publish complete | Aug 23, 2026, 19:51 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32661618665) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 23, 2026, 19:32 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32661489871) |
...
Last source update: Aug 23, 2026, 19:52 UTC
...
| Run attempts archived | 2058 | audit |
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#125873](https://github.com/openclaw/openclaw/pull/125873) is automation_failed: The source reproduction remains valid, but implementation and mandatory direct Codex-source inspection cannot run in this read-only envir....
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#125873](https://github.com/openclaw/openclaw/pull/125873) | automation_failed | The source reproduction remains valid, but implementation and mandatory direct Codex-source inspection cannot run in this read-only environment. | Aug 23, 2026, 19:52 UTC | [issue-openclaw-openclaw-125873](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-125873.md) | [32661965496](https://github.com/openclaw/clawsweeper/actions/runs/32661965496) |
