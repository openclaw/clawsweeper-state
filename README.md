...
Last source update: Aug 18, 2026, 10:26 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Aug 18, 2026, 10:26 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32125463667) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 18, 2026, 10:18 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32125970261) |
...
Last source update: Aug 18, 2026, 10:16 UTC
...
| Run attempts archived | 1432 | audit |
| Latest successful clusters | 438 | 85.9% |
| Latest failed clusters | 70 | 13.7% |
| Latest cancelled clusters | 2 | 0.4% |
| Needs-human clusters | 34 | 6.7% |
...
- Latest records: 510 clusters: 202 maintainer action, 114 automation snapshot, 167 intervention needed, 27 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#99277](https://github.com/openclaw/openclaw/issues/99277) is maintainer_input: Provide or mount ../codex and rerun the direct Codex-source inspection required by repository policy.; Provide an authorized Mattermost w....
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#125570](https://github.com/openclaw/openclaw/pull/125570) is automation_failed: Implementation and local validation require a writable checkout with dependencies and the mandated ../codex source available..
...
| Intervention Needed | 167 | automation failure or blocker recorded |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#99277](https://github.com/openclaw/openclaw/issues/99277) | maintainer_input | Provide or mount ../codex and rerun the direct Codex-source inspection required by repository policy.; Provide an authorized Mattermost workspace/t... | Aug 18, 2026, 10:16 UTC | [issue-openclaw-openclaw-99277](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-99277.md) | [32125069301](https://github.com/openclaw/clawsweeper/actions/runs/32125069301) |
...
| [openclaw/openclaw](https://github.com/openclaw/openclaw) |  | maintainer_input | Provide a writable checkout with ../codex available so the executor can create the failing configured-owner regression, implement the isolated-read... | Aug 18, 2026, 09:55 UTC | [issue-openclaw-openclaw-125745](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-125745.md) | [32123372146](https://github.com/openclaw/clawsweeper/actions/runs/32123372146) |
...
| --- | --- | --- | --- | --- |
| issue-openclaw-openclaw-99277 | needs human | Provide or mount ../codex and rerun the direct Codex-source inspection required by repository policy.; Provide an authorized Mattermost workspace/t... | [issue-openclaw-openclaw-99277](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-99277.md) | [32125069301](https://github.com/openclaw/clawsweeper/actions/runs/32125069301) |
...
| issue-openclaw-openclaw-125745 | needs human | Provide a writable checkout with ../codex available so the executor can create the failing configured-owner regression, implement the isolated-read... | [issue-openclaw-openclaw-125745](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-125745.md) | [32123372146](https://github.com/openclaw/clawsweeper/actions/runs/32123372146) |
