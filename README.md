...
Last source update: Sep 6, 2026, 15:47 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Sep 6, 2026, 15:47 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34041743199) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 6, 2026, 15:41 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34043049400) |
...
Last source update: Sep 6, 2026, 15:42 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 881 | 100% |
| Run attempts archived | 2743 | audit |
| Latest successful clusters | 722 | 82.0% |
| Latest failed clusters | 157 | 17.8% |
...
- Latest records: 881 clusters: 304 maintainer action, 136 automation snapshot, 404 intervention needed, 37 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [cluster:issue-openclaw-openclaw-140204](cluster:issue-openclaw-openclaw-140204) is automation_failed: Publication is blocked until the executor implements and validates the canonical fix path in a writable checkout and completes the owners....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#140052](https://github.com/openclaw/openclaw/pull/140052) is action_planned: Carry the established heartbeat optional-output contract from its producer into existing terminal classification. Keep the issue open; th....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 304 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 136 | repair, check, or planned action recorded; verify live status |
...
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#140193](https://github.com/openclaw/openclaw/pull/140193) | automation_failed | The source supports a bounded ordinary backup bug. Keep the issue open and complete reproduction and repair through the executor. | Sep 6, 2026, 15:38 UTC | [issue-openclaw-openclaw-140193](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-140193.md) | [34041614726](https://github.com/openclaw/clawsweeper/actions/runs/34041614726) |
