...
Last source update: Sep 21, 2026, 01:51 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review in progress | Sep 21, 2026, 01:51 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35552005387) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 21, 2026, 01:44 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35551871497) |
...
Last source update: Sep 21, 2026, 01:48 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1133 | 100% |
| Run attempts archived | 3383 | audit |
| Latest successful clusters | 962 | 84.9% |
...
- Latest records: 1133 clusters: 339 maintainer action, 320 automation snapshot, 426 intervention needed, 48 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#154227](https://github.com/openclaw/openclaw/pull/154227) is automation_failed: A producer-side isolation repair is supported by source evidence. Runtime reproduction remains unverified, so implementation must begin w....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#154180](https://github.com/openclaw/openclaw/pull/154180) is action_planned: A bounded startup repair is justified. Require an actual failing capture-layout regression before editing, then validate source and packa....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 339 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 320 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#154227](https://github.com/openclaw/openclaw/pull/154227) | automation_failed | A producer-side isolation repair is supported by source evidence. Runtime reproduction remains unverified, so implementation must begin with a fail... | Sep 21, 2026, 01:48 UTC | [issue-openclaw-openclaw-154227](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-154227.md) | [35550000708](https://github.com/openclaw/clawsweeper/actions/runs/35550000708) |
