...
Last source update: Aug 23, 2026, 13:55 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Planning review | Aug 23, 2026, 13:55 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32643585053) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 23, 2026, 13:39 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32642952934) |
...
Last source update: Aug 23, 2026, 13:53 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 590 | 100% |
| Run attempts archived | 2028 | audit |
| Latest successful clusters | 485 | 82.2% |
...
- Latest records: 590 clusters: 218 maintainer action, 115 automation snapshot, 230 intervention needed, 27 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#93696](https://github.com/openclaw/openclaw/issues/93696) is maintainer_input: Quarantined independently; it does not block the ordinary Matrix bug repair path..
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#93696](https://github.com/openclaw/openclaw/issues/93696) | maintainer_input | Quarantined independently; it does not block the ordinary Matrix bug repair path. | Aug 23, 2026, 13:53 UTC | [issue-openclaw-openclaw-81892](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-81892.md) | [32643246993](https://github.com/openclaw/clawsweeper/actions/runs/32643246993) |
