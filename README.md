...
Last source update: Aug 9, 2026, 01:53 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review publish complete | Aug 9, 2026, 01:53 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31289029943) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply finished | Aug 9, 2026, 01:45 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31288858370) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Aug 8, 2026, 23:49 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31284841078) |
...
| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 437 | 100% |
| Run attempts archived | 1213 | audit |
| Latest successful clusters | 372 | 85.1% |
...
- Latest records: 437 clusters: 194 maintainer action, 87 automation snapshot, 132 intervention needed, 24 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#10354](https://github.com/openclaw/openclaw/pull/10354) is automation_failed: Implement the prepared new-fix artifact in a writable executor, then validate before opening or updating clawsweeper/issue-openclaw-openc....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#99277](https://github.com/openclaw/openclaw/pull/99277) is action_planned: The hydrated open canonical issue and current-main source prove a missing bridge to an existing shared acknowledgement contract..
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 194 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 87 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#10354](https://github.com/openclaw/openclaw/pull/10354) | automation_failed | Implement the prepared new-fix artifact in a writable executor, then validate before opening or updating clawsweeper/issue-openclaw-openclaw-10354. | Aug 9, 2026, 01:53 UTC | [issue-openclaw-openclaw-10354](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-10354.md) | [31288906284](https://github.com/openclaw/clawsweeper/actions/runs/31288906284) |
| [openclaw/crabpot](https://github.com/openclaw/crabpot) | [#283](https://github.com/openclaw/crabpot/pull/283) | automation_failed | Maintainer opted this PR into ClawSweeper automerge/autofix repair; run the direct Codex edit loop after live hydration instead of a separate read-... | Aug 9, 2026, 01:21 UTC | [automerge-openclaw-crabpot-283](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-crabpot-283.md) | [31287772832](https://github.com/openclaw/clawsweeper/actions/runs/31287772832) |
