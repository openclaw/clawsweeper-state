...
Last source update: Aug 22, 2026, 05:25 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review comments checked | Aug 22, 2026, 05:25 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32551932002) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 22, 2026, 05:19 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32553974249) |
...
Last source update: Aug 22, 2026, 05:17 UTC
...
| Run attempts archived | 1836 | audit |
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#124689](https://github.com/openclaw/openclaw/pull/124689) is automation_blocked: A writable worker with ../codex available can implement the existing provider-policy contract without a core raw-suffix special case..
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#124689](https://github.com/openclaw/openclaw/pull/124689) | automation_blocked | A writable worker with ../codex available can implement the existing provider-policy contract without a core raw-suffix special case. | Aug 22, 2026, 05:17 UTC | [issue-openclaw-openclaw-124689](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-124689.md) | [32553416673](https://github.com/openclaw/clawsweeper/actions/runs/32553416673) |
