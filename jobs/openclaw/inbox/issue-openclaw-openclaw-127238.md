...
target_branch: clawsweeper/issue-openclaw-openclaw-127238
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/127238.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 127238
source_issue_revision_sha256: "eb35ba969a3464f1d402a7327095b96b052df7d223b52fe615a7a7bc16856b83"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-127238`.

Source issue: https://github.com/openclaw/openclaw/issues/127238
Title: TUI: status spinner freezes on 'processing' after run is aborted (wasActiveRun mismatch)

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/127238.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/127238.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/127238.md
Category: bug
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-127238` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/127238 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/127238 when the implementation satisfies the issue.
