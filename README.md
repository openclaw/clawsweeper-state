...
Last source update: Sep 18, 2026, 17:28 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review in progress | Sep 18, 2026, 17:28 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35373966829) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 18, 2026, 17:28 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35374425799) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Sep 18, 2026, 13:50 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35352486217) |
...
Last source update: Sep 18, 2026, 17:33 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1092 | 100% |
| Run attempts archived | 3300 | audit |
| Latest successful clusters | 924 | 84.6% |
| Latest failed clusters | 166 | 15.2% |
...
- Latest records: 1092 clusters: 331 maintainer action, 293 automation snapshot, 422 intervention needed, 46 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#151953](https://github.com/openclaw/openclaw/pull/151953) is automation_failed: Implementation is blocked by read-only filesystem permissions. The required failing native regression, Apple builds, real iOS flow, and s....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#151883](https://github.com/openclaw/openclaw/pull/151883) is action_planned: A bounded diagnostics fix is supported. Preserve runtime behavior and saved configuration; do not close or merge from this lane..
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 331 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 293 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#151953](https://github.com/openclaw/openclaw/pull/151953) | automation_failed | Implementation is blocked by read-only filesystem permissions. The required failing native regression, Apple builds, real iOS flow, and screenshot... | Sep 18, 2026, 17:33 UTC | [issue-openclaw-openclaw-151953](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-151953.md) | [35369599049](https://github.com/openclaw/clawsweeper/actions/runs/35369599049) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#151986](https://github.com/openclaw/openclaw/pull/151986) | automation_failed | An ordinary UI recovery bug with a narrow existing-owner fix; no security-boundary or product-policy change is needed. | Sep 18, 2026, 17:29 UTC | [issue-openclaw-openclaw-151986](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-151986.md) | [35374111001](https://github.com/openclaw/clawsweeper/actions/runs/35374111001) |
