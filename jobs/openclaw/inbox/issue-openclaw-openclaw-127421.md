...
target_branch: clawsweeper/issue-openclaw-openclaw-127421
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/127421.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 127421
source_issue_revision_sha256: "c90571689bfc1076d6f0fee618d523ae73538920c1532783bc33e0d6bc2cc90a"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-127421`.

Source issue: https://github.com/openclaw/openclaw/issues/127421
Title: [Bug]: Discord Activities shell hangs silently — vendored SDK served from wrong path, and command sync deletes the required Entry Point command

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/127421.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/127421.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/127421.md
Category: bug
...
- extensions/discord/src/activities/register.ts
- extensions/discord/src/activities/register.test.ts
- extensions/discord/src/activities/http.test.ts
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-127421` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/127421 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/127421 when the implementation satisfies the issue.
