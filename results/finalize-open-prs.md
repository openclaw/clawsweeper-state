...
Generated: 2026-08-03T01:57:27.119Z
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| [#118361](https://github.com/openclaw/openclaw/pull/118361) | fix(browser): make extension deep doctor probe page snapshots | issue-openclaw-openclaw-116747 | MERGEABLE | BLOCKED | CANCELLED:10 SKIPPED:44 SUCCESS:70 IN_PROGRESS:2 FAILURE:1; blockers:8 | needs_merge_state:BLOCKED, needs_checks:Real behavior proof:CANCELLED; Real behavior proof:CANCELLED; Real behavior proof:CANCELLED, needs_merge_preflight, needs_result_backfill | repair failing checks or document unrelated main flake with touched-surface proof |
...
| [#118303](https://github.com/openclaw/openclaw/pull/118303) | fix(minimax): route M3 image calls through MiniMax VL | issue-openclaw-openclaw-116601 | MERGEABLE | BLOCKED | CANCELLED:3 SKIPPED:39 SUCCESS:51 IN_PROGRESS:1 FAILURE:2 NEUTRAL:1; blockers:5 | needs_merge_state:BLOCKED, needs_checks:ClawSweeper Dispatch / dispatch:CANCELLED; Real behavior proof:CANCELLED; CI / build-artifacts:IN_PROGRESS, needs_merge_preflight | repair failing checks or document unrelated main flake with touched-surface proof |
