...
Last source update: Aug 8, 2026, 19:56 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Planning review | Aug 8, 2026, 19:56 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31275577754) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply finished | Aug 8, 2026, 19:37 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31274774344) |
...
Last source update: Aug 8, 2026, 19:54 UTC
...
| Run attempts archived | 1195 | audit |
| Latest successful clusters | 370 | 85.1% |
| Latest failed clusters | 63 | 14.5% |
...
- Latest records: 435 clusters: 194 maintainer action, 85 automation snapshot, 132 intervention needed, 24 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [cluster:issue-openclaw-openclaw-99277](cluster:issue-openclaw-openclaw-99277) is automation_failed: Executor should apply the fix artifact on clawsweeper/issue-openclaw-openclaw-99277, validate it, then open the labeled PR..
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [cluster:issue-openclaw-openclaw-99277](cluster:issue-openclaw-openclaw-99277) | automation_failed | Executor should apply the fix artifact on clawsweeper/issue-openclaw-openclaw-99277, validate it, then open the labeled PR. | Aug 8, 2026, 19:54 UTC | [issue-openclaw-openclaw-99277](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-99277.md) | [31275198493](https://github.com/openclaw/clawsweeper/actions/runs/31275198493) |
| [openclaw/crabpot](https://github.com/openclaw/crabpot) | [#283](https://github.com/openclaw/crabpot/pull/283) | automation_failed | Maintainer opted this PR into ClawSweeper automerge/autofix repair; run the direct Codex edit loop after live hydration instead of a separate read-... | Aug 8, 2026, 19:00 UTC | [automerge-openclaw-crabpot-283](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-crabpot-283.md) | [31273033155](https://github.com/openclaw/clawsweeper/actions/runs/31273033155) |
