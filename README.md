...
Last source update: Sep 7, 2026, 05:49 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 7, 2026, 05:49 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34086949997) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 7, 2026, 05:48 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34088143867) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Sep 6, 2026, 20:44 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34058883590) |
...
Last source update: Sep 7, 2026, 05:52 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 894 | 100% |
| Run attempts archived | 2767 | audit |
| Latest successful clusters | 735 | 82.2% |
| Latest failed clusters | 157 | 17.6% |
...
- Latest records: 894 clusters: 304 maintainer action, 146 automation snapshot, 407 intervention needed, 37 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#140879](https://github.com/openclaw/openclaw/pull/140879) is automation_failed: The current sidebar rendering path remains defective and differs from the historical Personal-card fixes. Keep the issue open and impleme....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#140821](https://github.com/openclaw/openclaw/pull/140821) is action_planned: A narrow lifecycle repair is supported. Keep the issue open and prepare one implementation on the designated branch after duplicate disco....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 304 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 146 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#140821](https://github.com/openclaw/openclaw/pull/140821) | action_planned | A narrow lifecycle repair is supported. Keep the issue open and prepare one implementation on the designated branch after duplicate discovery and r... | Sep 7, 2026, 05:37 UTC | [issue-openclaw-openclaw-140821](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-140821.md) | [34087185915](https://github.com/openclaw/clawsweeper/actions/runs/34087185915) |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#140879](https://github.com/openclaw/openclaw/pull/140879) | automation_failed | The current sidebar rendering path remains defective and differs from the historical Personal-card fixes. Keep the issue open and implement the exi... | Sep 7, 2026, 05:52 UTC | [issue-openclaw-openclaw-140879](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-140879.md) | [34087994361](https://github.com/openclaw/clawsweeper/actions/runs/34087994361) |
