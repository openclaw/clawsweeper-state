...
cluster_id: issue-steipete-codexbar-2200
mode: autonomous
...
target_branch: clawsweeper/issue-steipete-codexbar-2200
source: issue_implementation
trigger_source: review_viable_issue
clawsweeper_report_path: records/steipete-codexbar/items/2200.md
source_issue_repo: "steipete/codexbar"
source_issue_number: 2200
source_issue_revision_sha256: "8d4490e814b59b1f9680c5f9e13216b939ca4cdf0c2068c37360bfde64170589"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-steipete-codexbar-2200`.

Source issue: https://github.com/steipete/codexbar/issues/2200
Title: Tracking: latent data races surfaced under ThreadSanitizer + parallel Swift Testing

## Maintainer Context

- Trigger source: review_viable_issue
- ClawSweeper review report: records/steipete-codexbar/items/2200.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/steipete-codexbar/items/2200.md
- Maintainer instruction: ClawSweeper finished reviewing this open issue and found no active implementation PR.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/steipete-codexbar/items/2200.md
...
- Keep one PR for this issue; reuse `clawsweeper/issue-steipete-codexbar-2200` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/steipete/codexbar/issues/2200 in the PR body.
- Use a closing reference for https://github.com/steipete/codexbar/issues/2200 when the implementation satisfies the issue.
