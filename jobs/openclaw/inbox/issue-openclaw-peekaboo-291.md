...
cluster_id: issue-openclaw-peekaboo-291
mode: autonomous
...
target_branch: clawsweeper/issue-openclaw-peekaboo-291
source: issue_implementation
trigger_source: review_viable_issue
clawsweeper_report_path: records/openclaw-peekaboo/items/291.md
source_issue_repo: "openclaw/peekaboo"
source_issue_number: 291
source_issue_revision_sha256: "c9056f425c7b62ce9604009e1031fc2e80f54b32c13a541f6b466b15dc572221"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-peekaboo-291`.

Source issue: https://github.com/openclaw/peekaboo/issues/291
Title: 3.9.6 fails to launch on macOS 15: missing @rpath/libswiftCompatibilitySpan.dylib

## Maintainer Context

- Trigger source: review_viable_issue
- ClawSweeper review report: records/openclaw-peekaboo/items/291.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-peekaboo/items/291.md
- Maintainer instruction: ClawSweeper finished reviewing this open issue and found no active implementation PR.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-peekaboo/items/291.md
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-peekaboo-291` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/peekaboo/issues/291 in the PR body.
- Use a closing reference for https://github.com/openclaw/peekaboo/issues/291 when the implementation satisfies the issue.
