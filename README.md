...
Last source update: Sep 17, 2026, 19:14 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 17, 2026, 19:14 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35261434565) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 17, 2026, 18:58 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35261873152) |
...
Last source update: Sep 17, 2026, 19:02 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1083 | 100% |
| Run attempts archived | 3272 | audit |
| Latest successful clusters | 916 | 84.6% |
...
- Latest records: 1083 clusters: 329 maintainer action, 287 automation snapshot, 421 intervention needed, 46 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#151055](https://github.com/openclaw/openclaw/pull/151055) is automation_failed: Implementation requires a writable executor with dependencies. First demonstrate the failing regression on current main; do not publish a....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#151006](https://github.com/openclaw/openclaw/pull/151006) is action_planned: The existing formatter can own this bounded bug fix without configuration, storage, or policy changes. Reproduce on refreshed main before....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 329 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 287 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#151055](https://github.com/openclaw/openclaw/pull/151055) | automation_failed | Implementation requires a writable executor with dependencies. First demonstrate the failing regression on current main; do not publish a PR if rep... | Sep 17, 2026, 19:02 UTC | [issue-openclaw-openclaw-151055](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-151055.md) | [35259879896](https://github.com/openclaw/clawsweeper/actions/runs/35259879896) |
