...
cluster_id: issue-steipete-codexbar-2369
mode: autonomous
...
target_branch: clawsweeper/issue-steipete-codexbar-2369
source: issue_implementation
trigger_source: review_viable_issue
clawsweeper_report_path: records/steipete-codexbar/items/2369.md
source_issue_repo: "steipete/codexbar"
source_issue_number: 2369
source_issue_revision_sha256: "b1f6f1be0911195a17549939cde78ddc531ddf420000824e01e02f8794e46ab3"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-steipete-codexbar-2369`.

Source issue: https://github.com/steipete/codexbar/issues/2369
...
- ClawSweeper review report: records/steipete-codexbar/items/2369.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/steipete-codexbar/items/2369.md
- Maintainer instruction: ClawSweeper finished reviewing this open issue and found no active implementation PR.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/steipete-codexbar/items/2369.md
...
- Keep one PR for this issue; reuse `clawsweeper/issue-steipete-codexbar-2369` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/steipete/codexbar/issues/2369 in the PR body.
- Use a closing reference for https://github.com/steipete/codexbar/issues/2369 when the implementation satisfies the issue.
