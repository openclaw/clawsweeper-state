...
target_branch: clawsweeper/automerge-openclaw-openclaw-129784
source: pr_automerge
...
- Emit a fix artifact with `repair_strategy: "repair_contributor_branch"` and `source_prs: ["https://github.com/openclaw/openclaw/pull/129784"]` so the Codex edit pass can make this PR merge-ready.
