...
Last source update: Sep 21, 2026, 06:50 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 21, 2026, 06:50 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35569933667) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 21, 2026, 06:48 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35569960749) |
...
Last source update: Sep 21, 2026, 06:41 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1136 | 100% |
| Run attempts archived | 3392 | audit |
| Latest successful clusters | 965 | 84.9% |
...
- Latest records: 1136 clusters: 339 maintainer action, 323 automation snapshot, 426 intervention needed, 48 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#138929](https://github.com/openclaw/openclaw/pull/138929) is automation_failed: The non-mutating classification is clear. A writable executor must establish the failing production-boundary regression before implementa....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#154446](https://github.com/openclaw/openclaw/pull/154446) is action_planned: A focused repair is warranted, conditional on reproducing the geometry failure on current main before changing production CSS. No closure....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 339 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 323 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#138929](https://github.com/openclaw/openclaw/pull/138929) | automation_failed | The non-mutating classification is clear. A writable executor must establish the failing production-boundary regression before implementation; no m... | Sep 21, 2026, 06:41 UTC | [issue-openclaw-openclaw-138929](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-138929.md) | [35565959046](https://github.com/openclaw/clawsweeper/actions/runs/35565959046) |
