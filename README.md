...
Last source update: Aug 22, 2026, 17:52 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Planning review | Aug 22, 2026, 17:52 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32588848818) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 22, 2026, 17:45 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32588641454) |
...
Last source update: Aug 22, 2026, 17:48 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 579 | 100% |
| Run attempts archived | 1929 | audit |
| Latest successful clusters | 477 | 82.4% |
...
- Latest records: 579 clusters: 214 maintainer action, 115 automation snapshot, 223 intervention needed, 27 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#81269](https://github.com/openclaw/openclaw/pull/81269) is automation_blocked: Repair is clear, but this worker cannot modify or validate the target checkout under the filesystem restriction and cannot complete the r....
...
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#124689](https://github.com/openclaw/openclaw/pull/124689) | automation_blocked | The issue remains a narrow canonical bug, but the required direct Codex-source inspection and local test dependencies are unavailable. | Aug 22, 2026, 17:42 UTC | [issue-openclaw-openclaw-124689](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-124689.md) | [32588060829](https://github.com/openclaw/clawsweeper/actions/runs/32588060829) |
