...
Last source update: Aug 23, 2026, 11:25 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Aug 23, 2026, 11:25 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32635242764) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 23, 2026, 11:15 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32635987367) |
...
Last source update: Aug 23, 2026, 11:18 UTC
...
| Run attempts archived | 2022 | audit |
...
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [issue-openclaw-openclaw-128005](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-128005.md) is maintainer_input: Provide a writable repair environment with the required sibling ../codex checkout (or permission to clone it) so the capture-boundary reg....
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#128156](https://github.com/openclaw/openclaw/pull/128156) is automation_blocked: A writable runner must implement and validate the repair before a PR can be opened..
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) |  | maintainer_input | Provide a writable repair environment with the required sibling ../codex checkout (or permission to clone it) so the capture-boundary regression ca... | Aug 23, 2026, 11:18 UTC | [issue-openclaw-openclaw-128005](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-128005.md) | [32635657663](https://github.com/openclaw/clawsweeper/actions/runs/32635657663) |
...
| --- | --- | --- | --- | --- |
| issue-openclaw-openclaw-128005 | needs human | Provide a writable repair environment with the required sibling ../codex checkout (or permission to clone it) so the capture-boundary regression ca... | [issue-openclaw-openclaw-128005](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-128005.md) | [32635657663](https://github.com/openclaw/clawsweeper/actions/runs/32635657663) |
