...
Last source update: Sep 16, 2026, 08:50 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review in progress | Sep 16, 2026, 08:48 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35075547319) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 16, 2026, 08:50 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35075789509) |
...
Last source update: Sep 16, 2026, 08:47 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1060 | 100% |
| Run attempts archived | 3210 | audit |
| Latest successful clusters | 895 | 84.4% |
| Latest failed clusters | 163 | 15.4% |
| Latest cancelled clusters | 2 | 0.2% |
| Needs-human clusters | 123 | 11.6% |
| Fix actions failed | 35 | 4.7% |
| Fix actions blocked | 156 | 21.1% |
...
- Latest records: 1060 clusters: 328 maintainer action, 267 automation snapshot, 419 intervention needed, 46 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [cluster:issue-openclaw-openclaw-149867](cluster:issue-openclaw-openclaw-149867) is automation_failed: The executor must reproduce, implement, review, and validate the fix in a writable isolated checkout before opening or updating the singl....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#149672](https://github.com/openclaw/openclaw/pull/149672) is action_planned: A bounded bug-fix path exists. Keep the issue open while the executor reproduces, repairs, and validates the complete user flow..
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 328 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 267 | repair, check, or planned action recorded; verify live status |
...
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#148680](https://github.com/openclaw/openclaw/pull/148680) | action_planned | The supplied evidence supports a focused existing-behavior repair. Establish a failing real-transcript regression before implementation, then valid... | Sep 15, 2026, 02:07 UTC | [issue-openclaw-openclaw-148680](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-148680.md) | [34919777115](https://github.com/openclaw/clawsweeper/actions/runs/34919777115) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#148584](https://github.com/openclaw/openclaw/pull/148584) | action_planned | The reported failure has a bounded repair in the existing startup ownership path. Proceed only after reproducing it on the executor's current main;... | Sep 15, 2026, 01:11 UTC | [issue-openclaw-openclaw-148584](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-148584.md) | [34915988154](https://github.com/openclaw/clawsweeper/actions/runs/34915988154) |

#### Intervention Needed

| Repository | Item | Lane state | Recorded blocker | Updated | Cluster | Run |
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [cluster:issue-openclaw-openclaw-149867](cluster:issue-openclaw-openclaw-149867) | automation_failed | The executor must reproduce, implement, review, and validate the fix in a writable isolated checkout before opening or updating the single designat... | Sep 16, 2026, 08:47 UTC | [issue-openclaw-openclaw-149867](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-149867.md) | [35072193750](https://github.com/openclaw/clawsweeper/actions/runs/35072193750) |
