...
Last source update: Aug 25, 2026, 08:43 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Aug 25, 2026, 08:43 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32826065366) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 25, 2026, 08:43 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32827932777) |
...
Last source update: Aug 25, 2026, 08:47 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 616 | 100% |
| Run attempts archived | 2128 | audit |
| Latest successful clusters | 514 | 83.4% |
| Latest failed clusters | 100 | 16.2% |
| Latest cancelled clusters | 2 | 0.3% |
| Needs-human clusters | 56 | 9.1% |
| Fix actions failed | 26 | 4.4% |
| Fix actions blocked | 116 | 19.7% |
...
- Latest records: 616 clusters: 227 maintainer action, 114 automation snapshot, 247 intervention needed, 28 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [issue-openclaw-openclaw-129118](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-129118.md) is automation_blocked: validation command failed (pnpm check:changed): $ node scripts/check-changed.mjs [check:changed] lanes=coreTests, ui [check:changed] ui/s....
...
| Intervention Needed | 247 | automation failure or blocker recorded |
