...
Last source update: Sep 4, 2026, 01:01 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Planning review | Sep 4, 2026, 00:17 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33819839934) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 4, 2026, 01:01 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33824072707) |
...
Last source update: Sep 4, 2026, 01:18 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 803 | 100% |
| Run attempts archived | 2582 | audit |
| Latest successful clusters | 662 | 82.4% |
| Latest failed clusters | 139 | 17.3% |
...
- Latest records: 803 clusters: 287 maintainer action, 115 automation snapshot, 366 intervention needed, 35 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [cluster:issue-openclaw-openclaw-137690](cluster:issue-openclaw-openclaw-137690) is automation_failed: Create one narrow credited fix PR from clawsweeper/issue-openclaw-openclaw-137690..
