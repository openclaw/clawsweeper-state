...
target_branch: clawsweeper/issue-openclaw-openclaw-158944
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/158944.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 158944
source_issue_revision_sha256: "007cf245a74b7faf442d0a8fde95f7b3a18221ca8f866c5e2ff9978d5990e1b2"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-158944`.

Source issue: https://github.com/openclaw/openclaw/issues/158944
Title: [Bug]: Expired (and cancelled) plugin approvals render as "Denied" in native channel approval cards

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/158944.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/158944.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/158944.md
Category: bug
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-158944` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/158944 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/158944 when the implementation satisfies the issue.
