...
Last source update: Sep 17, 2026, 10:09 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 17, 2026, 10:09 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35207377318) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 17, 2026, 09:57 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35207759522) |
...
Last source update: Sep 17, 2026, 10:01 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1077 | 100% |
| Run attempts archived | 3260 | audit |
| Latest successful clusters | 910 | 84.5% |
...
- Latest records: 1077 clusters: 329 maintainer action, 281 automation snapshot, 421 intervention needed, 46 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#150766](https://github.com/openclaw/openclaw/pull/150766) is automation_failed: Confirmed ordinary platform-admission bug with a narrow existing-owner repair; retain the issue pending implementation..
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#150601](https://github.com/openclaw/openclaw/pull/150601) is action_planned: The job provides a focused bug-fix path. Preserve this issue as canonical and require current-main reproduction before implementing or pu....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 329 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 281 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#150766](https://github.com/openclaw/openclaw/pull/150766) | automation_failed | Confirmed ordinary platform-admission bug with a narrow existing-owner repair; retain the issue pending implementation. | Sep 17, 2026, 10:01 UTC | [issue-openclaw-openclaw-150766](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-150766.md) | [35205003661](https://github.com/openclaw/clawsweeper/actions/runs/35205003661) |
