...
target_branch: clawsweeper/issue-openclaw-openclaw-39461
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/39461.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 39461
source_issue_revision_sha256: "3a788616e3050160e52e5beeaeaf0999973a340adacd8b19edac1afb853ca9a0"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-39461`.

Source issue: https://github.com/openclaw/openclaw/issues/39461
Title: [Bug]：路径错误

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/39461.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/39461.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/39461.md
Category: bug
...
Repair QQBot startup diagnostics so they no longer create or report the retired data root or recommend unsupported `QQBOT_DATA_DIR`. Preserve the canonical SQLite plugin-state and `OPENCLAW_HOME` media contracts; do not add `QQBOT_DATA_DIR`, a config/env surface, runtime legacy fallbacks, or broaden legacy artifact handling. Keep bot-log export and opt-in command-file upload compatibility roots scoped. Add regression coverage for truthful startup diagnostics. No changelog edit.
...
- node scripts/run-vitest.mjs extensions/qqbot/src/engine/utils/platform-storage-laziness.test.ts
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-39461` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/39461 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/39461 when the implementation satisfies the issue.
