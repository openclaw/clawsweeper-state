...
Last source update: Aug 29, 2026, 16:26 UTC
...
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Aug 29, 2026, 16:26 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33262972829) |
...
Last source update: Aug 29, 2026, 16:16 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 691 | 100% |
| Run attempts archived | 2346 | audit |
| Latest successful clusters | 576 | 83.4% |
| Latest failed clusters | 113 | 16.4% |
...
- Latest records: 691 clusters: 241 maintainer action, 113 automation snapshot, 307 intervention needed, 30 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#119737](https://github.com/openclaw/openclaw/pull/119737) is automation_failed: Maintainer opted this PR into ClawSweeper automerge/autofix repair; run the direct Codex edit loop after live hydration instead of a sepa....
