...
Last source update: Sep 15, 2026, 13:57 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 15, 2026, 13:55 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34974349322) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 15, 2026, 13:57 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34978206676) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Sep 15, 2026, 12:53 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34971478344) |
...
Last source update: Sep 15, 2026, 14:07 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1051 | 100% |
| Run attempts archived | 3187 | audit |
| Latest successful clusters | 886 | 84.3% |
...
- Latest records: 1051 clusters: 328 maintainer action, 261 automation snapshot, 418 intervention needed, 44 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [cluster:issue-openclaw-openclaw-149101](cluster:issue-openclaw-openclaw-149101) is automation_failed: Implementation and publication are blocked on a writable executor completing reproduction, repair, validation, review, and duplicate-PR r....
...
| No Pending Action | 44 | latest record proposes no repair or apply action |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [cluster:issue-openclaw-openclaw-149101](cluster:issue-openclaw-openclaw-149101) | automation_failed | Implementation and publication are blocked on a writable executor completing reproduction, repair, validation, review, and duplicate-PR reconciliat... | Sep 15, 2026, 14:07 UTC | [issue-openclaw-openclaw-149101](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-149101.md) | [34972596303](https://github.com/openclaw/clawsweeper/actions/runs/34972596303) |
