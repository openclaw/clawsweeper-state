...
Last source update: Sep 3, 2026, 10:14 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 3, 2026, 10:14 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33740281554) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 3, 2026, 09:57 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33741528367) |
...
Last source update: Sep 3, 2026, 10:10 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 799 | 100% |
| Run attempts archived | 2572 | audit |
| Latest successful clusters | 660 | 82.6% |
...
- Latest records: 799 clusters: 287 maintainer action, 114 automation snapshot, 363 intervention needed, 35 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#137216](https://github.com/openclaw/openclaw/pull/137216) is automation_failed: Use a writable, dependency-ready checkout, inspect the required ../codex runtime/protocol source, then add the regression, prove it fails....
