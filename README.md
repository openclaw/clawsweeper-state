...
Last source update: Sep 8, 2026, 14:41 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 8, 2026, 14:41 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34234920571) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 8, 2026, 14:32 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34238805886) |
...
Last source update: Sep 8, 2026, 14:43 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 924 | 100% |
| Run attempts archived | 2834 | audit |
| Latest successful clusters | 765 | 82.8% |
| Latest failed clusters | 157 | 17.0% |
...
- Latest records: 924 clusters: 309 maintainer action, 169 automation snapshot, 409 intervention needed, 37 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#142208](https://github.com/openclaw/openclaw/pull/142208) is automation_failed: Only local implementation and validation are blocked. A writable executor must establish the failing CLI regression before applying the w....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#142107](https://github.com/openclaw/openclaw/pull/142107) is action_planned: A focused producer repair is supported. Reproduce through the real processing and buffering owners before editing, and recheck contributo....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 309 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 169 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#142208](https://github.com/openclaw/openclaw/pull/142208) | automation_failed | Only local implementation and validation are blocked. A writable executor must establish the failing CLI regression before applying the wording rep... | Sep 8, 2026, 14:43 UTC | [issue-openclaw-openclaw-142208](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-142208.md) | [34236387127](https://github.com/openclaw/clawsweeper/actions/runs/34236387127) |
