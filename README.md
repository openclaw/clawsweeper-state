...
Last source update: Sep 18, 2026, 15:09 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review in progress | Sep 18, 2026, 15:09 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35360252258) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 18, 2026, 14:57 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35359270268) |
...
Last source update: Sep 18, 2026, 15:11 UTC
...
| Run attempts archived | 3294 | audit |
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [cluster:issue-openclaw-openclaw-151792](cluster:issue-openclaw-openclaw-151792) is automation_failed: A writable executor with dependencies and GitHub access must reproduce on refreshed main, implement and review the fix, complete required....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#151789](https://github.com/openclaw/openclaw/pull/151789) is action_planned: A focused ordinary bug fix is supported. Neither hydrated PR supplies this repair. Establish a failing lifecycle regression before produc....
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [cluster:issue-openclaw-openclaw-151792](cluster:issue-openclaw-openclaw-151792) | automation_failed | A writable executor with dependencies and GitHub access must reproduce on refreshed main, implement and review the fix, complete required checks, a... | Sep 18, 2026, 15:11 UTC | [issue-openclaw-openclaw-151792](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-151792.md) | [35357058720](https://github.com/openclaw/clawsweeper/actions/runs/35357058720) |
