...
target_branch: clawsweeper/issue-openclaw-openclaw-117669
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/117669.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 117669
source_issue_revision_sha256: "65db3e5995572551c8cc678d622519bcdbbe9c237e8eab2d51bc09ad54882bee"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-117669`.

Source issue: https://github.com/openclaw/openclaw/issues/117669
Title: Dreaming recall store stays empty — RAW_TRANSCRIPT_TURN_RE blocks all session transcript ingestion

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/117669.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/117669.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/117669.md
Category: bug
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-117669` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/117669 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/117669 when the implementation satisfies the issue.
