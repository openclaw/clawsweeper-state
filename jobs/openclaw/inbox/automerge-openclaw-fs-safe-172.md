...
target_branch: clawsweeper/automerge-openclaw-fs-safe-172
source: pr_automerge
...
Title: fix(temp): pin sibling temp publication

ClawSweeper should use this job only for the bounded ClawSweeper review/fix loop:

- Emit a fix artifact with `repair_strategy: "repair_contributor_branch"` and `source_prs: ["https://github.com/openclaw/fs-safe/pull/172"]` so the Codex edit pass can make this PR merge-ready.
