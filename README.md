...
Last source update: Aug 9, 2026, 10:22 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Planning review | Aug 9, 2026, 10:22 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31308115518) |
...
Last source update: Aug 9, 2026, 10:13 UTC
...
| Run attempts archived | 1237 | audit |
| Latest successful clusters | 379 | 85.6% |
| Latest failed clusters | 62 | 14.0% |
...
- Latest records: 443 clusters: 193 maintainer action, 94 automation snapshot, 132 intervention needed, 24 no pending action, 0 completed.
...
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#52130](https://github.com/openclaw/openclaw/pull/52130) is action_planned: A narrow fix path is clear and allowed; no viable open contributor PR exists..
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#52130](https://github.com/openclaw/openclaw/pull/52130) | action_planned | A narrow fix path is clear and allowed; no viable open contributor PR exists. | Aug 9, 2026, 10:13 UTC | [issue-openclaw-openclaw-52130](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-52130.md) | [31307459262](https://github.com/openclaw/clawsweeper/actions/runs/31307459262) |
