...
Last source update: Sep 7, 2026, 17:47 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Sep 7, 2026, 17:47 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34145084258) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 7, 2026, 17:42 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34148598549) |
...
Last source update: Sep 7, 2026, 17:41 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 909 | 100% |
| Run attempts archived | 2804 | audit |
| Latest successful clusters | 750 | 82.5% |
...
- Latest records: 909 clusters: 307 maintainer action, 157 automation snapshot, 408 intervention needed, 37 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#92655](https://github.com/openclaw/openclaw/issues/92655) is maintainer_input: Route this authorization-sensitive item to central OpenClaw security handling without mutation. It does not block the unrelated inventory....
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#141382](https://github.com/openclaw/openclaw/pull/141382) is automation_failed: Existing Windows CLI behavior needs a launch-contract repair. No new configuration, plugin API, or authorization change is indicated. Kee....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#141279](https://github.com/openclaw/openclaw/pull/141279) is action_planned: A bounded existing-behavior repair is supported. Execute only after checking for existing contributor work and establishing the required....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 307 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 157 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#141382](https://github.com/openclaw/openclaw/pull/141382) | automation_failed | Existing Windows CLI behavior needs a launch-contract repair. No new configuration, plugin API, or authorization change is indicated. Keep the issu... | Sep 7, 2026, 17:41 UTC | [issue-openclaw-openclaw-141382](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-141382.md) | [34147575754](https://github.com/openclaw/clawsweeper/actions/runs/34147575754) |
