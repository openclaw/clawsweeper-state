...
mode: "autonomous"
run_id: "32822909844"
run_url: "https://github.com/openclaw/clawsweeper/actions/runs/32822909844"
head_sha: "56591f8ebaf3e958cf659786adeb69dd2d095046"
workflow_conclusion: "success"
result_status: "blocked"
published_at: "2026-08-25T08:54:47.217Z"
canonical: "https://github.com/openclaw/openclaw/issues/129116"
canonical_issue: "https://github.com/openclaw/openclaw/issues/129116"
canonical_pr: null
actions_total: 5
fix_executed: 0
fix_failed: 0
...
# issue-openclaw-openclaw-129116

Repo: openclaw/openclaw

Run: [https://github.com/openclaw/clawsweeper/actions/runs/32822909844](https://github.com/openclaw/clawsweeper/actions/runs/32822909844)
...
#129116 is a real current-main cache-miss bug. A narrow, credited fix PR is planned; this worker could not edit or validate it because the checkout is read-only and pnpm fails creating Corepack's cache.
...
| Target | Action | Status | Classification | Reason |
| --- | --- | --- | --- | --- |
| #129116 | fix_needed | planned | canonical | Replace the unreachable object-identity entry cache with a bounded cache keyed by the exact trimmed summary string, retaining the existing WeakMap keyed by schema object. |
| cluster:issue-openclaw-openclaw-129116 | build_fix_artifact | planned | canonical | Artifact is narrow and executable in a writable repair checkout; this worker cannot create the branch or establish the required failing-regression proof. |
| cluster:issue-openclaw-openclaw-129116 | open_fix_pr | blocked | canonical | Blocked only by the current execution environment; the deterministic applicator may open the PR after completing the artifact validation. |
| #73440 | keep_closed | skipped | related | Historical related cache work only; already closed and outside this repair. |
| #87172 | keep_closed | skipped | related | Historical adjacent optimization only; already closed. |
