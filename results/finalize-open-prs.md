...
Generated: 2026-08-03T00:27:00.310Z
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| [#118325](https://github.com/openclaw/openclaw/pull/118325) | fix(memory-core): ingest transcript turns into short-term recall | issue-openclaw-openclaw-117669 | MERGEABLE | BEHIND | CANCELLED:14 QUEUED:2 SKIPPED:44 SUCCESS:48 IN_PROGRESS:1; blockers:9 | needs_merge_state:BEHIND, needs_checks:Real behavior proof:CANCELLED; Real behavior proof:CANCELLED; Real behavior proof:CANCELLED, needs_merge_preflight, needs_result_backfill | repair failing checks or document unrelated main flake with touched-surface proof |
...
| [#118309](https://github.com/openclaw/openclaw/pull/118309) | fix(claude-cli): deduplicate live and imported assistant turns | issue-openclaw-openclaw-118185 | MERGEABLE | BEHIND | CANCELLED:14 SKIPPED:49 SUCCESS:84 NEUTRAL:1; blockers:8 | needs_merge_state:BEHIND, needs_checks:Real behavior proof:CANCELLED; Real behavior proof:CANCELLED; Real behavior proof:CANCELLED, needs_merge_preflight, needs_result_backfill | repair failing checks or document unrelated main flake with touched-surface proof |
...
| [#117951](https://github.com/openclaw/openclaw/pull/117951) | fix(gateway): preserve assistant media in live chat events | issue-openclaw-openclaw-73478 | MERGEABLE | BEHIND | CANCELLED:2 SKIPPED:41 SUCCESS:82 NEUTRAL:1; blockers:1 | needs_merge_state:BEHIND, needs_checks:Real behavior proof:CANCELLED, needs_merge_preflight | repair failing checks or document unrelated main flake with touched-surface proof |
...
| [#117485](https://github.com/openclaw/openclaw/pull/117485) | fix(ios): route forced realtime consults through Gateway relay | issue-openclaw-openclaw-110171 | MERGEABLE | BEHIND | SUCCESS:23 SKIPPED:24 IN_PROGRESS:2; blockers:2 | needs_merge_state:BEHIND, needs_checks:CI / macos-swift:IN_PROGRESS; CI / ios-build:IN_PROGRESS, needs_merge_preflight | repair failing checks or document unrelated main flake with touched-surface proof |
