...
Last source update: Sep 5, 2026, 10:32 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review publish complete | Sep 5, 2026, 10:32 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33959752139) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 5, 2026, 10:28 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33960702049) |
...
Last source update: Sep 5, 2026, 10:28 UTC
...
| Run attempts archived | 2676 | audit |
| Latest successful clusters | 704 | 82.4% |
...
- Latest records: 854 clusters: 302 maintainer action, 124 automation snapshot, 393 intervention needed, 35 no pending action, 0 completed.
...
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#42986](https://github.com/openclaw/openclaw/pull/42986) is action_planned: Keep the issue open and prepare the bounded repair below. Implementation must first demonstrate a failing regression on refreshed main. C....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 302 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 124 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#42986](https://github.com/openclaw/openclaw/pull/42986) | action_planned | Keep the issue open and prepare the bounded repair below. Implementation must first demonstrate a failing regression on refreshed main. Closure and... | Sep 5, 2026, 10:28 UTC | [issue-openclaw-openclaw-42986](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-42986.md) | [33959210910](https://github.com/openclaw/clawsweeper/actions/runs/33959210910) |
