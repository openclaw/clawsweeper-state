...
Generated: 2026-08-03T10:50:43.188Z
...
| [#118303](https://github.com/openclaw/openclaw/pull/118303) | fix(minimax): route M3 image calls through MiniMax VL | issue-openclaw-openclaw-116601 | MERGEABLE | BEHIND | CANCELLED:1 SUCCESS:68 SKIPPED:37 IN_PROGRESS:8 NEUTRAL:1; blockers:9 | needs_merge_state:BEHIND, needs_checks:ClawSweeper Dispatch / dispatch:CANCELLED; CI / checks-node-compact-large-1:IN_PROGRESS; CI / checks-node-compact-large-5:IN_PROGRESS, needs_merge_preflight | repair failing checks or document unrelated main flake with touched-surface proof |
