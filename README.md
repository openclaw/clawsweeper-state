...
Last source update: Aug 18, 2026, 08:47 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Aug 18, 2026, 08:47 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32115161893) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Aug 18, 2026, 08:34 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32117055715) |
...
Last source update: Aug 18, 2026, 08:48 UTC
...
| Run attempts archived | 1421 | audit |
| Latest successful clusters | 437 | 85.9% |
| Latest failed clusters | 70 | 13.8% |
...
- Latest records: 509 clusters: 199 maintainer action, 115 automation snapshot, 168 intervention needed, 27 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#119041](https://github.com/openclaw/openclaw/pull/119041) is automation_failed: Implementation is blocked only by the read-only checkout and unmet required direct ../codex inspection gate; no maintainer product decisi....
...
| Intervention Needed | 168 | automation failure or blocker recorded |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#119041](https://github.com/openclaw/openclaw/pull/119041) | automation_failed | Implementation is blocked only by the read-only checkout and unmet required direct ../codex inspection gate; no maintainer product decision is needed. | Aug 18, 2026, 08:48 UTC | [issue-openclaw-openclaw-119041](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-119041.md) | [32116984476](https://github.com/openclaw/clawsweeper/actions/runs/32116984476) |
