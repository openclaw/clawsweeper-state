...
Last source update: Aug 19, 2026, 21:53 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Hot intake publish complete | Aug 19, 2026, 21:53 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32305116132) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 19, 2026, 21:47 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32305577055) |
...
Last source update: Aug 19, 2026, 20:30 UTC
...
| Run attempts archived | 1590 | audit |
| Latest successful clusters | 453 | 84.2% |
...
- Latest records: 538 clusters: 206 maintainer action, 116 automation snapshot, 189 intervention needed, 27 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#126400](https://github.com/openclaw/openclaw/pull/126400) is automation_blocked: Produce the narrow fix on the designated branch after restoring a writable checkout, dependencies, and the required Codex source gate..
...
| Intervention Needed | 189 | automation failure or blocker recorded |
...
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#124015](https://github.com/openclaw/openclaw/pull/124015) | automation_failed | Maintainer opted this PR into ClawSweeper automerge/autofix repair; run the direct Codex edit loop after live hydration instead of a separate read-... | Aug 19, 2026, 01:16 UTC | [automerge-openclaw-openclaw-124015](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-openclaw-124015.md) | [32203214897](https://github.com/openclaw/clawsweeper/actions/runs/32203214897) |
