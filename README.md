...
Last source update: Sep 6, 2026, 05:27 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Planning review | Sep 6, 2026, 05:27 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34013966132) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 6, 2026, 05:21 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34013694785) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Sep 6, 2026, 01:15 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34003404611) |
...
Last source update: Sep 6, 2026, 04:55 UTC
...
| Run attempts archived | 2724 | audit |
| Latest successful clusters | 715 | 81.9% |
...
- Latest records: 873 clusters: 304 maintainer action, 131 automation snapshot, 401 intervention needed, 37 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#130432](https://github.com/openclaw/openclaw/pull/130432) is automation_failed: Canonical bug classification is supported; implementation remains blocked until a writable executor establishes the failing production bo....
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#130432](https://github.com/openclaw/openclaw/pull/130432) | automation_failed | Canonical bug classification is supported; implementation remains blocked until a writable executor establishes the failing production boundary and... | Sep 6, 2026, 04:55 UTC | [issue-openclaw-openclaw-130432](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-130432.md) | [34012426664](https://github.com/openclaw/clawsweeper/actions/runs/34012426664) |
