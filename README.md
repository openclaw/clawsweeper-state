...
Last source update: Aug 9, 2026, 10:46 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Aug 9, 2026, 10:46 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31308738517) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 9, 2026, 10:36 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31308710025) |
...
Last source update: Aug 9, 2026, 10:48 UTC
...
| Run attempts archived | 1238 | audit |
| Latest successful clusters | 378 | 85.3% |
...
- Latest records: 443 clusters: 193 maintainer action, 93 automation snapshot, 133 intervention needed, 24 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#52130](https://github.com/openclaw/openclaw/pull/52130) is automation_failed: A narrow documentation, Settings-help, and Doctor-regression repair is allowed without reintroducing runtime coercion or a new configurat....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#120968](https://github.com/openclaw/openclaw/issues/120968) is action_planned: Narrow owner-plugin repair is appropriate; no configuration or security-boundary change is needed..
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 193 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 93 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#52130](https://github.com/openclaw/openclaw/pull/52130) | automation_failed | A narrow documentation, Settings-help, and Doctor-regression repair is allowed without reintroducing runtime coercion or a new configuration surface. | Aug 9, 2026, 10:48 UTC | [issue-openclaw-openclaw-52130](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-52130.md) | [31308133543](https://github.com/openclaw/clawsweeper/actions/runs/31308133543) |
