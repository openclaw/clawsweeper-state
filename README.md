...
Last source update: Sep 16, 2026, 09:25 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 16, 2026, 09:24 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35076224232) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 16, 2026, 09:25 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35079183933) |
...
Last source update: Sep 16, 2026, 09:07 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1061 | 100% |
| Run attempts archived | 3212 | audit |
| Latest successful clusters | 896 | 84.4% |
...
- Latest records: 1061 clusters: 328 maintainer action, 268 automation snapshot, 419 intervention needed, 46 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#149887](https://github.com/openclaw/openclaw/pull/149887) is automation_failed: A narrow cache-initialization repair is supported. Recheck issue-linked work and the designated branch before implementation to avoid dup....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#149867](https://github.com/openclaw/openclaw/pull/149867) is action_planned: A narrow repair to existing embedded bootstrap eligibility is warranted. Keep the issue open and require a failing production-path regres....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 328 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 268 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#149887](https://github.com/openclaw/openclaw/pull/149887) | automation_failed | A narrow cache-initialization repair is supported. Recheck issue-linked work and the designated branch before implementation to avoid duplicating @... | Sep 16, 2026, 09:07 UTC | [issue-openclaw-openclaw-149887](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-149887.md) | [35074148334](https://github.com/openclaw/clawsweeper/actions/runs/35074148334) |
