...
target_branch: clawsweeper/issue-openclaw-openclaw-103694
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/103694.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 103694
source_issue_revision_sha256: "88badfbae4bb9d563dae4f173acf647afc2b1c32880a6bb59e081d3ace35c284"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-103694`.

Source issue: https://github.com/openclaw/openclaw/issues/103694
Title: WARN on every boot: unknown format "google-duration" from remote MCP schema

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/103694.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/103694.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/103694.md
Category: bug
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-103694` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/103694 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/103694 when the implementation satisfies the issue.
