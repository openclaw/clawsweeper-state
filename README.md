...
Last source update: Sep 7, 2026, 06:55 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Sep 7, 2026, 06:55 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34092231672) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 7, 2026, 06:55 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34092930059) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Sep 7, 2026, 06:45 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34092239903) |
...
Last source update: Sep 7, 2026, 06:27 UTC
...
| Run attempts archived | 2768 | audit |
| Latest successful clusters | 734 | 82.1% |
| Latest failed clusters | 158 | 17.7% |
...
- Latest records: 894 clusters: 304 maintainer action, 145 automation snapshot, 408 intervention needed, 37 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#140821](https://github.com/openclaw/openclaw/pull/140821) is automation_failed: Keep the issue open and prepare the narrow repair; reproduce against freshly verified main and recheck existing PR ownership before imple....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#140770](https://github.com/openclaw/openclaw/pull/140770) is action_planned: The canonical report supports a narrow non-security repair. Preserve the issue while the executor establishes a failing regression, verif....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 304 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 145 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#140821](https://github.com/openclaw/openclaw/pull/140821) | automation_failed | Keep the issue open and prepare the narrow repair; reproduce against freshly verified main and recheck existing PR ownership before implementation. | Sep 7, 2026, 06:27 UTC | [issue-openclaw-openclaw-140821](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-140821.md) | [34088865844](https://github.com/openclaw/clawsweeper/actions/runs/34088865844) |
