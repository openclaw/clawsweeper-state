...
target_branch: clawsweeper/automerge-openclaw-openclaw-80620
source: pr_automerge
---

# ClawSweeper adopted PR repair candidate

Maintainer opted #80620 into ClawSweeper automerge.

Source PR: https://github.com/openclaw/openclaw/pull/80620
Title: fix(memory-core): use CJK-aware tokenizer for dreaming dedupe (#80613)

ClawSweeper should use this job only for the bounded ClawSweeper review/fix loop:

- Emit a fix artifact with `repair_strategy: "repair_contributor_branch"` and `source_prs: ["https://github.com/openclaw/openclaw/pull/80620"]` so the Codex edit pass can make this PR merge-ready.
