...
target_branch: clawsweeper/issue-openclaw-openclaw-76769
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-76769`.

Source issue: https://github.com/openclaw/openclaw/issues/76769
...
- Command comment: https://github.com/openclaw/openclaw/issues/76769#issuecomment-4366524296
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-76769` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/76769 in the PR body.
