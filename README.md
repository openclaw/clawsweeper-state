...
Last source update: Sep 8, 2026, 05:30 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 8, 2026, 05:26 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34188437309) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 8, 2026, 05:30 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34190837684) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Sep 8, 2026, 03:51 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34184878427) |
...
Last source update: Sep 8, 2026, 05:07 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 919 | 100% |
| Run attempts archived | 2824 | audit |
| Latest successful clusters | 760 | 82.7% |
| Latest failed clusters | 157 | 17.1% |
...
- Latest records: 919 clusters: 309 maintainer action, 164 automation snapshot, 409 intervention needed, 37 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#141839](https://github.com/openclaw/openclaw/pull/141839) is automation_failed: The source supports a bounded repair, but this worker cannot write the required failing regression or implementation. Execute the attache....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#141835](https://github.com/openclaw/openclaw/pull/141835) is action_planned: The accepted repair is bounded and non-security. Prepare one fix PR only after checking existing ownership and reproducing the diagnostic....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 309 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 164 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#141839](https://github.com/openclaw/openclaw/pull/141839) | automation_failed | The source supports a bounded repair, but this worker cannot write the required failing regression or implementation. Execute the attached plan in... | Sep 8, 2026, 05:07 UTC | [issue-openclaw-openclaw-141839](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-141839.md) | [34187527730](https://github.com/openclaw/clawsweeper/actions/runs/34187527730) |
