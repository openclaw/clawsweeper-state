...
Last source update: Sep 6, 2026, 06:46 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 6, 2026, 06:46 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34016612116) |
...
| Run attempts archived | 2729 | audit |
| Latest successful clusters | 716 | 81.9% |
| Latest failed clusters | 156 | 17.8% |
...
- Latest records: 874 clusters: 304 maintainer action, 132 automation snapshot, 401 intervention needed, 37 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#130432](https://github.com/openclaw/openclaw/pull/130432) is automation_failed: Keep the issue open. The hydrated report and inspected source support repair planning, but implementation must first establish a failing....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#139847](https://github.com/openclaw/openclaw/pull/139847) is action_planned: A focused fix plan is supported. Check current issue links and existing branch ownership, then reproduce the queued-operation failure bef....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 304 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 132 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#139847](https://github.com/openclaw/openclaw/pull/139847) | action_planned | A focused fix plan is supported. Check current issue links and existing branch ownership, then reproduce the queued-operation failure before changi... | Sep 6, 2026, 06:46 UTC | [issue-openclaw-openclaw-139847](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-139847.md) | [34017128847](https://github.com/openclaw/clawsweeper/actions/runs/34017128847) |
