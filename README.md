...
Last source update: Sep 25, 2026, 20:04 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Sep 25, 2026, 20:04 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/36182540526) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 25, 2026, 19:58 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/36182605236) |
...
Last source update: Sep 25, 2026, 19:58 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1208 | 100% |
| Run attempts archived | 3618 | audit |
| Latest successful clusters | 1016 | 84.1% |
| Latest failed clusters | 189 | 15.6% |
...
- Latest records: 1208 clusters: 344 maintainer action, 360 automation snapshot, 455 intervention needed, 49 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [cluster:issue-openclaw-openclaw-158262](cluster:issue-openclaw-openclaw-158262) is automation_failed: Implementation must run in a writable checkout with dependencies. First establish a failing manager-to-Twilio regression on current main,....
...
| Intervention Needed | 455 | automation failure or blocker recorded |
