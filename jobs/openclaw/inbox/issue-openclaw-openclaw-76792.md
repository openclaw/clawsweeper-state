...
target_branch: clawsweeper/issue-openclaw-openclaw-76792
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-76792`.

Source issue: https://github.com/openclaw/openclaw/issues/76792
Title: openclaw doctor: 'No active memory plugin is registered' false alarm; runtime is per-process

## Maintainer Context

- Command comment: https://github.com/openclaw/openclaw/issues/76792#issuecomment-4366572225
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-76792` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/76792 in the PR body.
