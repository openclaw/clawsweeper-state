...
Last source update: Sep 6, 2026, 07:04 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Sep 6, 2026, 07:04 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34016612116) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 6, 2026, 06:58 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34017819302) |
...
Last source update: Sep 6, 2026, 06:48 UTC
...
| Run attempts archived | 2730 | audit |
| Latest successful clusters | 717 | 82.0% |
...
- Latest records: 874 clusters: 304 maintainer action, 133 automation snapshot, 400 intervention needed, 37 no pending action, 0 completed.
...
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#130432](https://github.com/openclaw/openclaw/pull/130432) is action_planned: The supplied evidence supports a bounded routing repair. Existing-PR discovery and executable reproduction must precede implementation; m....
