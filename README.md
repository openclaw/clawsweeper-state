...
Last source update: Aug 13, 2026, 02:12 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Aug 13, 2026, 02:09 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31659407220) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Aug 13, 2026, 02:04 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31659667583) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Aug 13, 2026, 02:12 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31660072835) |
...
Last source update: Aug 13, 2026, 02:16 UTC
...
| Run attempts archived | 1398 | audit |
| Latest successful clusters | 432 | 85.9% |
| Latest failed clusters | 69 | 13.7% |
...
- Latest records: 503 clusters: 197 maintainer action, 116 automation snapshot, 164 intervention needed, 26 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#122911](https://github.com/openclaw/openclaw/pull/122911) is automation_failed: Implementation is blocked only by this worker's read-only filesystem and unavailable dependencies; the verified narrow repair is specifie....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#107814](https://github.com/openclaw/openclaw/pull/107814) is action_planned: The issue is a real shared-parser regression with a narrow owner-boundary repair; no Spark-specific behavior, configuration, fallback, or....
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#107814](https://github.com/openclaw/openclaw/pull/107814) | action_planned | The issue is a real shared-parser regression with a narrow owner-boundary repair; no Spark-specific behavior, configuration, fallback, or changelog... | Aug 13, 2026, 02:12 UTC | [issue-openclaw-openclaw-107814](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-107814.md) | [31659850670](https://github.com/openclaw/clawsweeper/actions/runs/31659850670) |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#122911](https://github.com/openclaw/openclaw/pull/122911) | automation_failed | Implementation is blocked only by this worker's read-only filesystem and unavailable dependencies; the verified narrow repair is specified in the f... | Aug 13, 2026, 02:16 UTC | [issue-openclaw-openclaw-122911](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-122911.md) | [31659780600](https://github.com/openclaw/clawsweeper/actions/runs/31659780600) |
