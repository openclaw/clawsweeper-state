...
target_branch: clawsweeper/issue-openclaw-clawsweeper-191
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-clawsweeper-191`.

Source issue: https://github.com/openclaw/clawsweeper/issues/191
Title: Add review metrics digest near PR report stats

## Maintainer Context

- Command comment: https://github.com/openclaw/clawsweeper/issues/191#issuecomment-4531156704
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-clawsweeper-191` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/clawsweeper/issues/191 in the PR body.
