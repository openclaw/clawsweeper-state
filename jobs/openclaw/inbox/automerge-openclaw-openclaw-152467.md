...
target_branch: clawsweeper/automerge-openclaw-openclaw-152467
source: pr_automerge
...
Title: refactor(agents): consolidate tool catalogs and model publication

ClawSweeper should use this job only for the bounded ClawSweeper review/fix loop:

- Emit a fix artifact with `repair_strategy: "repair_contributor_branch"` and `source_prs: ["https://github.com/openclaw/openclaw/pull/152467"]` so the Codex edit pass can make this PR merge-ready.
