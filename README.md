...
Last source update: Aug 8, 2026, 17:10 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Hot intake in progress | Aug 8, 2026, 17:10 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31268684936) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Aug 8, 2026, 17:06 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31268593759) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Aug 8, 2026, 17:06 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/31268594463) |
...
Last source update: Aug 8, 2026, 16:04 UTC
...
| Run attempts archived | 1191 | audit |
| Latest successful clusters | 370 | 85.3% |
| Latest failed clusters | 62 | 14.3% |
| Latest cancelled clusters | 2 | 0.5% |
| Needs-human clusters | 26 | 6.0% |
| Fix actions failed | 22 | 4.4% |
| Fix actions blocked | 85 | 17.1% |
...
- Latest records: 434 clusters: 193 maintainer action, 85 automation snapshot, 132 intervention needed, 24 no pending action, 0 completed.
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#120586](https://github.com/openclaw/openclaw/pull/120586) is merge_ready: issue implementation PR checks are green; merge intentionally blocked for this lane.
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [issue-openclaw-openclaw-97601](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-97601.md) is automation_blocked: validation command failed (pnpm check:changed): validation command runtime budget exhausted.
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#120550](https://github.com/openclaw/openclaw/pull/120550) is checks_blocked: checks are not clean: checks-node-compact-small-7: IN_PROGRESS.
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 193 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 85 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) |  | automation_blocked | validation command failed (pnpm check:changed): validation command runtime budget exhausted | Aug 8, 2026, 16:04 UTC | [issue-openclaw-openclaw-97601](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-97601.md) | [31262782095](https://github.com/openclaw/clawsweeper/actions/runs/31262782095) |
| [openclaw/crabpot](https://github.com/openclaw/crabpot) | [#283](https://github.com/openclaw/crabpot/pull/283) | automation_failed | Maintainer opted this PR into ClawSweeper automerge/autofix repair; run the direct Codex edit loop after live hydration instead of a separate read-... | Aug 8, 2026, 14:12 UTC | [automerge-openclaw-crabpot-283](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-crabpot-283.md) | [31261162695](https://github.com/openclaw/clawsweeper/actions/runs/31261162695) |
...
| --- | --- | --- | --- | --- |
| issue-openclaw-openclaw-97601 | execute_fix blocked | validation command failed (pnpm check:changed): validation command runtime budget exhausted | [issue-openclaw-openclaw-97601](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-97601.md) | [31262782095](https://github.com/openclaw/clawsweeper/actions/runs/31262782095) |
...
| --- | --- | --- | --- | --- | --- |
| [issue-openclaw-openclaw-97601](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-97601.md) | blocked |  |  | validation command failed (pnpm check:changed): validation command runtime budget exhausted | [31262782095](https://github.com/openclaw/clawsweeper/actions/runs/31262782095) |
