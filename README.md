...
Last source update: Aug 31, 2026, 17:42 UTC
...
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 31, 2026, 17:42 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33420863167) |
...
Last source update: Aug 31, 2026, 17:46 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 735 | 100% |
| Run attempts archived | 2465 | audit |
| Latest successful clusters | 613 | 83.4% |
...
- Latest records: 735 clusters: 262 maintainer action, 114 automation snapshot, 324 intervention needed, 35 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#134297](https://github.com/openclaw/openclaw/pull/134297) is automation_failed: Implementation is blocked only in this read-only, dependency-free checkout; the deterministic executor can apply the narrow artifact on c....
