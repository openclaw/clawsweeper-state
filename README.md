...
Last source update: Sep 2, 2026, 20:33 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review in progress | Sep 2, 2026, 20:24 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33677541604) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 2, 2026, 20:33 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33679839755) |
...
Last source update: Sep 2, 2026, 18:43 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 793 | 100% |
| Run attempts archived | 2565 | audit |
| Latest successful clusters | 658 | 83.0% |
| Latest failed clusters | 133 | 16.8% |
| Latest cancelled clusters | 2 | 0.3% |
| Needs-human clusters | 109 | 13.7% |
...
- Latest records: 793 clusters: 286 maintainer action, 114 automation snapshot, 358 intervention needed, 35 no pending action, 0 completed.
