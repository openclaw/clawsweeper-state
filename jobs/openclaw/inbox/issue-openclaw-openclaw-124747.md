...
cluster_id: issue-openclaw-openclaw-124747
mode: autonomous
...
target_branch: clawsweeper/issue-openclaw-openclaw-124747
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/124747.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 124747
source_issue_revision_sha256: "a428fc34301dab64a13eeab8d57aa67f8097fdeff828475da833f7970e8ff4f2"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-124747`.

Source issue: https://github.com/openclaw/openclaw/issues/124747
Title: Session-limit errors fail silently — Discord users get no explanation

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/124747.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/124747.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/124747.md
Category: bug
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-124747` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/124747 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/124747 when the implementation satisfies the issue.
