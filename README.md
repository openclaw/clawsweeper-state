...
Last source update: Sep 7, 2026, 15:37 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply finished | Sep 7, 2026, 15:37 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34137616709) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 7, 2026, 15:31 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34138645803) |
...
Last source update: Sep 7, 2026, 15:33 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 907 | 100% |
| Run attempts archived | 2799 | audit |
| Latest successful clusters | 747 | 82.4% |
| Latest failed clusters | 158 | 17.4% |
| Latest cancelled clusters | 2 | 0.2% |
| Needs-human clusters | 121 | 13.3% |
| Fix actions failed | 33 | 4.6% |
| Fix actions blocked | 148 | 20.6% |
...
- Latest records: 907 clusters: 305 maintainer action, 156 automation snapshot, 409 intervention needed, 37 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#141260](https://github.com/openclaw/openclaw/pull/141260) is automation_failed: Implementation, failing-regression proof, and repaired validation require a writable executor environment. The source finding remains act....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#141233](https://github.com/openclaw/openclaw/pull/141233) is action_planned: Keep this issue as the canonical tracker. Prepare the bounded repair only after checking existing PR ownership, inspecting the pinned dep....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 305 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 156 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#141260](https://github.com/openclaw/openclaw/pull/141260) | automation_failed | Implementation, failing-regression proof, and repaired validation require a writable executor environment. The source finding remains actionable; t... | Sep 7, 2026, 15:33 UTC | [issue-openclaw-openclaw-141260](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-141260.md) | [34132984300](https://github.com/openclaw/clawsweeper/actions/runs/34132984300) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#141279](https://github.com/openclaw/openclaw/pull/141279) | automation_failed | Implementation requires a writable executor, a fresh existing-PR check, and a failing native Windows owner-boundary regression before production ed... | Sep 7, 2026, 15:26 UTC | [issue-openclaw-openclaw-141279](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-141279.md) | [34137177618](https://github.com/openclaw/clawsweeper/actions/runs/34137177618) |
