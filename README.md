...
Last source update: Aug 29, 2026, 22:23 UTC
...
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 29, 2026, 22:19 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33278219491) |
...
Last source update: Aug 29, 2026, 22:13 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 696 | 100% |
| Run attempts archived | 2361 | audit |
| Latest successful clusters | 579 | 83.2% |
...
- Latest records: 696 clusters: 242 maintainer action, 114 automation snapshot, 310 intervention needed, 30 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#110564](https://github.com/openclaw/openclaw/pull/110564) is automation_failed: Provision a writable worker with ../codex available and dependencies installed, then implement and validate the prepared new-fix-PR plan..
