...
Last source update: Sep 21, 2026, 12:39 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 21, 2026, 12:36 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35596576963) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 21, 2026, 12:39 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35600748471) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Sep 20, 2026, 23:50 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/35545790282) |
...
Last source update: Sep 21, 2026, 12:04 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1140 | 100% |
| Run attempts archived | 3400 | audit |
| Latest successful clusters | 969 | 85.0% |
| Latest failed clusters | 168 | 14.7% |
| Latest cancelled clusters | 3 | 0.3% |
| Needs-human clusters | 126 | 11.1% |
...
- Latest records: 1140 clusters: 339 maintainer action, 327 automation snapshot, 426 intervention needed, 48 no pending action, 0 completed.
...
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#154685](https://github.com/openclaw/openclaw/pull/154685) is action_planned: A bounded ordinary bug repair is appropriate, conditional on reproducing the reported mechanism on current main. Related historical filen....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 339 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 327 | repair, check, or planned action recorded; verify live status |
