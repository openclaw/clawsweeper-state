...
cluster_id: issue-steipete-codexbar-1611
mode: autonomous
...
target_branch: clawsweeper/issue-steipete-codexbar-1611
source: issue_implementation
trigger_source: review_viable_issue
clawsweeper_report_path: records/steipete-codexbar/items/1611.md
source_issue_repo: "steipete/codexbar"
source_issue_number: 1611
source_issue_revision_sha256: "1e254e5b24da422909d570bd7e9516d809aa22f991b77ca104ba4b985d9e3bd5"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-steipete-codexbar-1611`.

Source issue: https://github.com/steipete/codexbar/issues/1611
Title: Can't change to 'pace' display in menu bar and refresh runs very long

## Maintainer Context

- Trigger source: review_viable_issue
- ClawSweeper review report: records/steipete-codexbar/items/1611.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/steipete-codexbar/items/1611.md
- Maintainer instruction: ClawSweeper finished reviewing this open issue and found no active implementation PR.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/steipete-codexbar/items/1611.md
...
- Keep one PR for this issue; reuse `clawsweeper/issue-steipete-codexbar-1611` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/steipete/codexbar/issues/1611 in the PR body.
- Use a closing reference for https://github.com/steipete/codexbar/issues/1611 when the implementation satisfies the issue.
