...
Last source update: Aug 22, 2026, 23:49 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review publish complete | Aug 22, 2026, 23:49 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32605225609) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 22, 2026, 23:45 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/32606009829) |
...
| Run attempts archived | 1966 | audit |
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#45224](https://github.com/openclaw/openclaw/pull/45224) is automation_failed: Implementation needs a writable dependency-ready checkout and direct Playwright/Codex contract inspection before the regression can be pr....
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#45224](https://github.com/openclaw/openclaw/pull/45224) | automation_failed | Implementation needs a writable dependency-ready checkout and direct Playwright/Codex contract inspection before the regression can be proved on pr... | Aug 22, 2026, 23:49 UTC | [issue-openclaw-openclaw-45224](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-45224.md) | [32605653532](https://github.com/openclaw/clawsweeper/actions/runs/32605653532) |
