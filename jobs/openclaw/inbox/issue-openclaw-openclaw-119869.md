...
cluster_id: issue-openclaw-openclaw-119869
mode: autonomous
...
target_branch: clawsweeper/issue-openclaw-openclaw-119869
source: issue_implementation
trigger_source: review_reproducible_bug
clawsweeper_report_path: records/openclaw-openclaw/items/119869.md
source_issue_repo: "openclaw/openclaw"
source_issue_number: 119869
source_issue_revision_sha256: "6db237b4bb981cc68b85e5409c2c2f91964131ed4a1126a94d94e88420287819"
required_pr_labels:
...
ClawSweeper Repair should create or update one implementation PR from `clawsweeper/issue-openclaw-openclaw-119869`.

Source issue: https://github.com/openclaw/openclaw/issues/119869
Title: [Bug]: restored requester-settle wakes start before Gateway request scope and create a retry storm

## Maintainer Context

- Trigger source: review_reproducible_bug
- ClawSweeper review report: records/openclaw-openclaw/items/119869.md
- Review report URL: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/119869.md
- Maintainer instruction: This was selected by ClawSweeper's high-confidence bug-fix lane.

Review report: https://github.com/openclaw/clawsweeper-state/blob/state/records/openclaw-openclaw/items/119869.md
Category: bug
...
- Keep one PR for this issue; reuse `clawsweeper/issue-openclaw-openclaw-119869` if it already exists.
- Keep the diff narrow and avoid unrelated refactors.
- Preserve issue context and link https://github.com/openclaw/openclaw/issues/119869 in the PR body.
- Use a closing reference for https://github.com/openclaw/openclaw/issues/119869 when the implementation satisfies the issue.
