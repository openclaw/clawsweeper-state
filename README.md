...
Last source update: Sep 24, 2026, 19:48 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review in progress | Sep 24, 2026, 19:48 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/36050138267) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 24, 2026, 18:57 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/36044687351) |
...
Last source update: Sep 24, 2026, 19:30 UTC
...
| Run attempts archived | 3576 | audit |
| Latest successful clusters | 1006 | 84.4% |
| Latest failed clusters | 183 | 15.4% |
...
- Latest records: 1192 clusters: 343 maintainer action, 354 automation snapshot, 446 intervention needed, 49 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [cluster:issue-openclaw-openclaw-157477](cluster:issue-openclaw-openclaw-157477) is automation_failed: Implementation requires a writable, dependency-ready checkout..
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#120616](https://github.com/openclaw/openclaw/pull/120616) is action_planned: The issue remains the canonical bug report. A fix is conditional on reproducing the failure on the preflight main commit..
...
| Intervention Needed | 446 | automation failure or blocker recorded |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#120616](https://github.com/openclaw/openclaw/pull/120616) | action_planned | The issue remains the canonical bug report. A fix is conditional on reproducing the failure on the preflight main commit. | Sep 24, 2026, 19:30 UTC | [issue-openclaw-openclaw-120616](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-120616.md) | [36044844101](https://github.com/openclaw/clawsweeper/actions/runs/36044844101) |
