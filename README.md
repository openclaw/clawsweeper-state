...
Last source update: Aug 29, 2026, 03:15 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Aug 29, 2026, 03:15 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33228901018) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Aug 29, 2026, 02:57 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/33230131066) |
...
Last source update: Aug 29, 2026, 03:13 UTC
...
| Run attempts archived | 2318 | audit |
| Latest successful clusters | 571 | 83.2% |
| Latest failed clusters | 113 | 16.5% |
...
- Maintainer first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#111687](https://github.com/openclaw/openclaw/issues/111687) is maintainer_input: Security-sensitive linked reference is out of scope for this repair job..
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#118386](https://github.com/openclaw/openclaw/pull/118386) is automation_blocked: A narrow repair path is known, but the repository's Codex hard gate prohibits a code-change verdict or implementation without direct ../c....
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#118386](https://github.com/openclaw/openclaw/pull/118386) | automation_blocked | A narrow repair path is known, but the repository's Codex hard gate prohibits a code-change verdict or implementation without direct ../codex sourc... | Aug 29, 2026, 03:13 UTC | [issue-openclaw-openclaw-118386](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-118386.md) | [33229550758](https://github.com/openclaw/clawsweeper/actions/runs/33229550758) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#132263](https://github.com/openclaw/openclaw/pull/132263) | automation_failed | Implementation is narrowly specified, but local reproduction, test validation, browser evidence, and the repository's mandatory Codex-source gate a... | Aug 29, 2026, 02:52 UTC | [issue-openclaw-openclaw-132263](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-132263.md) | [33229349066](https://github.com/openclaw/clawsweeper/actions/runs/33229349066) |
